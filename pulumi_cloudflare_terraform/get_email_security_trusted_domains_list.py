...
def get_email_security_trusted_domains_list(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getEmailSecurityTrustedDomainsList:getEmailSecurityTrustedDomainsList', __args__, opts=opts, typ=GetEmailSecurityTrustedDomainsListResult, package_ref=_utilities.get_package()).value
...
def get_email_security_trusted_domains_list_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getEmailSecurityTrustedDomainsList:getEmailSecurityTrustedDomainsList', __args__, opts=opts, typ=GetEmailSecurityTrustedDomainsListResult, package_ref=_utilities.get_package())
