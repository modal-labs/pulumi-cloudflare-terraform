...
def get_custom_hostname_fallback_origin(zone_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getCustomHostnameFallbackOrigin:getCustomHostnameFallbackOrigin', __args__, opts=opts, typ=GetCustomHostnameFallbackOriginResult, package_ref=_utilities.get_package()).value
...
def get_custom_hostname_fallback_origin_output(zone_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getCustomHostnameFallbackOrigin:getCustomHostnameFallbackOrigin', __args__, opts=opts, typ=GetCustomHostnameFallbackOriginResult, package_ref=_utilities.get_package())
