...
def get_pages_project(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getPagesProject:getPagesProject', __args__, opts=opts, typ=GetPagesProjectResult, package_ref=_utilities.get_package()).value
...
def get_pages_project_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getPagesProject:getPagesProject', __args__, opts=opts, typ=GetPagesProjectResult, package_ref=_utilities.get_package())
