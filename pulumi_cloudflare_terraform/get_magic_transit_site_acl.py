...
def get_magic_transit_site_acl(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMagicTransitSiteAcl:getMagicTransitSiteAcl', __args__, opts=opts, typ=GetMagicTransitSiteAclResult, package_ref=_utilities.get_package()).value
...
def get_magic_transit_site_acl_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMagicTransitSiteAcl:getMagicTransitSiteAcl', __args__, opts=opts, typ=GetMagicTransitSiteAclResult, package_ref=_utilities.get_package())
