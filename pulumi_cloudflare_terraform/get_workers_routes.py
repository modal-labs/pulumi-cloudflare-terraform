...
def get_workers_routes(max_items: Optional[float] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWorkersRoutes:getWorkersRoutes', __args__, opts=opts, typ=GetWorkersRoutesResult, package_ref=_utilities.get_package()).value
...
def get_workers_routes_output(max_items: Optional[pulumi.Input[Optional[float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWorkersRoutes:getWorkersRoutes', __args__, opts=opts, typ=GetWorkersRoutesResult, package_ref=_utilities.get_package())
