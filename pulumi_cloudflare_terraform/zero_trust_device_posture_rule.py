...
class ZeroTrustDevicePostureRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] expiration: Sets the expiration time for a posture check result. If empty, the result remains valid until it is overwritten by new
               data from the WARP client.
    ...
    def expiration(self) -> Optional[pulumi.Input[str]]:
        """
        Sets the expiration time for a posture check result. If empty, the result remains valid until it is overwritten by new
        data from the WARP client.
        """
...
class ZeroTrustDevicePostureRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustDevicePostureRule resource with the given unique name, props, and options.
