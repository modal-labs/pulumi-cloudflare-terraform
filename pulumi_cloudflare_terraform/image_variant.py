...
class ImageVariantArgs:
    def __init__(__self__, *,
                 ...
                 image_variant_id: pulumi.Input[str],
    ...
    def image_variant_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "image_variant_id")

    @image_variant_id.setter
    def image_variant_id(self, value: pulumi.Input[str]):
...
class _ImageVariantState:
    def __init__(__self__, *,
                 ...
                 image_variant_id: Optional[pulumi.Input[str]] = None,
                 never_require_signed_urls: Optional[pulumi.Input[bool]] = None,
    ...
    @property
    @pulumi.getter(name="imageVariantId")
    def image_variant_id(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "image_variant_id")

    @image_variant_id.setter
    def image_variant_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "image_variant_id", value)
...
class ImageVariant(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ImageVariant resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="imageVariantId")
    def image_variant_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "image_variant_id")

    @property
    @pulumi.getter(name="neverRequireSignedUrls")
    def never_require_signed_urls(self) -> pulumi.Output[bool]:
        """
        Indicates whether the variant can access an image without a signature, regardless of image access control.
        """
        return pulumi.get(self, "never_require_signed_urls")
