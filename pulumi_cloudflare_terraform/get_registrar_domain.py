...
def get_registrar_domain(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getRegistrarDomain:getRegistrarDomain', __args__, opts=opts, typ=GetRegistrarDomainResult, package_ref=_utilities.get_package()).value
...
def get_registrar_domain_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getRegistrarDomain:getRegistrarDomain', __args__, opts=opts, typ=GetRegistrarDomainResult, package_ref=_utilities.get_package())
