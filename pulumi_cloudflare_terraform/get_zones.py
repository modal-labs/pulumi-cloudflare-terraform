...
def get_zones(account: Optional[Union['GetZonesAccountArgs', 'GetZonesAccountArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZones:getZones', __args__, opts=opts, typ=GetZonesResult, package_ref=_utilities.get_package()).value
...
def get_zones_output(account: Optional[pulumi.Input[Optional[Union['GetZonesAccountArgs', 'GetZonesAccountArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZones:getZones', __args__, opts=opts, typ=GetZonesResult, package_ref=_utilities.get_package())
