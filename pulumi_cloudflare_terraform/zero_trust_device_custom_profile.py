...
class ZeroTrustDeviceCustomProfileArgs:
    def __init__(__self__, *,
                 ...
                 auto_connect: Optional[pulumi.Input[float]] = None,
                 captive_portal: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[float] precedence: The precedence of the policy. Lower values indicate higher precedence. Policies will be evaluated in ascending order of
               this field.
        :param pulumi.Input[bool] allow_mode_switch: Whether to allow the user to switch WARP between modes.
        :param pulumi.Input[bool] allow_updates: Whether to receive update notifications when a new version of the client is available.
        :param pulumi.Input[bool] allowed_to_leave: Whether to allow devices to leave the organization.
        :param pulumi.Input[float] auto_connect: The amount of time in seconds to reconnect after having been disabled.
        :param pulumi.Input[float] captive_portal: Turn on the captive portal after the specified amount of time.
        :param pulumi.Input[str] description: A description of the policy.
        :param pulumi.Input[bool] disable_auto_fallback: If the `dns_server` field of a fallback domain is not present, the client will fall back to a best guess of the
               default/system DNS resolvers unless this policy option is set to `true`.
        ...
        :param pulumi.Input[float] lan_allow_minutes: The amount of time in minutes a user is allowed access to their LAN. A value of 0 will allow LAN access until the next
               WARP reconnection, such as a reboot or a laptop waking from sleep. Note that this field is omitted from the response if
               null or unset.
    ...
    @property
    @pulumi.getter
    def precedence(self) -> pulumi.Input[float]:
        """
        The precedence of the policy. Lower values indicate higher precedence. Policies will be evaluated in ascending order of
        this field.
        """
        return pulumi.get(self, "precedence")

    @precedence.setter
    def precedence(self, value: pulumi.Input[float]):
    ...
    def auto_connect(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    @auto_connect.setter
    def auto_connect(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "auto_connect", value)

    @property
    @pulumi.getter(name="captivePortal")
    def captive_portal(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def captive_portal(self, value: Optional[pulumi.Input[float]]):
    ...
    def disable_auto_fallback(self) -> Optional[pulumi.Input[bool]]:
        """
        If the `dns_server` field of a fallback domain is not present, the client will fall back to a best guess of the
        default/system DNS resolvers unless this policy option is set to `true`.
        """
    ...
    def lan_allow_minutes(self) -> Optional[pulumi.Input[float]]:
        """
        The amount of time in minutes a user is allowed access to their LAN. A value of 0 will allow LAN access until the next
        WARP reconnection, such as a reboot or a laptop waking from sleep. Note that this field is omitted from the response if
        null or unset.
        """
    ...
    def lan_allow_minutes(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "lan_allow_minutes", value)

    @property
    @pulumi.getter(name="lanAllowSubnetSize")
    def lan_allow_subnet_size(self) -> Optional[pulumi.Input[float]]:
        """
...
class _ZeroTrustDeviceCustomProfileState:
    def __init__(__self__, *,
                 ...
                 gateway_unique_id: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[float] auto_connect: The amount of time in seconds to reconnect after having been disabled.
        :param pulumi.Input[float] captive_portal: Turn on the captive portal after the specified amount of time.
        :param pulumi.Input[bool] default: Whether the policy is the default policy for an account.
        :param pulumi.Input[str] description: A description of the policy.
        :param pulumi.Input[bool] disable_auto_fallback: If the `dns_server` field of a fallback domain is not present, the client will fall back to a best guess of the
               default/system DNS resolvers unless this policy option is set to `true`.
        :param pulumi.Input[bool] enabled: Whether the policy will be applied to matching devices.
    ...
    def gateway_unique_id(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "gateway_unique_id")

    @gateway_unique_id.setter
    def gateway_unique_id(self, value: Optional[pulumi.Input[str]]):
...
class ZeroTrustDeviceCustomProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustDeviceCustomProfile resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            tunnel_protocol: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustDeviceCustomProfile':
        """
    ...
    @property
    @pulumi.getter(name="autoConnect")
    def auto_connect(self) -> pulumi.Output[Optional[float]]:
        """
        The amount of time in seconds to reconnect after having been disabled.
        """
        return pulumi.get(self, "auto_connect")
    ...
    @property
    @pulumi.getter(name="captivePortal")
    def captive_portal(self) -> pulumi.Output[Optional[float]]:
        """
        Turn on the captive portal after the specified amount of time.
        """
        return pulumi.get(self, "captive_portal")
    ...
    @property
    @pulumi.getter(name="gatewayUniqueId")
    def gateway_unique_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "gateway_unique_id")
    ...
    @property
    @pulumi.getter(name="lanAllowMinutes")
    def lan_allow_minutes(self) -> pulumi.Output[Optional[float]]:
        """
        The amount of time in minutes a user is allowed access to their LAN. A value of 0 will allow LAN access until the next
        WARP reconnection, such as a reboot or a laptop waking from sleep. Note that this field is omitted from the response if
        null or unset.
    ...
    @property
    @pulumi.getter(name="lanAllowSubnetSize")
    def lan_allow_subnet_size(self) -> pulumi.Output[Optional[float]]:
        """
        The size of the subnet for the local access network. Note that this field is omitted from the response if null or unset.
        """
        return pulumi.get(self, "lan_allow_subnet_size")
    ...
    @property
    @pulumi.getter
    def precedence(self) -> pulumi.Output[float]:
        """
        The precedence of the policy. Lower values indicate higher precedence. Policies will be evaluated in ascending order of
        this field.
        """
