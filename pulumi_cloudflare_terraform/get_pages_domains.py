...
def get_pages_domains(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getPagesDomains:getPagesDomains', __args__, opts=opts, typ=GetPagesDomainsResult, package_ref=_utilities.get_package()).value
...
def get_pages_domains_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getPagesDomains:getPagesDomains', __args__, opts=opts, typ=GetPagesDomainsResult, package_ref=_utilities.get_package())
