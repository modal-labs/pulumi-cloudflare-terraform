...
class ZeroTrustRiskScoringIntegration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustRiskScoringIntegration resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            reference_id: Optional[pulumi.Input[str]] = None,
            tenant_url: Optional[pulumi.Input[str]] = None,
            well_known_url: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustRiskScoringIntegration':
        """
    ...
    @property
    @pulumi.getter(name="referenceId")
    def reference_id(self) -> pulumi.Output[Optional[str]]:
        """
        A reference id that can be supplied by the client. Currently this should be set to the Access-Okta IDP ID (a UUIDv4).
        https://developers.cloudflare.com/api/operations/access-identity-providers-get-an-access-identity-provider
        """
