...
def get_email_routing_dns(subdomain: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getEmailRoutingDns:getEmailRoutingDns', __args__, opts=opts, typ=GetEmailRoutingDnsResult, package_ref=_utilities.get_package()).value
...
def get_email_routing_dns_output(subdomain: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getEmailRoutingDns:getEmailRoutingDns', __args__, opts=opts, typ=GetEmailRoutingDnsResult, package_ref=_utilities.get_package())
