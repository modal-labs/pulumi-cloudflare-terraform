...
def get_zero_trust_access_applications(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustAccessApplications:getZeroTrustAccessApplications', __args__, opts=opts, typ=GetZeroTrustAccessApplicationsResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_access_applications_output(account_id: Optional[pulumi.Input[Optional[str]]] = None,
                                              aud: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustAccessApplications:getZeroTrustAccessApplications', __args__, opts=opts, typ=GetZeroTrustAccessApplicationsResult, package_ref=_utilities.get_package())
