...
def get_magic_wan_ipsec_tunnel(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMagicWanIpsecTunnel:getMagicWanIpsecTunnel', __args__, opts=opts, typ=GetMagicWanIpsecTunnelResult, package_ref=_utilities.get_package()).value
...
def get_magic_wan_ipsec_tunnel_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMagicWanIpsecTunnel:getMagicWanIpsecTunnel', __args__, opts=opts, typ=GetMagicWanIpsecTunnelResult, package_ref=_utilities.get_package())
