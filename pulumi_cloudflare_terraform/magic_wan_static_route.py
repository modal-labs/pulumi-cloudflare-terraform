...
class MagicWanStaticRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] priority: Priority of the static route.
        :param pulumi.Input[str] route_id: Identifier
        :param pulumi.Input['MagicWanStaticRouteScopeArgs'] scope: Used only for ECMP routes.
        :param pulumi.Input[float] weight: Optional weight of the ECMP scope - if provided.
        """
...
class MagicWanStaticRoute(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a MagicWanStaticRoute resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            routes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MagicWanStaticRouteRouteArgs', 'MagicWanStaticRouteRouteArgsDict']]]]] = None,
            scope: Optional[pulumi.Input[Union['MagicWanStaticRouteScopeArgs', 'MagicWanStaticRouteScopeArgsDict']]] = None,
            weight: Optional[pulumi.Input[float]] = None) -> 'MagicWanStaticRoute':
        """
    ...
    @property
    @pulumi.getter
    def nexthop(self) -> pulumi.Output[Optional[str]]:
        """
        The next-hop IP Address for the static route.
        """
        return pulumi.get(self, "nexthop")
