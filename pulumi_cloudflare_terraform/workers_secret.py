...
class WorkersSecretArgs:
    def __init__(__self__, *,
                 ...
                 dispatch_namespace: pulumi.Input[str],
        ...
        :param pulumi.Input[str] name: The name of this secret, this is what will be used to access it inside the Worker.
    ...
    def dispatch_namespace(self) -> pulumi.Input[str]:
        """
    ...
    def dispatch_namespace(self, value: pulumi.Input[str]):
...
class WorkersSecret(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a WorkersSecret resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            script_name: Optional[pulumi.Input[str]] = None,
            text: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None) -> 'WorkersSecret':
        """
    ...
    @property
    @pulumi.getter(name="dispatchNamespace")
    def dispatch_namespace(self) -> pulumi.Output[str]:
        """
        Name of the Workers for Platforms dispatch namespace.
        """
        return pulumi.get(self, "dispatch_namespace")
