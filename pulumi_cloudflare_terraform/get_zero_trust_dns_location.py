...
def get_zero_trust_dns_location(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDnsLocation:getZeroTrustDnsLocation', __args__, opts=opts, typ=GetZeroTrustDnsLocationResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_dns_location_output(account_id: Optional[pulumi.Input[str]] = None,
                                       location_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDnsLocation:getZeroTrustDnsLocation', __args__, opts=opts, typ=GetZeroTrustDnsLocationResult, package_ref=_utilities.get_package())
