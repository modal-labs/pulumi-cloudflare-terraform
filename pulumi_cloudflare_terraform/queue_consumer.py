...
class QueueConsumerInitArgs:
    def __init__(__self__, *,
                 ...
                 dead_letter_queue: Optional[pulumi.Input[str]] = None,
    ...
    def dead_letter_queue(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "dead_letter_queue")

    @dead_letter_queue.setter
    def dead_letter_queue(self, value: Optional[pulumi.Input[str]]):
...
class QueueConsumer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a QueueConsumer resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            script_name: Optional[pulumi.Input[str]] = None,
            settings: Optional[pulumi.Input[Union['QueueConsumerSettingsArgs', 'QueueConsumerSettingsArgsDict']]] = None,
            type: Optional[pulumi.Input[str]] = None) -> 'QueueConsumer':
        """
    ...
    @property
    @pulumi.getter(name="deadLetterQueue")
    def dead_letter_queue(self) -> pulumi.Output[Optional[str]]:
        return pulumi.get(self, "dead_letter_queue")
