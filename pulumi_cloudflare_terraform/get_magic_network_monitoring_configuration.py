...
class GetMagicNetworkMonitoringConfigurationResult:
    ...
    def default_sampling(self) -> float:
    ...
    def router_ips(self) -> Sequence[str]:
...
def get_magic_network_monitoring_configuration(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMagicNetworkMonitoringConfiguration:getMagicNetworkMonitoringConfiguration', __args__, opts=opts, typ=GetMagicNetworkMonitoringConfigurationResult, package_ref=_utilities.get_package()).value
...
def get_magic_network_monitoring_configuration_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMagicNetworkMonitoringConfiguration:getMagicNetworkMonitoringConfiguration', __args__, opts=opts, typ=GetMagicNetworkMonitoringConfigurationResult, package_ref=_utilities.get_package())
