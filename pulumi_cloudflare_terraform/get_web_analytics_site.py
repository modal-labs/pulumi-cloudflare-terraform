...
def get_web_analytics_site(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWebAnalyticsSite:getWebAnalyticsSite', __args__, opts=opts, typ=GetWebAnalyticsSiteResult, package_ref=_utilities.get_package()).value
...
def get_web_analytics_site_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWebAnalyticsSite:getWebAnalyticsSite', __args__, opts=opts, typ=GetWebAnalyticsSiteResult, package_ref=_utilities.get_package())
