...
class GetWaitingRoomResult:
    ...
    def __init__(__self__, additional_routes=None, cookie_attributes=None, cookie_suffix=None, created_on=None, custom_page_html=None, default_template_language=None, description=None, disable_session_renewal=None, enabled_origin_commands=None, host=None, id=None, json_response_enabled=None, modified_on=None, name=None, new_users_per_minute=None, next_event_prequeue_start_time=None, next_event_start_time=None, path=None, queue_all=None, queueing_method=None, queueing_status_code=None, session_duration=None, suspended=None, total_active_users=None, turnstile_action=None, turnstile_mode=None, waiting_room_id=None, zone_id=None):
        ...
        if queueing_status_code and not isinstance(queueing_status_code, float):
            raise TypeError("Expected argument 'queueing_status_code' to be a float")
    ...
    def queueing_status_code(self) -> float:
    ...
    def waiting_room_id(self) -> Optional[str]:
...
def get_waiting_room(waiting_room_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWaitingRoom:getWaitingRoom', __args__, opts=opts, typ=GetWaitingRoomResult, package_ref=_utilities.get_package()).value
...
def get_waiting_room_output(waiting_room_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWaitingRoom:getWaitingRoom', __args__, opts=opts, typ=GetWaitingRoomResult, package_ref=_utilities.get_package())
