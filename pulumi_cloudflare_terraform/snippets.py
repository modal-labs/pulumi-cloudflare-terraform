...
class SnippetsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] files: Content files of uploaded snippet
        """
...
class _SnippetsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] created_on: Creation time of the snippet
        :param pulumi.Input[str] files: Content files of uploaded snippet
        :param pulumi.Input[str] modified_on: Modification time of the snippet
        :param pulumi.Input[str] snippet_name: Snippet identifying name
        :param pulumi.Input[str] zone_id: Identifier
        """
...
class Snippets(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            modified_on: Optional[pulumi.Input[str]] = None,
            snippet_name: Optional[pulumi.Input[str]] = None,
            zone_id: Optional[pulumi.Input[str]] = None) -> 'Snippets':
        """
    ...
    @property
    @pulumi.getter
    def files(self) -> pulumi.Output[Optional[str]]:
        """
        Content files of uploaded snippet
        """
        return pulumi.get(self, "files")
    ...
    @property
    @pulumi.getter(name="snippetName")
    def snippet_name(self) -> pulumi.Output[str]:
        """
        Snippet identifying name
        """
        return pulumi.get(self, "snippet_name")
