...
class ZeroTrustOrganizationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] session_duration: The amount of time that tokens issued for applications will be valid. Must be in the format `300ms` or `2h45m`. Valid
        ...
        :param pulumi.Input[str] user_seat_expiration_inactive_time: The amount of time a user seat is inactive before it expires. When the user seat exceeds the set time of inactivity, the
               user is removed as an active seat and no longer counts against your Teams seat count. Minimum value for this setting is
               1 month (730h). Must be in the format `300ms` or `2h45m`. Valid time units are: `ns`, `us` (or `µs`), `ms`, `s`, `m`,
               `h`.
    ...
    def session_duration(self) -> Optional[pulumi.Input[str]]:
        """
        The amount of time that tokens issued for applications will be valid. Must be in the format `300ms` or `2h45m`. Valid
        time units are: ns, us (or µs), ms, s, m, h.
        """
...
class ZeroTrustOrganization(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustOrganization resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            user_seat_expiration_inactive_time: Optional[pulumi.Input[str]] = None,
            warp_auth_session_duration: Optional[pulumi.Input[str]] = None,
            zone_id: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustOrganization':
        """
    ...
    @property
    @pulumi.getter(name="authDomain")
    def auth_domain(self) -> pulumi.Output[Optional[str]]:
        """
        The unique subdomain assigned to your Zero Trust organization.
        """
        return pulumi.get(self, "auth_domain")
