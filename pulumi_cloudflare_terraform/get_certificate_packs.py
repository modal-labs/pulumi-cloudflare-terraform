...
def get_certificate_packs(max_items: Optional[float] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getCertificatePacks:getCertificatePacks', __args__, opts=opts, typ=GetCertificatePacksResult, package_ref=_utilities.get_package()).value
...
def get_certificate_packs_output(max_items: Optional[pulumi.Input[Optional[float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getCertificatePacks:getCertificatePacks', __args__, opts=opts, typ=GetCertificatePacksResult, package_ref=_utilities.get_package())
