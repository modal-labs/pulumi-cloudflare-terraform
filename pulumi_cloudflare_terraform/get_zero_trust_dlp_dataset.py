...
class GetZeroTrustDlpDatasetResult:
    ...
    def __init__(__self__, account_id=None, columns=None, created_at=None, dataset_id=None, description=None, encoding_version=None, id=None, name=None, num_cells=None, secret=None, status=None, updated_at=None, uploads=None):
        ...
        if encoding_version and not isinstance(encoding_version, float):
            raise TypeError("Expected argument 'encoding_version' to be a float")
        ...
        if num_cells and not isinstance(num_cells, float):
            raise TypeError("Expected argument 'num_cells' to be a float")
    ...
    def encoding_version(self) -> float:
...
def get_zero_trust_dlp_dataset(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDlpDataset:getZeroTrustDlpDataset', __args__, opts=opts, typ=GetZeroTrustDlpDatasetResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_dlp_dataset_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDlpDataset:getZeroTrustDlpDataset', __args__, opts=opts, typ=GetZeroTrustDlpDatasetResult, package_ref=_utilities.get_package())
