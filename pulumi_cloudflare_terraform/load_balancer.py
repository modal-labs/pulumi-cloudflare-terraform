...
class LoadBalancerArgs:
    def __init__(__self__, *,
                 default_pools: pulumi.Input[Sequence[pulumi.Input[str]]],
                 fallback_pool: pulumi.Input[str],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] default_pools: A list of pool IDs ordered by their failover priority. Pools defined here are used by default, or when region_pools are
        ...
        :param pulumi.Input['LoadBalancerAdaptiveRoutingArgs'] adaptive_routing: Controls features that modify the routing of requests to pools and origins in response to dynamic conditions, such as
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[str]]]]] country_pools: A mapping of country codes to a list of pool IDs (ordered by their failover priority) for the given country. Any country
        ...
        :param pulumi.Input[bool] enabled: Whether to enable (the default) this load balancer.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[str]]]]] pop_pools: (Enterprise only): A mapping of Cloudflare PoP identifiers to a list of pool IDs (ordered by their failover priority)
        ...
        :param pulumi.Input[bool] proxied: Whether the hostname should be gray clouded (false) or orange clouded (true).
        :param pulumi.Input['LoadBalancerRandomSteeringArgs'] random_steering: Configures pool weights. - `steering_policy="random"`: A random pool is selected with probability proportional to pool
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[str]]]]] region_pools: A mapping of region codes to a list of pool IDs (ordered by their failover priority) for the given region. Any regions
        ...
        :param pulumi.Input[str] session_affinity: Specifies the type of session affinity the load balancer should use unless specified as `"none"`. The supported types
        ...
        :param pulumi.Input[float] session_affinity_ttl: Time, in seconds, until a client's session expires after being created. Once the expiry time has been reached,
        ...
        :param pulumi.Input[str] steering_policy: Steering Policy for this load balancer. - `"off"`: Use `default_pools`. - `"geo"`: Use
        ...
        :param pulumi.Input[float] ttl: Time to live (TTL) of the DNS entry for the IP address returned by this load balancer. This only applies to gray-clouded
    ...
    def default_pools(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
    ...
    def default_pools(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
        pulumi.set(self, "default_pools", value)

    @property
    @pulumi.getter(name="fallbackPool")
    def fallback_pool(self) -> pulumi.Input[str]:
        """
    ...
    def fallback_pool(self, value: pulumi.Input[str]):
...
class LoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Union['LoadBalancerAdaptiveRoutingArgs', 'LoadBalancerAdaptiveRoutingArgsDict']] adaptive_routing: Controls features that modify the routing of requests to pools and origins in response to dynamic conditions, such as
               during the interval between active health monitoring requests. For example, zero-downtime failover occurs immediately
               when an origin becomes unavailable due to HTTP 521, 522, or 523 response codes. If there is another healthy origin in
               the same pool, the request is retried once against this alternate origin.
        :param pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[str]]]]] country_pools: A mapping of country codes to a list of pool IDs (ordered by their failover priority) for the given country. Any country
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[str]]]]] pop_pools: (Enterprise only): A mapping of Cloudflare PoP identifiers to a list of pool IDs (ordered by their failover priority)
               ...
               region_pool mapping if it exists else to default_pools.
        :param pulumi.Input[bool] proxied: Whether the hostname should be gray clouded (false) or orange clouded (true).
        :param pulumi.Input[Union['LoadBalancerRandomSteeringArgs', 'LoadBalancerRandomSteeringArgsDict']] random_steering: Configures pool weights. - `steering_policy="random"`: A random pool is selected with probability proportional to pool
               weights. - `steering_policy="least_outstanding_requests"`: Use pool weights to scale each pool's outstanding requests. -
               `steering_policy="least_connections"`: Use pool weights to scale each pool's open connections.
        :param pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[str]]]]] region_pools: A mapping of region codes to a list of pool IDs (ordered by their failover priority) for the given region. Any regions
               not explicitly defined will fall back to using default_pools.
    ...
    @property
    @pulumi.getter(name="countryPools")
    def country_pools(self) -> pulumi.Output[Mapping[str, Sequence[str]]]:
        """
        A mapping of country codes to a list of pool IDs (ordered by their failover priority) for the given country. Any country
        not explicitly defined will fall back to using the corresponding region_pool mapping if it exists else to default_pools.
        """
    ...
    @property
    @pulumi.getter(name="defaultPools")
    def default_pools(self) -> pulumi.Output[Sequence[str]]:
        """
        A list of pool IDs ordered by their failover priority. Pools defined here are used by default, or when region_pools are
        not configured for a given region.
        """
    ...
    @property
    @pulumi.getter(name="fallbackPool")
    def fallback_pool(self) -> pulumi.Output[str]:
        """
        The pool ID to use when all other pools are detected as unhealthy.
        """
        return pulumi.get(self, "fallback_pool")
    ...
    @property
    @pulumi.getter(name="popPools")
    def pop_pools(self) -> pulumi.Output[Mapping[str, Sequence[str]]]:
        """
        (Enterprise only): A mapping of Cloudflare PoP identifiers to a list of pool IDs (ordered by their failover priority)
        for the PoP (datacenter). Any PoPs not explicitly defined will fall back to using the corresponding country_pool, then
        region_pool mapping if it exists else to default_pools.
    ...
    @property
    @pulumi.getter
    def proxied(self) -> pulumi.Output[bool]:
        """
        Whether the hostname should be gray clouded (false) or orange clouded (true).
        """
        return pulumi.get(self, "proxied")
    ...
    @property
    @pulumi.getter(name="regionPools")
    def region_pools(self) -> pulumi.Output[Mapping[str, Sequence[str]]]:
        """
        A mapping of region codes to a list of pool IDs (ordered by their failover priority) for the given region. Any regions
        not explicitly defined will fall back to using default_pools.
        """
    ...
    @property
    @pulumi.getter(name="sessionAffinityTtl")
    def session_affinity_ttl(self) -> pulumi.Output[float]:
        """
        Time, in seconds, until a client's session expires after being created. Once the expiry time has been reached,
        subsequent requests may get sent to a different origin server. The accepted ranges per `session_affinity` policy are: -
        `"cookie"` / `"ip_cookie"`: The current default of 23 hours will be used unless explicitly set. The accepted range of
