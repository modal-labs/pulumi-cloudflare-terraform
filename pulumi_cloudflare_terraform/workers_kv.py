...
class WorkersKvArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] key_name: A key's name. The name may be at most 512 bytes. All printable, non-whitespace characters are valid. Use
               percent-encoding to define key names as part of a URL.
        :param pulumi.Input[str] namespace_id: Namespace identifier tag.
        :param pulumi.Input[str] value: A byte sequence to be stored, up to 25 MiB in length.
        :param pulumi.Input[str] metadata: Arbitrary JSON to be associated with a key/value pair.
        """
    ...
    def key_name(self) -> pulumi.Input[str]:
        """
        A key's name. The name may be at most 512 bytes. All printable, non-whitespace characters are valid. Use
        percent-encoding to define key names as part of a URL.
        """
...
class WorkersKv(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a WorkersKv resource with the given unique name, props, and options.
