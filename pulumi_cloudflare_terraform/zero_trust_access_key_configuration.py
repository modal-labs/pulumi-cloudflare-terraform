...
class ZeroTrustAccessKeyConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustAccessKeyConfiguration resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            days_until_next_rotation: Optional[pulumi.Input[float]] = None,
            key_rotation_interval_days: Optional[pulumi.Input[float]] = None,
            last_key_rotation_at: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustAccessKeyConfiguration':
        """
