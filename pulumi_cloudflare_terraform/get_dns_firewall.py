...
class GetDnsFirewallResult:
    ...
    def dns_firewall_id(self) -> Optional[str]:
...
def get_dns_firewall(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getDnsFirewall:getDnsFirewall', __args__, opts=opts, typ=GetDnsFirewallResult, package_ref=_utilities.get_package()).value
...
def get_dns_firewall_output(account_id: Optional[pulumi.Input[str]] = None,
                            dns_firewall_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getDnsFirewall:getDnsFirewall', __args__, opts=opts, typ=GetDnsFirewallResult, package_ref=_utilities.get_package())
