...
def get_tiered_cache(zone_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getTieredCache:getTieredCache', __args__, opts=opts, typ=GetTieredCacheResult, package_ref=_utilities.get_package()).value
...
def get_tiered_cache_output(zone_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getTieredCache:getTieredCache', __args__, opts=opts, typ=GetTieredCacheResult, package_ref=_utilities.get_package())
