...
def get_resource_group(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getResourceGroup:getResourceGroup', __args__, opts=opts, typ=GetResourceGroupResult, package_ref=_utilities.get_package()).value
...
def get_resource_group_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getResourceGroup:getResourceGroup', __args__, opts=opts, typ=GetResourceGroupResult, package_ref=_utilities.get_package())
