...
class GetPageShieldConnectionsListResult:
    ...
    def exclude_cdn_cgi(self) -> Optional[bool]:
...
def get_page_shield_connections_list(direction: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getPageShieldConnectionsList:getPageShieldConnectionsList', __args__, opts=opts, typ=GetPageShieldConnectionsListResult, package_ref=_utilities.get_package()).value
...
def get_page_shield_connections_list_output(direction: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getPageShieldConnectionsList:getPageShieldConnectionsList', __args__, opts=opts, typ=GetPageShieldConnectionsListResult, package_ref=_utilities.get_package())
