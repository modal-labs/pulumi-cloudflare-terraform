...
def get_workers_custom_domains(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWorkersCustomDomains:getWorkersCustomDomains', __args__, opts=opts, typ=GetWorkersCustomDomainsResult, package_ref=_utilities.get_package()).value
...
def get_workers_custom_domains_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWorkersCustomDomains:getWorkersCustomDomains', __args__, opts=opts, typ=GetWorkersCustomDomainsResult, package_ref=_utilities.get_package())
