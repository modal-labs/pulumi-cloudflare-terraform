...
class GetByoIpPrefixResult:
    ...
    def prefix_id(self) -> Optional[str]:
...
def get_byo_ip_prefix(prefix_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getByoIpPrefix:getByoIpPrefix', __args__, opts=opts, typ=GetByoIpPrefixResult, package_ref=_utilities.get_package()).value
...
def get_byo_ip_prefix_output(prefix_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getByoIpPrefix:getByoIpPrefix', __args__, opts=opts, typ=GetByoIpPrefixResult, package_ref=_utilities.get_package())
