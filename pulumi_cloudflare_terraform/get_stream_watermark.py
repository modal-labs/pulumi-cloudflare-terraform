...
class GetStreamWatermarkResult:
    ...
    def __init__(__self__, account_id=None, created=None, downloaded_from=None, height=None, id=None, identifier=None, name=None, opacity=None, padding=None, position=None, scale=None, size=None, uid=None, width=None):
        ...
        if height and not isinstance(height, float):
            raise TypeError("Expected argument 'height' to be a float")
        ...
        if width and not isinstance(width, float):
            raise TypeError("Expected argument 'width' to be a float")
...
def get_stream_watermark(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getStreamWatermark:getStreamWatermark', __args__, opts=opts, typ=GetStreamWatermarkResult, package_ref=_utilities.get_package()).value
...
def get_stream_watermark_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getStreamWatermark:getStreamWatermark', __args__, opts=opts, typ=GetStreamWatermarkResult, package_ref=_utilities.get_package())
