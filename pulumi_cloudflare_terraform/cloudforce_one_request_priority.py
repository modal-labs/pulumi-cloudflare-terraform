...
class CloudforceOneRequestPriorityArgs:
    ...
    @tlp.setter
    def tlp(self, value: pulumi.Input[str]):
...
class CloudforceOneRequestPriority(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CloudforceOneRequestPriority resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            tlp: Optional[pulumi.Input[str]] = None,
            tokens: Optional[pulumi.Input[float]] = None,
            updated: Optional[pulumi.Input[str]] = None) -> 'CloudforceOneRequestPriority':
        """
    ...
    @property
    @pulumi.getter
    def requirement(self) -> pulumi.Output[str]:
        """
        Requirement
        """
        return pulumi.get(self, "requirement")
