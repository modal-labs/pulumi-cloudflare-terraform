...
class GetAddressMapsResult:
    ...
    @property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetAddressMapsResultResult']:
        return pulumi.get(self, "results")


class AwaitableGetAddressMapsResult(GetAddressMapsResult):
...
def get_address_maps(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getAddressMaps:getAddressMaps', __args__, opts=opts, typ=GetAddressMapsResult, package_ref=_utilities.get_package()).value

    return AwaitableGetAddressMapsResult(
...
def get_address_maps_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getAddressMaps:getAddressMaps', __args__, opts=opts, typ=GetAddressMapsResult, package_ref=_utilities.get_package())
    return __ret__.apply(lambda __response__: GetAddressMapsResult(
