...
class ArgoTieredCachingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] value: Enables Tiered Caching.
...
class ArgoTieredCaching(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ArgoTieredCaching resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            modified_on: Optional[pulumi.Input[str]] = None,
            value: Optional[pulumi.Input[str]] = None,
            zone_id: Optional[pulumi.Input[str]] = None) -> 'ArgoTieredCaching':
        """
