...
def get_r2_bucket_sippy(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getR2BucketSippy:getR2BucketSippy', __args__, opts=opts, typ=GetR2BucketSippyResult, package_ref=_utilities.get_package()).value
...
def get_r2_bucket_sippy_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getR2BucketSippy:getR2BucketSippy', __args__, opts=opts, typ=GetR2BucketSippyResult, package_ref=_utilities.get_package())
