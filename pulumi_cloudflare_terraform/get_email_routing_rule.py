...
def get_email_routing_rule(filter: Optional[Union['GetEmailRoutingRuleFilterArgs', 'GetEmailRoutingRuleFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getEmailRoutingRule:getEmailRoutingRule', __args__, opts=opts, typ=GetEmailRoutingRuleResult, package_ref=_utilities.get_package()).value
...
def get_email_routing_rule_output(filter: Optional[pulumi.Input[Optional[Union['GetEmailRoutingRuleFilterArgs', 'GetEmailRoutingRuleFilterArgsDict']]]] = None,
                                  rule_identifier: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getEmailRoutingRule:getEmailRoutingRule', __args__, opts=opts, typ=GetEmailRoutingRuleResult, package_ref=_utilities.get_package())
