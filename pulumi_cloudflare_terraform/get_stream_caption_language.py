...
def get_stream_caption_language(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getStreamCaptionLanguage:getStreamCaptionLanguage', __args__, opts=opts, typ=GetStreamCaptionLanguageResult, package_ref=_utilities.get_package()).value
...
def get_stream_caption_language_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getStreamCaptionLanguage:getStreamCaptionLanguage', __args__, opts=opts, typ=GetStreamCaptionLanguageResult, package_ref=_utilities.get_package())
