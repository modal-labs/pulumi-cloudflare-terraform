...
class PageShieldPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] value: The policy which will be applied
...
class PageShieldPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PageShieldPolicy resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            expression: Optional[pulumi.Input[str]] = None,
            value: Optional[pulumi.Input[str]] = None,
            zone_id: Optional[pulumi.Input[str]] = None) -> 'PageShieldPolicy':
        """
