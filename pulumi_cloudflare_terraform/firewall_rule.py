...
class _FirewallRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['FirewallRuleActionArgs'] action: The action to perform when the threshold of matched traffic within the configured period is exceeded.
        :param pulumi.Input[str] description: An informative summary of the firewall rule.
        :param pulumi.Input[bool] paused: When true, indicates that the firewall rule is currently paused.
        :param pulumi.Input[float] priority: The priority of the rule. Optional value used to define the processing order. A lower number indicates a higher
               priority. If not provided, rules with a defined priority will be processed before rules without a priority.
    ...
    def priority(self) -> Optional[pulumi.Input[float]]:
        """
        The priority of the rule. Optional value used to define the processing order. A lower number indicates a higher
        priority. If not provided, rules with a defined priority will be processed before rules without a priority.
        """
