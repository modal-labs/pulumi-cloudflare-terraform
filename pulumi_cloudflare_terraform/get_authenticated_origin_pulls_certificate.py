...
def get_authenticated_origin_pulls_certificate(certificate_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getAuthenticatedOriginPullsCertificate:getAuthenticatedOriginPullsCertificate', __args__, opts=opts, typ=GetAuthenticatedOriginPullsCertificateResult, package_ref=_utilities.get_package()).value
...
def get_authenticated_origin_pulls_certificate_output(certificate_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getAuthenticatedOriginPullsCertificate:getAuthenticatedOriginPullsCertificate', __args__, opts=opts, typ=GetAuthenticatedOriginPullsCertificateResult, package_ref=_utilities.get_package())
