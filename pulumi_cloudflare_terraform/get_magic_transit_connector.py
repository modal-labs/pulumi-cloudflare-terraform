...
def get_magic_transit_connector(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMagicTransitConnector:getMagicTransitConnector', __args__, opts=opts, typ=GetMagicTransitConnectorResult, package_ref=_utilities.get_package()).value
...
def get_magic_transit_connector_output(account_id: Optional[pulumi.Input[str]] = None,
                                       connector_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMagicTransitConnector:getMagicTransitConnector', __args__, opts=opts, typ=GetMagicTransitConnectorResult, package_ref=_utilities.get_package())
