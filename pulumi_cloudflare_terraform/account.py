...
class AccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AccountUnitArgs'] unit: information related to the tenant unit, and optionally, an id of the unit to create the account on. see
...
class _AccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] created_on: Timestamp for the creation of the account
        :param pulumi.Input[str] name: Account name
        :param pulumi.Input['AccountSettingsArgs'] settings: Account settings
        :param pulumi.Input[str] type: the type of account being created. For self-serve customers, use standard. for enterprise customers, use enterprise.
        :param pulumi.Input['AccountUnitArgs'] unit: information related to the tenant unit, and optionally, an id of the unit to create the account on. see
...
class Account(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[str] type: the type of account being created. For self-serve customers, use standard. for enterprise customers, use enterprise.
        :param pulumi.Input[Union['AccountUnitArgs', 'AccountUnitArgsDict']] unit: information related to the tenant unit, and optionally, an id of the unit to create the account on. see
               https://developers.cloudflare.com/tenant/how-to/manage-accounts/
        """
        ...
    @overload
