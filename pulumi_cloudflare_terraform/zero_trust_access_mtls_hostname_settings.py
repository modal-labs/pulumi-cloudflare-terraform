...
class _ZeroTrustAccessMtlsHostnameSettingsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] client_certificate_forwarding: Client Certificate Forwarding is a feature that takes the client cert provided by the eyeball to the edge, and forwards
               it to the origin as a HTTP header to allow logging on the origin.
    ...
    def client_certificate_forwarding(self) -> Optional[pulumi.Input[bool]]:
        """
        Client Certificate Forwarding is a feature that takes the client cert provided by the eyeball to the edge, and forwards
        it to the origin as a HTTP header to allow logging on the origin.
        """
...
class ZeroTrustAccessMtlsHostnameSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustAccessMtlsHostnameSettings resource with the given unique name, props, and options.
