...
__all__ = [
    ...
    'AwaitableGetMagicTransitConnectorsResult',
    'get_magic_transit_connectors',
...
class GetMagicTransitConnectorsResult:
    ...
    @property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetMagicTransitConnectorsResultResult']:
        return pulumi.get(self, "results")


class AwaitableGetMagicTransitConnectorsResult(GetMagicTransitConnectorsResult):
...
def get_magic_transit_connectors(account_id: Optional[str] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMagicTransitConnectorsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMagicTransitConnectors:getMagicTransitConnectors', __args__, opts=opts, typ=GetMagicTransitConnectorsResult, package_ref=_utilities.get_package()).value
...
def get_magic_transit_connectors_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMagicTransitConnectors:getMagicTransitConnectors', __args__, opts=opts, typ=GetMagicTransitConnectorsResult, package_ref=_utilities.get_package())
