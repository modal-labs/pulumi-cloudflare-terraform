...
class ZoneSettingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] setting_id: Setting name
...
class _ZoneSettingState:
    def __init__(__self__, *,
                 ...
                 time_remaining: Optional[pulumi.Input[float]] = None,
                 value: Optional[Any] = None,
                 zone_id: Optional[pulumi.Input[str]] = None,
                 zone_setting_id: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering ZoneSetting resources.
        :param pulumi.Input[bool] editable: Whether or not this setting can be modified for this zone (based on your Cloudflare plan level).
        :param pulumi.Input[str] modified_on: last time this setting was modified.
        :param pulumi.Input[str] setting_id: Setting name
        :param pulumi.Input[float] time_remaining: Value of the zone setting. Notes: The interval (in seconds) from when development mode expires (positive integer) or
               last expired (negative integer) for the domain. If development mode has never been enabled, this value is false.
        :param Any value: Current value of the zone setting.
        :param pulumi.Input[str] zone_id: Identifier
        :param pulumi.Input[str] zone_setting_id: ID of the zone setting.
        """
    ...
    def time_remaining(self) -> Optional[pulumi.Input[float]]:
        """
        Value of the zone setting. Notes: The interval (in seconds) from when development mode expires (positive integer) or
        last expired (negative integer) for the domain. If development mode has never been enabled, this value is false.
        """
        return pulumi.get(self, "time_remaining")

    @time_remaining.setter
    def time_remaining(self, value: Optional[pulumi.Input[float]]):
...
class ZoneSetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZoneSetting resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            value: Optional[Any] = None,
            zone_id: Optional[pulumi.Input[str]] = None,
            zone_setting_id: Optional[pulumi.Input[str]] = None) -> 'ZoneSetting':
        """
    ...
    @property
    @pulumi.getter(name="timeRemaining")
    def time_remaining(self) -> pulumi.Output[float]:
        """
        Value of the zone setting. Notes: The interval (in seconds) from when development mode expires (positive integer) or
        last expired (negative integer) for the domain. If development mode has never been enabled, this value is false.
        """
    ...
    @property
    @pulumi.getter(name="zoneSettingId")
    def zone_setting_id(self) -> pulumi.Output[Optional[str]]:
        """
        ID of the zone setting.
        """
        return pulumi.get(self, "zone_setting_id")
