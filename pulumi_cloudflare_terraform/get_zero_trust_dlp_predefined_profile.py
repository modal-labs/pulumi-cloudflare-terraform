...
class GetZeroTrustDlpPredefinedProfileResult:
    ...
    def __init__(__self__, account_id=None, ai_context_enabled=None, allowed_match_count=None, confidence_threshold=None, context_awareness=None, created_at=None, description=None, entries=None, id=None, name=None, ocr_enabled=None, open_access=None, profile_id=None, type=None, updated_at=None):
        ...
        if allowed_match_count and not isinstance(allowed_match_count, float):
            raise TypeError("Expected argument 'allowed_match_count' to be a float")
    ...
    def allowed_match_count(self) -> float:
...
def get_zero_trust_dlp_predefined_profile(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDlpPredefinedProfile:getZeroTrustDlpPredefinedProfile', __args__, opts=opts, typ=GetZeroTrustDlpPredefinedProfileResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_dlp_predefined_profile_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDlpPredefinedProfile:getZeroTrustDlpPredefinedProfile', __args__, opts=opts, typ=GetZeroTrustDlpPredefinedProfileResult, package_ref=_utilities.get_package())
