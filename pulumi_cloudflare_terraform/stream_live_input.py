...
class StreamLiveInputArgs:
    def __init__(__self__, *,
                 ...
                 default_creator: Optional[pulumi.Input[str]] = None,
                 delete_recording_after_days: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[str] default_creator: Sets the creator ID asssociated with this live input.
        :param pulumi.Input[float] delete_recording_after_days: Indicates the number of days after which the live inputs recordings will be deleted. When a stream completes and the
               recording is ready, the value is used to calculate a scheduled deletion date for that recording. Omit the field to
               indicate no change, or include with a `null` value to remove an existing scheduled deletion.
        :param pulumi.Input[str] live_input_identifier: A unique identifier for a live input.
        :param pulumi.Input[str] meta: A user modifiable key-value store used to reference other systems of record for managing live inputs.
        :param pulumi.Input['StreamLiveInputRecordingArgs'] recording: Records the input to a Cloudflare Stream video. Behavior depends on the mode. In most cases, the video will initially be
               viewable as a live video and transition to on-demand after a condition is satisfied.
        """
    ...
    def default_creator(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def default_creator(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "default_creator", value)

    @property
    @pulumi.getter(name="deleteRecordingAfterDays")
    def delete_recording_after_days(self) -> Optional[pulumi.Input[float]]:
        """
        Indicates the number of days after which the live inputs recordings will be deleted. When a stream completes and the
        recording is ready, the value is used to calculate a scheduled deletion date for that recording. Omit the field to
        indicate no change, or include with a `null` value to remove an existing scheduled deletion.
        """
    ...
    def delete_recording_after_days(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "delete_recording_after_days", value)

    @property
    @pulumi.getter(name="liveInputIdentifier")
    def live_input_identifier(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def live_input_identifier(self, value: Optional[pulumi.Input[str]]):
    ...
    def recording(self) -> Optional[pulumi.Input['StreamLiveInputRecordingArgs']]:
        """
        Records the input to a Cloudflare Stream video. Behavior depends on the mode. In most cases, the video will initially be
        viewable as a live video and transition to on-demand after a condition is satisfied.
        """
...
class _StreamLiveInputState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] account_id: Identifier
        :param pulumi.Input[str] created: The date and time the live input was created.
        :param pulumi.Input[str] default_creator: Sets the creator ID asssociated with this live input.
        :param pulumi.Input[float] delete_recording_after_days: Indicates the number of days after which the live inputs recordings will be deleted. When a stream completes and the
               recording is ready, the value is used to calculate a scheduled deletion date for that recording. Omit the field to
               indicate no change, or include with a `null` value to remove an existing scheduled deletion.
        :param pulumi.Input[str] live_input_identifier: A unique identifier for a live input.
        :param pulumi.Input[str] meta: A user modifiable key-value store used to reference other systems of record for managing live inputs.
        :param pulumi.Input[str] modified: The date and time the live input was last modified.
        :param pulumi.Input['StreamLiveInputRecordingArgs'] recording: Records the input to a Cloudflare Stream video. Behavior depends on the mode. In most cases, the video will initially be
               viewable as a live video and transition to on-demand after a condition is satisfied.
...
class StreamLiveInput(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a StreamLiveInput resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] live_input_identifier: A unique identifier for a live input.
        :param pulumi.Input[str] meta: A user modifiable key-value store used to reference other systems of record for managing live inputs.
        :param pulumi.Input[Union['StreamLiveInputRecordingArgs', 'StreamLiveInputRecordingArgsDict']] recording: Records the input to a Cloudflare Stream video. Behavior depends on the mode. In most cases, the video will initially be
               viewable as a live video and transition to on-demand after a condition is satisfied.
        """
        ...
    @overload
    ...
    @property
    @pulumi.getter(name="defaultCreator")
    def default_creator(self) -> pulumi.Output[Optional[str]]:
        """
        Sets the creator ID asssociated with this live input.
        """
        return pulumi.get(self, "default_creator")
    ...
    @property
    @pulumi.getter(name="deleteRecordingAfterDays")
    def delete_recording_after_days(self) -> pulumi.Output[Optional[float]]:
        """
        Indicates the number of days after which the live inputs recordings will be deleted. When a stream completes and the
        recording is ready, the value is used to calculate a scheduled deletion date for that recording. Omit the field to
        indicate no change, or include with a `null` value to remove an existing scheduled deletion.
    ...
    @property
    @pulumi.getter(name="liveInputIdentifier")
    def live_input_identifier(self) -> pulumi.Output[Optional[str]]:
        """
        A unique identifier for a live input.
        """
        return pulumi.get(self, "live_input_identifier")
