...
def get_zero_trust_device_managed_networks(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDeviceManagedNetworks:getZeroTrustDeviceManagedNetworks', __args__, opts=opts, typ=GetZeroTrustDeviceManagedNetworksResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_device_managed_networks_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDeviceManagedNetworks:getZeroTrustDeviceManagedNetworks', __args__, opts=opts, typ=GetZeroTrustDeviceManagedNetworksResult, package_ref=_utilities.get_package())
