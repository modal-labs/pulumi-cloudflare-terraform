...
def get_queues(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getQueues:getQueues', __args__, opts=opts, typ=GetQueuesResult, package_ref=_utilities.get_package()).value
...
def get_queues_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getQueues:getQueues', __args__, opts=opts, typ=GetQueuesResult, package_ref=_utilities.get_package())
