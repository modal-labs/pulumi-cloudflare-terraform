...
def get_zero_trust_device_default_profile_certificates(zone_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDeviceDefaultProfileCertificates:getZeroTrustDeviceDefaultProfileCertificates', __args__, opts=opts, typ=GetZeroTrustDeviceDefaultProfileCertificatesResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_device_default_profile_certificates_output(zone_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDeviceDefaultProfileCertificates:getZeroTrustDeviceDefaultProfileCertificates', __args__, opts=opts, typ=GetZeroTrustDeviceDefaultProfileCertificatesResult, package_ref=_utilities.get_package())
