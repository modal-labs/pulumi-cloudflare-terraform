...
class ZeroTrustAccessInfrastructureTargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] hostname: A non-unique field that refers to a target. Case insensitive, maximum length of 255 characters, supports the use of
               special characters dash and period, does not support spaces, and must start and end with an alphanumeric character.
    ...
    def hostname(self) -> pulumi.Input[str]:
        """
        A non-unique field that refers to a target. Case insensitive, maximum length of 255 characters, supports the use of
        special characters dash and period, does not support spaces, and must start and end with an alphanumeric character.
        """
...
class _ZeroTrustAccessInfrastructureTargetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] account_id: Account identifier
        :param pulumi.Input[str] created_at: Date and time at which the target was created
        :param pulumi.Input[str] hostname: A non-unique field that refers to a target. Case insensitive, maximum length of 255 characters, supports the use of
               special characters dash and period, does not support spaces, and must start and end with an alphanumeric character.
        :param pulumi.Input['ZeroTrustAccessInfrastructureTargetIpArgs'] ip: The IPv4/IPv6 address that identifies where to reach a target
        :param pulumi.Input[str] modified_at: Date and time at which the target was modified
        """
...
class ZeroTrustAccessInfrastructureTarget(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustAccessInfrastructureTarget resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            hostname: Optional[pulumi.Input[str]] = None,
            ip: Optional[pulumi.Input[Union['ZeroTrustAccessInfrastructureTargetIpArgs', 'ZeroTrustAccessInfrastructureTargetIpArgsDict']]] = None,
            modified_at: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustAccessInfrastructureTarget':
        """
