...
class ZeroTrustTunnelCloudflaredVirtualNetwork(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustTunnelCloudflaredVirtualNetwork resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            is_default: Optional[pulumi.Input[bool]] = None,
            is_default_network: Optional[pulumi.Input[bool]] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustTunnelCloudflaredVirtualNetwork':
        """
