...
def get_notification_policy_webhooks(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getNotificationPolicyWebhooks:getNotificationPolicyWebhooks', __args__, opts=opts, typ=GetNotificationPolicyWebhooksResult, package_ref=_utilities.get_package()).value
...
def get_notification_policy_webhooks_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getNotificationPolicyWebhooks:getNotificationPolicyWebhooks', __args__, opts=opts, typ=GetNotificationPolicyWebhooksResult, package_ref=_utilities.get_package())
