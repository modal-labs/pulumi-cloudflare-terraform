...
class EmailSecurityImpersonationRegistryArgs:
    def __init__(__self__, *,
                 ...
                 is_email_regex: pulumi.Input[bool],
    ...
    def is_email_regex(self) -> pulumi.Input[bool]:
        return pulumi.get(self, "is_email_regex")

    @is_email_regex.setter
    def is_email_regex(self, value: pulumi.Input[bool]):
...
class _EmailSecurityImpersonationRegistryState:
    def __init__(__self__, *,
                 ...
                 directory_id: Optional[pulumi.Input[float]] = None,
                 directory_node_id: Optional[pulumi.Input[float]] = None,
                 email: Optional[pulumi.Input[str]] = None,
                 email_security_impersonation_registry_id: Optional[pulumi.Input[float]] = None,
                 external_directory_node_id: Optional[pulumi.Input[str]] = None,
                 is_email_regex: Optional[pulumi.Input[bool]] = None,
    ...
    def directory_id(self) -> Optional[pulumi.Input[float]]:
        return pulumi.get(self, "directory_id")

    @directory_id.setter
    def directory_id(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "directory_id", value)

    @property
    @pulumi.getter(name="directoryNodeId")
    def directory_node_id(self) -> Optional[pulumi.Input[float]]:
        return pulumi.get(self, "directory_node_id")

    @directory_node_id.setter
    def directory_node_id(self, value: Optional[pulumi.Input[float]]):
    ...
    def email_security_impersonation_registry_id(self) -> Optional[pulumi.Input[float]]:
        return pulumi.get(self, "email_security_impersonation_registry_id")

    @email_security_impersonation_registry_id.setter
    def email_security_impersonation_registry_id(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "email_security_impersonation_registry_id", value)

    @property
    @pulumi.getter(name="externalDirectoryNodeId")
    def external_directory_node_id(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "external_directory_node_id")

    @external_directory_node_id.setter
    def external_directory_node_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "external_directory_node_id", value)

    @property
    @pulumi.getter(name="isEmailRegex")
    def is_email_regex(self) -> Optional[pulumi.Input[bool]]:
        return pulumi.get(self, "is_email_regex")

    @is_email_regex.setter
    def is_email_regex(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "is_email_regex", value)
    ...
    @property
    @pulumi.getter
    def provenance(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "provenance")

    @provenance.setter
    def provenance(self, value: Optional[pulumi.Input[str]]):
...
class EmailSecurityImpersonationRegistry(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a EmailSecurityImpersonationRegistry resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            last_modified: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None,
            provenance: Optional[pulumi.Input[str]] = None) -> 'EmailSecurityImpersonationRegistry':
        """
    ...
    @property
    @pulumi.getter(name="directoryId")
    def directory_id(self) -> pulumi.Output[float]:
        return pulumi.get(self, "directory_id")

    @property
    @pulumi.getter(name="directoryNodeId")
    def directory_node_id(self) -> pulumi.Output[float]:
        return pulumi.get(self, "directory_node_id")
    ...
    @property
    @pulumi.getter(name="emailSecurityImpersonationRegistryId")
    def email_security_impersonation_registry_id(self) -> pulumi.Output[float]:
        return pulumi.get(self, "email_security_impersonation_registry_id")

    @property
    @pulumi.getter(name="externalDirectoryNodeId")
    def external_directory_node_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "external_directory_node_id")

    @property
    @pulumi.getter(name="isEmailRegex")
    def is_email_regex(self) -> pulumi.Output[bool]:
        return pulumi.get(self, "is_email_regex")
    ...
    @property
    @pulumi.getter
    def provenance(self) -> pulumi.Output[str]:
        return pulumi.get(self, "provenance")
