...
class WebAnalyticsRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] ruleset_id: The Web Analytics ruleset identifier.
...
class WebAnalyticsRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a WebAnalyticsRule resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter
    def inclusive(self) -> pulumi.Output[Optional[bool]]:
        """
        Whether the rule includes or excludes traffic from being measured.
        """
        return pulumi.get(self, "inclusive")
