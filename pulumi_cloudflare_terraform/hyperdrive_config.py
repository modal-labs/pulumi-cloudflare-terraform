...
class _HyperdriveConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] account_id: Identifier
        :param pulumi.Input[str] created_on: When the Hyperdrive configuration was created.
        :param pulumi.Input[str] modified_on: When the Hyperdrive configuration was last modified.
        """
...
class HyperdriveConfig(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a HyperdriveConfig resource with the given unique name, props, and options.
