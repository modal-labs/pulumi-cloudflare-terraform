...
def get_load_balancer(country_pools: Optional[Mapping[str, Sequence[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getLoadBalancer:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult, package_ref=_utilities.get_package()).value
...
def get_load_balancer_output(country_pools: Optional[pulumi.Input[Optional[Mapping[str, Sequence[str]]]]] = None,
                             ...
                             region_pools: Optional[pulumi.Input[Optional[Mapping[str, Sequence[str]]]]] = None,
                             session_affinity_ttl: Optional[pulumi.Input[Optional[float]]] = None,
                             steering_policy: Optional[pulumi.Input[Optional[str]]] = None,
                             ttl: Optional[pulumi.Input[Optional[float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getLoadBalancer:getLoadBalancer', __args__, opts=opts, typ=GetLoadBalancerResult, package_ref=_utilities.get_package())
