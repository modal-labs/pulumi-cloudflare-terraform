...
def get_magic_network_monitoring_rules(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMagicNetworkMonitoringRules:getMagicNetworkMonitoringRules', __args__, opts=opts, typ=GetMagicNetworkMonitoringRulesResult, package_ref=_utilities.get_package()).value
...
def get_magic_network_monitoring_rules_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMagicNetworkMonitoringRules:getMagicNetworkMonitoringRules', __args__, opts=opts, typ=GetMagicNetworkMonitoringRulesResult, package_ref=_utilities.get_package())
