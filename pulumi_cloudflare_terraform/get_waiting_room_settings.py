...
class GetWaitingRoomSettingsResult:
    ...
    def search_engine_crawler_bypass(self) -> bool:
...
def get_waiting_room_settings(zone_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWaitingRoomSettings:getWaitingRoomSettings', __args__, opts=opts, typ=GetWaitingRoomSettingsResult, package_ref=_utilities.get_package()).value
...
def get_waiting_room_settings_output(zone_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWaitingRoomSettings:getWaitingRoomSettings', __args__, opts=opts, typ=GetWaitingRoomSettingsResult, package_ref=_utilities.get_package())
