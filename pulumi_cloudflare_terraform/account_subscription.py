...
class AccountSubscriptionArgs:
    ...
    def subscription_identifier(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def subscription_identifier(self, value: Optional[pulumi.Input[str]]):
...
class _AccountSubscriptionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] current_period_start: When the current billing period started. May match initial_period_start if this is the first period.
        :param pulumi.Input[str] frequency: How often the subscription is renewed automatically.
...
class AccountSubscription(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="subscriptionIdentifier")
    def subscription_identifier(self) -> pulumi.Output[Optional[str]]:
        """
        Subscription identifier tag.
        """
        return pulumi.get(self, "subscription_identifier")
