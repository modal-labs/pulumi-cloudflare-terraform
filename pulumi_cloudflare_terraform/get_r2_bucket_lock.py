...
def get_r2_bucket_lock(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getR2BucketLock:getR2BucketLock', __args__, opts=opts, typ=GetR2BucketLockResult, package_ref=_utilities.get_package()).value
...
def get_r2_bucket_lock_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getR2BucketLock:getR2BucketLock', __args__, opts=opts, typ=GetR2BucketLockResult, package_ref=_utilities.get_package())
