...
def get_zero_trust_access_policy(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustAccessPolicy:getZeroTrustAccessPolicy', __args__, opts=opts, typ=GetZeroTrustAccessPolicyResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_access_policy_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustAccessPolicy:getZeroTrustAccessPolicy', __args__, opts=opts, typ=GetZeroTrustAccessPolicyResult, package_ref=_utilities.get_package())
