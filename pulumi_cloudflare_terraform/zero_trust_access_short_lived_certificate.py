...
class ZeroTrustAccessShortLivedCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] app_id: UUID
...
class _ZeroTrustAccessShortLivedCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] account_id: The Account ID to use for this endpoint. Mutually exclusive with the Zone ID.
        :param pulumi.Input[str] app_id: UUID
        :param pulumi.Input[str] aud: The Application Audience (AUD) tag. Identifies the application associated with the CA.
        :param pulumi.Input[str] public_key: The public key to add to your SSH server configuration.
        :param pulumi.Input[str] zone_id: The Zone ID to use for this endpoint. Mutually exclusive with the Account ID.
        """
        if account_id is not None:
            pulumi.set(__self__, "account_id", account_id)
...
class ZeroTrustAccessShortLivedCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustAccessShortLivedCertificate resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            aud: Optional[pulumi.Input[str]] = None,
            public_key: Optional[pulumi.Input[str]] = None,
            zone_id: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustAccessShortLivedCertificate':
        """
