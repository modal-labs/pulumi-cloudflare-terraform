...
def get_workers_secret(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWorkersSecret:getWorkersSecret', __args__, opts=opts, typ=GetWorkersSecretResult, package_ref=_utilities.get_package()).value
...
def get_workers_secret_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWorkersSecret:getWorkersSecret', __args__, opts=opts, typ=GetWorkersSecretResult, package_ref=_utilities.get_package())
