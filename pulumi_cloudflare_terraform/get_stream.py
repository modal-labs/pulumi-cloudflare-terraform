...
class GetStreamResult:
    ...
    def __init__(__self__, account_id=None, allowed_origins=None, created=None, creator=None, duration=None, id=None, identifier=None, input=None, live_input=None, max_duration_seconds=None, meta=None, modified=None, playback=None, preview=None, ready_to_stream=None, ready_to_stream_at=None, require_signed_urls=None, scheduled_deletion=None, size=None, status=None, thumbnail=None, thumbnail_timestamp_pct=None, uid=None, upload_expiry=None, uploaded=None, watermark=None):
        ...
        if max_duration_seconds and not isinstance(max_duration_seconds, float):
            raise TypeError("Expected argument 'max_duration_seconds' to be a float")
...
def get_stream(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getStream:getStream', __args__, opts=opts, typ=GetStreamResult, package_ref=_utilities.get_package()).value
...
def get_stream_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getStream:getStream', __args__, opts=opts, typ=GetStreamResult, package_ref=_utilities.get_package())
