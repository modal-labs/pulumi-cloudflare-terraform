...
def get_api_shield_schema(omit_source: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getApiShieldSchema:getApiShieldSchema', __args__, opts=opts, typ=GetApiShieldSchemaResult, package_ref=_utilities.get_package()).value
...
def get_api_shield_schema_output(omit_source: Optional[pulumi.Input[Optional[bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getApiShieldSchema:getApiShieldSchema', __args__, opts=opts, typ=GetApiShieldSchemaResult, package_ref=_utilities.get_package())
