...
def get_api_shield_schemas(max_items: Optional[float] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getApiShieldSchemas:getApiShieldSchemas', __args__, opts=opts, typ=GetApiShieldSchemasResult, package_ref=_utilities.get_package()).value
...
def get_api_shield_schemas_output(max_items: Optional[pulumi.Input[Optional[float]]] = None,
                                  omit_source: Optional[pulumi.Input[Optional[bool]]] = None,
                                  validation_enabled: Optional[pulumi.Input[Optional[bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getApiShieldSchemas:getApiShieldSchemas', __args__, opts=opts, typ=GetApiShieldSchemasResult, package_ref=_utilities.get_package())
