...
__all__ = [
    ...
    'AwaitableGetZeroTrustDeviceCustomProfilesResult',
    'get_zero_trust_device_custom_profiles',
...
class AwaitableGetZeroTrustDeviceCustomProfilesResult(GetZeroTrustDeviceCustomProfilesResult):
...
def get_zero_trust_device_custom_profiles(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDeviceCustomProfiles:getZeroTrustDeviceCustomProfiles', __args__, opts=opts, typ=GetZeroTrustDeviceCustomProfilesResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_device_custom_profiles_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDeviceCustomProfiles:getZeroTrustDeviceCustomProfiles', __args__, opts=opts, typ=GetZeroTrustDeviceCustomProfilesResult, package_ref=_utilities.get_package())
