...
class GetCustomHostnameResult:
    ...
    def custom_hostname_id(self) -> Optional[str]:
...
def get_custom_hostname(custom_hostname_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getCustomHostname:getCustomHostname', __args__, opts=opts, typ=GetCustomHostnameResult, package_ref=_utilities.get_package()).value
...
def get_custom_hostname_output(custom_hostname_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getCustomHostname:getCustomHostname', __args__, opts=opts, typ=GetCustomHostnameResult, package_ref=_utilities.get_package())
