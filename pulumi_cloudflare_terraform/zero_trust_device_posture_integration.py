...
class ZeroTrustDevicePostureIntegrationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] interval: The interval between each posture check with the third-party API. Use `m` for minutes (e.g. `5m`) and `h` for hours
               (e.g. `12h`).
    ...
    def interval(self) -> pulumi.Input[str]:
        """
        The interval between each posture check with the third-party API. Use `m` for minutes (e.g. `5m`) and `h` for hours
        (e.g. `12h`).
        """
...
class ZeroTrustDevicePostureIntegration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustDevicePostureIntegration resource with the given unique name, props, and options.
