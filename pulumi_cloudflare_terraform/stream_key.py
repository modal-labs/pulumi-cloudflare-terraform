...
class _StreamKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] account_id: Identifier
        :param pulumi.Input[str] created: The date and time a signing key was created.
        :param pulumi.Input[str] jwk: The signing key in JWK format.
        :param pulumi.Input[str] pem: The signing key in PEM format.
        """
...
class StreamKey(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a StreamKey resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            created: Optional[pulumi.Input[str]] = None,
            jwk: Optional[pulumi.Input[str]] = None,
            pem: Optional[pulumi.Input[str]] = None) -> 'StreamKey':
        """
        ...
        __props__ = _StreamKeyState.__new__(_StreamKeyState)
