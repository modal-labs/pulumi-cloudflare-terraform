...
class GetPageShieldCookiesResult:
    ...
    def __init__(__self__, cookie_id=None, domain_attribute=None, expires_attribute=None, first_seen_at=None, host=None, http_only_attribute=None, id=None, last_seen_at=None, max_age_attribute=None, name=None, page_urls=None, path_attribute=None, same_site_attribute=None, secure_attribute=None, type=None, zone_id=None):
        ...
        if max_age_attribute and not isinstance(max_age_attribute, float):
            raise TypeError("Expected argument 'max_age_attribute' to be a float")
    ...
    def max_age_attribute(self) -> float:
...
def get_page_shield_cookies(cookie_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getPageShieldCookies:getPageShieldCookies', __args__, opts=opts, typ=GetPageShieldCookiesResult, package_ref=_utilities.get_package()).value
...
def get_page_shield_cookies_output(cookie_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getPageShieldCookies:getPageShieldCookies', __args__, opts=opts, typ=GetPageShieldCookiesResult, package_ref=_utilities.get_package())
