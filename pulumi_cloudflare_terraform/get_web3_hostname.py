...
def get_web3_hostname(identifier: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWeb3Hostname:getWeb3Hostname', __args__, opts=opts, typ=GetWeb3HostnameResult, package_ref=_utilities.get_package()).value
...
def get_web3_hostname_output(identifier: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWeb3Hostname:getWeb3Hostname', __args__, opts=opts, typ=GetWeb3HostnameResult, package_ref=_utilities.get_package())
