...
def get_zone_subscription(identifier: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZoneSubscription:getZoneSubscription', __args__, opts=opts, typ=GetZoneSubscriptionResult, package_ref=_utilities.get_package()).value
...
def get_zone_subscription_output(identifier: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZoneSubscription:getZoneSubscription', __args__, opts=opts, typ=GetZoneSubscriptionResult, package_ref=_utilities.get_package())
