...
def get_zero_trust_tunnel_cloudflared_virtual_networks(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustTunnelCloudflaredVirtualNetworks:getZeroTrustTunnelCloudflaredVirtualNetworks', __args__, opts=opts, typ=GetZeroTrustTunnelCloudflaredVirtualNetworksResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_tunnel_cloudflared_virtual_networks_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustTunnelCloudflaredVirtualNetworks:getZeroTrustTunnelCloudflaredVirtualNetworks', __args__, opts=opts, typ=GetZeroTrustTunnelCloudflaredVirtualNetworksResult, package_ref=_utilities.get_package())
