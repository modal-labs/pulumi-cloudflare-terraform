...
class RateLimitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] period: The time in seconds (an integer value) to count matching traffic. If the count exceeds the configured threshold within
               this period, Cloudflare will perform the configured action.
        :param pulumi.Input[float] threshold: The threshold that will trigger the configured mitigation action. Configure this value along with the `period` property
    ...
    def period(self) -> pulumi.Input[float]:
        """
        The time in seconds (an integer value) to count matching traffic. If the count exceeds the configured threshold within
        this period, Cloudflare will perform the configured action.
        """
    ...
    def threshold(self) -> pulumi.Input[float]:
        """
        The threshold that will trigger the configured mitigation action. Configure this value along with the `period` property
        to establish a threshold per period.
        """
...
class _RateLimitState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['RateLimitActionArgs'] action: The action to perform when the threshold of matched traffic within the configured period is exceeded.
        :param pulumi.Input[Sequence[pulumi.Input['RateLimitBypassArgs']]] bypasses: Criteria specifying when the current rate limit should be bypassed. You can specify that the rate limit should not apply
               to one or more URLs.
        :param pulumi.Input[str] description: An informative summary of the rate limit. This value is sanitized and any tags will be removed.
        :param pulumi.Input[bool] disabled: When true, indicates that the rate limit is currently disabled.
        :param pulumi.Input['RateLimitMatchArgs'] match: Determines which traffic the rate limit counts towards the threshold.
        :param pulumi.Input[float] period: The time in seconds (an integer value) to count matching traffic. If the count exceeds the configured threshold within
               this period, Cloudflare will perform the configured action.
        :param pulumi.Input[float] threshold: The threshold that will trigger the configured mitigation action. Configure this value along with the `period` property
    ...
    def bypasses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['RateLimitBypassArgs']]]]:
        """
        Criteria specifying when the current rate limit should be bypassed. You can specify that the rate limit should not apply
        to one or more URLs.
        """
...
class RateLimit(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a RateLimit resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Union['RateLimitActionArgs', 'RateLimitActionArgsDict']] action: The action to perform when the threshold of matched traffic within the configured period is exceeded.
        :param pulumi.Input[Sequence[pulumi.Input[Union['RateLimitBypassArgs', 'RateLimitBypassArgsDict']]]] bypasses: Criteria specifying when the current rate limit should be bypassed. You can specify that the rate limit should not apply
               to one or more URLs.
        :param pulumi.Input[str] description: An informative summary of the rate limit. This value is sanitized and any tags will be removed.
        :param pulumi.Input[bool] disabled: When true, indicates that the rate limit is currently disabled.
        :param pulumi.Input[Union['RateLimitMatchArgs', 'RateLimitMatchArgsDict']] match: Determines which traffic the rate limit counts towards the threshold.
