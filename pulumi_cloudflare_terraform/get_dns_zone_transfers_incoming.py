...
def get_dns_zone_transfers_incoming(zone_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getDnsZoneTransfersIncoming:getDnsZoneTransfersIncoming', __args__, opts=opts, typ=GetDnsZoneTransfersIncomingResult, package_ref=_utilities.get_package()).value
...
def get_dns_zone_transfers_incoming_output(zone_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getDnsZoneTransfersIncoming:getDnsZoneTransfersIncoming', __args__, opts=opts, typ=GetDnsZoneTransfersIncomingResult, package_ref=_utilities.get_package())
