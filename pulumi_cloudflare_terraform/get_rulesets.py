...
def get_rulesets(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getRulesets:getRulesets', __args__, opts=opts, typ=GetRulesetsResult, package_ref=_utilities.get_package()).value
...
def get_rulesets_output(account_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getRulesets:getRulesets', __args__, opts=opts, typ=GetRulesetsResult, package_ref=_utilities.get_package())
