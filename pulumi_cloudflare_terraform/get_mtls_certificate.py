...
class GetMtlsCertificateResult:
    ...
    def mtls_certificate_id(self) -> Optional[str]:
...
def get_mtls_certificate(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMtlsCertificate:getMtlsCertificate', __args__, opts=opts, typ=GetMtlsCertificateResult, package_ref=_utilities.get_package()).value
...
def get_mtls_certificate_output(account_id: Optional[pulumi.Input[str]] = None,
                                mtls_certificate_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMtlsCertificate:getMtlsCertificate', __args__, opts=opts, typ=GetMtlsCertificateResult, package_ref=_utilities.get_package())
