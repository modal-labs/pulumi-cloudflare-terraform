...
def get_zero_trust_risk_scoring_integration(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustRiskScoringIntegration:getZeroTrustRiskScoringIntegration', __args__, opts=opts, typ=GetZeroTrustRiskScoringIntegrationResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_risk_scoring_integration_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustRiskScoringIntegration:getZeroTrustRiskScoringIntegration', __args__, opts=opts, typ=GetZeroTrustRiskScoringIntegrationResult, package_ref=_utilities.get_package())
