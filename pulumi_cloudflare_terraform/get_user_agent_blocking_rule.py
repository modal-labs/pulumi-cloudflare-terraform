...
def get_user_agent_blocking_rule(ua_rule_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getUserAgentBlockingRule:getUserAgentBlockingRule', __args__, opts=opts, typ=GetUserAgentBlockingRuleResult, package_ref=_utilities.get_package()).value

    return AwaitableGetUserAgentBlockingRuleResult(
        id=pulumi.get(__ret__, 'id'),
        ua_rule_id=pulumi.get(__ret__, 'ua_rule_id'),
        zone_id=pulumi.get(__ret__, 'zone_id'))
def get_user_agent_blocking_rule_output(ua_rule_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getUserAgentBlockingRule:getUserAgentBlockingRule', __args__, opts=opts, typ=GetUserAgentBlockingRuleResult, package_ref=_utilities.get_package())
