...
def get_workers_script(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWorkersScript:getWorkersScript', __args__, opts=opts, typ=GetWorkersScriptResult, package_ref=_utilities.get_package()).value
...
def get_workers_script_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWorkersScript:getWorkersScript', __args__, opts=opts, typ=GetWorkersScriptResult, package_ref=_utilities.get_package())
