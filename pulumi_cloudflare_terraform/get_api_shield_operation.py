...
class GetApiShieldOperationResult:
    ...
    @property
    @pulumi.getter
    def feature(self) -> Optional[Sequence[str]]:
...
def get_api_shield_operation(feature: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getApiShieldOperation:getApiShieldOperation', __args__, opts=opts, typ=GetApiShieldOperationResult, package_ref=_utilities.get_package()).value
...
def get_api_shield_operation_output(feature: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getApiShieldOperation:getApiShieldOperation', __args__, opts=opts, typ=GetApiShieldOperationResult, package_ref=_utilities.get_package())
