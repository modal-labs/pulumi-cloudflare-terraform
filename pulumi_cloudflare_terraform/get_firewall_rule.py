...
def get_firewall_rule(rule_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getFirewallRule:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult, package_ref=_utilities.get_package()).value
...
def get_firewall_rule_output(rule_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getFirewallRule:getFirewallRule', __args__, opts=opts, typ=GetFirewallRuleResult, package_ref=_utilities.get_package())
