...
class WorkersRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] script: Name of the script, used in URLs and route configuration.
        """
...
class WorkersRoute(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a WorkersRoute resource with the given unique name, props, and options.
