...
class MagicTransitConnectorArgs:
    def __init__(__self__, *,
                 ...
                 interrupt_window_duration_hours: Optional[pulumi.Input[float]] = None,
                 interrupt_window_hour_of_day: Optional[pulumi.Input[float]] = None,
    ...
    def interrupt_window_duration_hours(self) -> Optional[pulumi.Input[float]]:
        return pulumi.get(self, "interrupt_window_duration_hours")

    @interrupt_window_duration_hours.setter
    def interrupt_window_duration_hours(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "interrupt_window_duration_hours", value)

    @property
    @pulumi.getter(name="interruptWindowHourOfDay")
    def interrupt_window_hour_of_day(self) -> Optional[pulumi.Input[float]]:
        return pulumi.get(self, "interrupt_window_hour_of_day")

    @interrupt_window_hour_of_day.setter
    def interrupt_window_hour_of_day(self, value: Optional[pulumi.Input[float]]):
...
class _MagicTransitConnectorState:
    def __init__(__self__, *,
                 ...
                 interrupt_window_duration_hours: Optional[pulumi.Input[float]] = None,
                 interrupt_window_hour_of_day: Optional[pulumi.Input[float]] = None,
                 last_heartbeat: Optional[pulumi.Input[str]] = None,
                 last_seen_version: Optional[pulumi.Input[str]] = None,
    ...
    def last_heartbeat(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "last_heartbeat")

    @last_heartbeat.setter
    def last_heartbeat(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "last_heartbeat", value)

    @property
    @pulumi.getter(name="lastSeenVersion")
    def last_seen_version(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "last_seen_version")

    @last_seen_version.setter
    def last_seen_version(self, value: Optional[pulumi.Input[str]]):
...
class MagicTransitConnector(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a MagicTransitConnector resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            last_updated: Optional[pulumi.Input[str]] = None,
            notes: Optional[pulumi.Input[str]] = None,
            timezone: Optional[pulumi.Input[str]] = None) -> 'MagicTransitConnector':
        """
    ...
    @property
    @pulumi.getter(name="interruptWindowDurationHours")
    def interrupt_window_duration_hours(self) -> pulumi.Output[Optional[float]]:
        return pulumi.get(self, "interrupt_window_duration_hours")

    @property
    @pulumi.getter(name="interruptWindowHourOfDay")
    def interrupt_window_hour_of_day(self) -> pulumi.Output[Optional[float]]:
        return pulumi.get(self, "interrupt_window_hour_of_day")

    @property
    @pulumi.getter(name="lastHeartbeat")
    def last_heartbeat(self) -> pulumi.Output[str]:
        return pulumi.get(self, "last_heartbeat")

    @property
    @pulumi.getter(name="lastSeenVersion")
    def last_seen_version(self) -> pulumi.Output[str]:
        return pulumi.get(self, "last_seen_version")
