...
def get_turnstile_widget(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getTurnstileWidget:getTurnstileWidget', __args__, opts=opts, typ=GetTurnstileWidgetResult, package_ref=_utilities.get_package()).value
...
def get_turnstile_widget_output(account_id: Optional[pulumi.Input[str]] = None,
                                ...
                                sitekey: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getTurnstileWidget:getTurnstileWidget', __args__, opts=opts, typ=GetTurnstileWidgetResult, package_ref=_utilities.get_package())
