...
class _EmailRoutingAddressState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] tag: Destination address tag. (Deprecated, replaced by destination address identifier)
...
class EmailRoutingAddress(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a EmailRoutingAddress resource with the given unique name, props, and options.
