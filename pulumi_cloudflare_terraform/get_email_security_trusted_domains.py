...
class GetEmailSecurityTrustedDomainsResult:
    ...
    def __init__(__self__, account_id=None, comments=None, created_at=None, filter=None, id=None, is_recent=None, is_regex=None, is_similarity=None, last_modified=None, pattern=None, trusted_domain_id=None):
        ...
        if trusted_domain_id and not isinstance(trusted_domain_id, float):
            raise TypeError("Expected argument 'trusted_domain_id' to be a float")
    ...
    def trusted_domain_id(self) -> Optional[float]:
...
def get_email_security_trusted_domains(account_id: Optional[str] = None,
                                       ...
                                       trusted_domain_id: Optional[float] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getEmailSecurityTrustedDomains:getEmailSecurityTrustedDomains', __args__, opts=opts, typ=GetEmailSecurityTrustedDomainsResult, package_ref=_utilities.get_package()).value
...
def get_email_security_trusted_domains_output(account_id: Optional[pulumi.Input[str]] = None,
                                              ...
                                              trusted_domain_id: Optional[pulumi.Input[Optional[float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getEmailSecurityTrustedDomains:getEmailSecurityTrustedDomains', __args__, opts=opts, typ=GetEmailSecurityTrustedDomainsResult, package_ref=_utilities.get_package())
