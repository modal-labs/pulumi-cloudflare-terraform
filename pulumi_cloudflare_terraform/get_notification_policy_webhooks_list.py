...
def get_notification_policy_webhooks_list(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getNotificationPolicyWebhooksList:getNotificationPolicyWebhooksList', __args__, opts=opts, typ=GetNotificationPolicyWebhooksListResult, package_ref=_utilities.get_package()).value
...
def get_notification_policy_webhooks_list_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getNotificationPolicyWebhooksList:getNotificationPolicyWebhooksList', __args__, opts=opts, typ=GetNotificationPolicyWebhooksListResult, package_ref=_utilities.get_package())
