...
class StreamWatermarkInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] file: The image file to upload.
        :param pulumi.Input[str] identifier: The unique identifier for a watermark profile.
        :param pulumi.Input[str] name: A short description of the watermark profile.
        :param pulumi.Input[float] opacity: The translucency of the image. A value of `0.0` makes the image completely transparent, and `1.0` makes the image
               completely opaque. Note that if the image is already semi-transparent, setting this to `1.0` will not make the image
               completely opaque.
        :param pulumi.Input[float] padding: The whitespace between the adjacent edges (determined by position) of the video and the image. `0.0` indicates no
               padding, and `1.0` indicates a fully padded video width or length, as determined by the algorithm.
        :param pulumi.Input[str] position: The location of the image. Valid positions are: `upperRight`, `upperLeft`, `lowerLeft`, `lowerRight`, and `center`. Note
               that `center` ignores the `padding` parameter.
        :param pulumi.Input[float] scale: The size of the image relative to the overall size of the video. This parameter will adapt to horizontal and vertical
               videos automatically. `0.0` indicates no scaling (use the size of the image as-is), and `1.0 `fills the entire video.
        """
    ...
    def opacity(self) -> Optional[pulumi.Input[float]]:
        """
        The translucency of the image. A value of `0.0` makes the image completely transparent, and `1.0` makes the image
        completely opaque. Note that if the image is already semi-transparent, setting this to `1.0` will not make the image
        completely opaque.
        """
    ...
    def padding(self) -> Optional[pulumi.Input[float]]:
        """
        The whitespace between the adjacent edges (determined by position) of the video and the image. `0.0` indicates no
        padding, and `1.0` indicates a fully padded video width or length, as determined by the algorithm.
        """
    ...
    def position(self) -> Optional[pulumi.Input[str]]:
        """
        The location of the image. Valid positions are: `upperRight`, `upperLeft`, `lowerLeft`, `lowerRight`, and `center`. Note
        that `center` ignores the `padding` parameter.
        """
    ...
    def scale(self) -> Optional[pulumi.Input[float]]:
        """
        The size of the image relative to the overall size of the video. This parameter will adapt to horizontal and vertical
        videos automatically. `0.0` indicates no scaling (use the size of the image as-is), and `1.0 `fills the entire video.
        """
...
class _StreamWatermarkState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] file: The image file to upload.
        :param pulumi.Input[float] height: The height of the image in pixels.
        :param pulumi.Input[str] identifier: The unique identifier for a watermark profile.
        :param pulumi.Input[str] name: A short description of the watermark profile.
        :param pulumi.Input[float] opacity: The translucency of the image. A value of `0.0` makes the image completely transparent, and `1.0` makes the image
               completely opaque. Note that if the image is already semi-transparent, setting this to `1.0` will not make the image
        ...
        :param pulumi.Input[float] width: The width of the image in pixels.
        """
...
class StreamWatermark(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a StreamWatermark resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            size: Optional[pulumi.Input[float]] = None,
            uid: Optional[pulumi.Input[str]] = None,
            width: Optional[pulumi.Input[float]] = None) -> 'StreamWatermark':
        """
    ...
    @property
    @pulumi.getter(name="downloadedFrom")
    def downloaded_from(self) -> pulumi.Output[str]:
        """
        The source URL for a downloaded image. If the watermark profile was created via direct upload, this field is null.
        """
        return pulumi.get(self, "downloaded_from")
    ...
    @property
    @pulumi.getter
    def opacity(self) -> pulumi.Output[float]:
        """
        The translucency of the image. A value of `0.0` makes the image completely transparent, and `1.0` makes the image
        completely opaque. Note that if the image is already semi-transparent, setting this to `1.0` will not make the image
        completely opaque.
    ...
    @property
    @pulumi.getter
    def padding(self) -> pulumi.Output[float]:
        """
        The whitespace between the adjacent edges (determined by position) of the video and the image. `0.0` indicates no
        padding, and `1.0` indicates a fully padded video width or length, as determined by the algorithm.
        """
    ...
    @property
    @pulumi.getter
    def scale(self) -> pulumi.Output[float]:
        """
        The size of the image relative to the overall size of the video. This parameter will adapt to horizontal and vertical
        videos automatically. `0.0` indicates no scaling (use the size of the image as-is), and `1.0 `fills the entire video.
        """
