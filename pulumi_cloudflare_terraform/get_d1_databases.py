...
class GetD1DatabasesResult:
    ...
    @property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetD1DatabasesResultResult']:
        return pulumi.get(self, "results")


class AwaitableGetD1DatabasesResult(GetD1DatabasesResult):
...
def get_d1_databases(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getD1Databases:getD1Databases', __args__, opts=opts, typ=GetD1DatabasesResult, package_ref=_utilities.get_package()).value

    return AwaitableGetD1DatabasesResult(
...
def get_d1_databases_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getD1Databases:getD1Databases', __args__, opts=opts, typ=GetD1DatabasesResult, package_ref=_utilities.get_package())
    return __ret__.apply(lambda __response__: GetD1DatabasesResult(
