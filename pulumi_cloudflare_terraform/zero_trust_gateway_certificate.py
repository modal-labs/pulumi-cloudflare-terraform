...
class ZeroTrustGatewayCertificateArgs:
    def __init__(__self__, *,
                 ...
                 validity_period_days: Optional[pulumi.Input[float]] = None):
        """
        The set of arguments for constructing a ZeroTrustGatewayCertificate resource.
        :param pulumi.Input[float] validity_period_days: Number of days the generated certificate will be valid, minimum 1 day and maximum 30 years. Defaults to 5 years.
        """
    ...
    def validity_period_days(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def validity_period_days(self, value: Optional[pulumi.Input[float]]):
...
class _ZeroTrustGatewayCertificateState:
    def __init__(__self__, *,
                 ...
                 issuer_org: Optional[pulumi.Input[str]] = None,
                 issuer_raw: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] binding_status: The deployment status of the certificate on Cloudflare's edge. Certificates in the 'available' (previously called
               'active') state may be used for Gateway TLS interception.
    ...
    def issuer_org(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @issuer_org.setter
    def issuer_org(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "issuer_org", value)

    @property
    @pulumi.getter(name="issuerRaw")
    def issuer_raw(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @issuer_raw.setter
    def issuer_raw(self, value: Optional[pulumi.Input[str]]):
...
class ZeroTrustGatewayCertificate(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustGatewayCertificate resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            updated_at: Optional[pulumi.Input[str]] = None,
            uploaded_on: Optional[pulumi.Input[str]] = None,
            validity_period_days: Optional[pulumi.Input[float]] = None) -> 'ZeroTrustGatewayCertificate':
        """
    ...
    @property
    @pulumi.getter(name="issuerOrg")
    def issuer_org(self) -> pulumi.Output[str]:
        """
        The organization that issued the certificate.
        """
        return pulumi.get(self, "issuer_org")
    ...
    @property
    @pulumi.getter(name="issuerRaw")
    def issuer_raw(self) -> pulumi.Output[str]:
        """
        The entire issuer field of the certificate.
        """
        return pulumi.get(self, "issuer_raw")
    ...
    @property
    @pulumi.getter(name="validityPeriodDays")
    def validity_period_days(self) -> pulumi.Output[Optional[float]]:
        """
        Number of days the generated certificate will be valid, minimum 1 day and maximum 30 years. Defaults to 5 years.
        """
        return pulumi.get(self, "validity_period_days")
