...
class DnsZoneTransfersAclArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] ip_range: Allowed IPv4/IPv6 address range of primary or secondary nameservers. This will be applied for the entire account. The IP
               range is used to allow additional NOTIFY IPs for secondary zones and IPs Cloudflare allows AXFR/IXFR requests from for
               primary zones. CIDRs are limited to a maximum of /24 for IPv4 and /64 for IPv6 respectively.
    ...
    def ip_range(self) -> pulumi.Input[str]:
        """
        Allowed IPv4/IPv6 address range of primary or secondary nameservers. This will be applied for the entire account. The IP
        range is used to allow additional NOTIFY IPs for secondary zones and IPs Cloudflare allows AXFR/IXFR requests from for
        primary zones. CIDRs are limited to a maximum of /24 for IPv4 and /64 for IPv6 respectively.
        """
...
class DnsZoneTransfersAcl(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DnsZoneTransfersAcl resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            account_id: Optional[pulumi.Input[str]] = None,
            ip_range: Optional[pulumi.Input[str]] = None,
            name: Optional[pulumi.Input[str]] = None) -> 'DnsZoneTransfersAcl':
        """
