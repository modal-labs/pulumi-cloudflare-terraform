...
class HealthcheckArgs:
    def __init__(__self__, *,
                 ...
                 consecutive_fails: Optional[pulumi.Input[float]] = None,
                 consecutive_successes: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] check_regions: A list of regions from which to run health checks. Null means Cloudflare will pick a default region.
        :param pulumi.Input[float] consecutive_fails: The number of consecutive fails required from a health check before changing the health to unhealthy.
        :param pulumi.Input[float] consecutive_successes: The number of consecutive successes required from a health check before changing the health to healthy.
        ...
        :param pulumi.Input[float] interval: The interval between each health check. Shorter intervals may give quicker notifications if the origin status changes,
        ...
        :param pulumi.Input[str] type: The protocol to use for the health check. Currently supported protocols are 'HTTP', 'HTTPS' and 'TCP'.
        """
    ...
    def consecutive_fails(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def consecutive_fails(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "consecutive_fails", value)

    @property
    @pulumi.getter(name="consecutiveSuccesses")
    def consecutive_successes(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def consecutive_successes(self, value: Optional[pulumi.Input[float]]):
...
class _HealthcheckState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] consecutive_successes: The number of consecutive successes required from a health check before changing the health to healthy.
        :param pulumi.Input[str] description: A human-readable description of the health check.
        :param pulumi.Input[str] failure_reason: The current failure reason if status is unhealthy.
        :param pulumi.Input['HealthcheckHttpConfigArgs'] http_config: Parameters specific to an HTTP or HTTPS health check.
        :param pulumi.Input[float] interval: The interval between each health check. Shorter intervals may give quicker notifications if the origin status changes,
               but will increase load on the origin as we check from multiple locations.
        :param pulumi.Input[str] name: A short name to identify the health check. Only alphanumeric characters, hyphens and underscores are allowed.
...
class Healthcheck(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="consecutiveFails")
    def consecutive_fails(self) -> pulumi.Output[float]:
        """
        The number of consecutive fails required from a health check before changing the health to unhealthy.
        """
        return pulumi.get(self, "consecutive_fails")
    ...
    @property
    @pulumi.getter(name="consecutiveSuccesses")
    def consecutive_successes(self) -> pulumi.Output[float]:
        """
        The number of consecutive successes required from a health check before changing the health to healthy.
        """
        return pulumi.get(self, "consecutive_successes")
