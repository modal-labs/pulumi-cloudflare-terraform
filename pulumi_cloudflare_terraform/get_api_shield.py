...
def get_api_shield(properties: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getApiShield:getApiShield', __args__, opts=opts, typ=GetApiShieldResult, package_ref=_utilities.get_package()).value
...
def get_api_shield_output(properties: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getApiShield:getApiShield', __args__, opts=opts, typ=GetApiShieldResult, package_ref=_utilities.get_package())
