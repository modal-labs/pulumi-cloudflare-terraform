...
class BotManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] auto_update_model: Automatically update to the newest bot detection models created by Cloudflare as they are released. [Learn
               more.](https://developers.cloudflare.com/bots/reference/machine-learning-models#model-versions-and-release-notes)
        :param pulumi.Input[bool] enable_js: Use lightweight, invisible JavaScript detections to improve Bot Management. [Learn more about JavaScript
        ...
        :param pulumi.Input[bool] sbfm_static_resource_protection: Super Bot Fight Mode (SBFM) to enable static resource protection. Enable if static resources on your application need
               bot protection. Note: Static resource protection can also result in legitimate traffic being blocked.
    ...
    def auto_update_model(self) -> Optional[pulumi.Input[bool]]:
        """
        Automatically update to the newest bot detection models created by Cloudflare as they are released. [Learn
        more.](https://developers.cloudflare.com/bots/reference/machine-learning-models#model-versions-and-release-notes)
        """
    ...
    def enable_js(self) -> Optional[pulumi.Input[bool]]:
        """
        Use lightweight, invisible JavaScript detections to improve Bot Management. [Learn more about JavaScript
        Detections](https://developers.cloudflare.com/bots/reference/javascript-detections/).
        """
    ...
    def sbfm_static_resource_protection(self) -> Optional[pulumi.Input[bool]]:
        """
        Super Bot Fight Mode (SBFM) to enable static resource protection. Enable if static resources on your application need
        bot protection. Note: Static resource protection can also result in legitimate traffic being blocked.
        """
...
class _BotManagementState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] sbfm_static_resource_protection: Super Bot Fight Mode (SBFM) to enable static resource protection. Enable if static resources on your application need
               bot protection. Note: Static resource protection can also result in legitimate traffic being blocked.
        :param pulumi.Input[str] sbfm_verified_bots: Super Bot Fight Mode (SBFM) action to take on verified bots requests.
        :param pulumi.Input['BotManagementStaleZoneConfigurationArgs'] stale_zone_configuration: A read-only field that shows which unauthorized settings are currently active on the zone. These settings typically
...
class BotManagement(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a BotManagement resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[bool] sbfm_static_resource_protection: Super Bot Fight Mode (SBFM) to enable static resource protection. Enable if static resources on your application need
               bot protection. Note: Static resource protection can also result in legitimate traffic being blocked.
        :param pulumi.Input[str] sbfm_verified_bots: Super Bot Fight Mode (SBFM) action to take on verified bots requests.
        :param pulumi.Input[Union['BotManagementStaleZoneConfigurationArgs', 'BotManagementStaleZoneConfigurationArgsDict']] stale_zone_configuration: A read-only field that shows which unauthorized settings are currently active on the zone. These settings typically
               result from upgrades or downgrades.
        :param pulumi.Input[bool] suppress_session_score: Whether to disable tracking the highest bot score for a session in the Bot Management cookie.
        :param pulumi.Input[bool] using_latest_model: A read-only field that indicates whether the zone currently is running the latest ML model.
        :param pulumi.Input[str] zone_id: Identifier
    ...
    @property
    @pulumi.getter(name="suppressSessionScore")
    def suppress_session_score(self) -> pulumi.Output[bool]:
        """
        Whether to disable tracking the highest bot score for a session in the Bot Management cookie.
        """
        return pulumi.get(self, "suppress_session_score")
