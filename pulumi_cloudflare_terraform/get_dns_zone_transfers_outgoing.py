...
class GetDnsZoneTransfersOutgoingResult:
    ...
    def last_transferred_time(self) -> str:
...
def get_dns_zone_transfers_outgoing(zone_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getDnsZoneTransfersOutgoing:getDnsZoneTransfersOutgoing', __args__, opts=opts, typ=GetDnsZoneTransfersOutgoingResult, package_ref=_utilities.get_package()).value
...
def get_dns_zone_transfers_outgoing_output(zone_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getDnsZoneTransfersOutgoing:getDnsZoneTransfersOutgoing', __args__, opts=opts, typ=GetDnsZoneTransfersOutgoingResult, package_ref=_utilities.get_package())
