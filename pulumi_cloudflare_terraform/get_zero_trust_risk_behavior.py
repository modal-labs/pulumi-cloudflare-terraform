...
def get_zero_trust_risk_behavior(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustRiskBehavior:getZeroTrustRiskBehavior', __args__, opts=opts, typ=GetZeroTrustRiskBehaviorResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_risk_behavior_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustRiskBehavior:getZeroTrustRiskBehavior', __args__, opts=opts, typ=GetZeroTrustRiskBehaviorResult, package_ref=_utilities.get_package())
