...
def get_account_role(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getAccountRole:getAccountRole', __args__, opts=opts, typ=GetAccountRoleResult, package_ref=_utilities.get_package()).value
...
def get_account_role_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getAccountRole:getAccountRole', __args__, opts=opts, typ=GetAccountRoleResult, package_ref=_utilities.get_package())
