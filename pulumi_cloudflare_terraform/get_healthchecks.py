...
class GetHealthchecksResult:
    ...
    @property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetHealthchecksResultResult']:
...
def get_healthchecks(max_items: Optional[float] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getHealthchecks:getHealthchecks', __args__, opts=opts, typ=GetHealthchecksResult, package_ref=_utilities.get_package()).value
...
def get_healthchecks_output(max_items: Optional[pulumi.Input[Optional[float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getHealthchecks:getHealthchecks', __args__, opts=opts, typ=GetHealthchecksResult, package_ref=_utilities.get_package())
