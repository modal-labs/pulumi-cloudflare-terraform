...
class ByoIpPrefixArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] asn: Autonomous System Number (ASN) the prefix will be advertised under.
...
class ByoIpPrefix(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ByoIpPrefix resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter
    def asn(self) -> pulumi.Output[float]:
        """
        Autonomous System Number (ASN) the prefix will be advertised under.
        """
        return pulumi.get(self, "asn")
