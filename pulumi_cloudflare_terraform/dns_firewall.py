...
class DnsFirewallArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] maximum_cache_ttl: Maximum DNS cache TTL This setting sets an upper bound on DNS TTLs for purposes of caching between DNS Firewall and the
               upstream servers. Higher TTLs will be decreased to the maximum defined here for caching purposes.
        :param pulumi.Input[float] minimum_cache_ttl: Minimum DNS cache TTL This setting sets a lower bound on DNS TTLs for purposes of caching between DNS Firewall and the
               upstream servers. Lower TTLs will be increased to the minimum defined here for caching purposes.
        :param pulumi.Input[str] name: DNS Firewall cluster name
        :param pulumi.Input[float] negative_cache_ttl: Negative DNS cache TTL This setting controls how long DNS Firewall should cache negative responses (e.g., NXDOMAIN) from
               the upstream servers.
        :param pulumi.Input[float] ratelimit: Ratelimit in queries per second per datacenter (applies to DNS queries sent to the upstream nameservers configured on
               the cluster)
    ...
    def deprecate_any_requests(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def deprecate_any_requests(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "deprecate_any_requests", value)

    @property
    @pulumi.getter(name="ecsFallback")
    def ecs_fallback(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    @ecs_fallback.setter
    def ecs_fallback(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "ecs_fallback", value)

    @property
    @pulumi.getter(name="maximumCacheTtl")
    def maximum_cache_ttl(self) -> Optional[pulumi.Input[float]]:
        """
        Maximum DNS cache TTL This setting sets an upper bound on DNS TTLs for purposes of caching between DNS Firewall and the
        upstream servers. Higher TTLs will be decreased to the maximum defined here for caching purposes.
        """
        return pulumi.get(self, "maximum_cache_ttl")

    @maximum_cache_ttl.setter
    def maximum_cache_ttl(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "maximum_cache_ttl", value)

    @property
    @pulumi.getter(name="minimumCacheTtl")
    def minimum_cache_ttl(self) -> Optional[pulumi.Input[float]]:
        """
        Minimum DNS cache TTL This setting sets a lower bound on DNS TTLs for purposes of caching between DNS Firewall and the
        upstream servers. Lower TTLs will be increased to the minimum defined here for caching purposes.
        """
        return pulumi.get(self, "minimum_cache_ttl")

    @minimum_cache_ttl.setter
    def minimum_cache_ttl(self, value: Optional[pulumi.Input[float]]):
    ...
    def negative_cache_ttl(self) -> Optional[pulumi.Input[float]]:
        """
        Negative DNS cache TTL This setting controls how long DNS Firewall should cache negative responses (e.g., NXDOMAIN) from
        the upstream servers.
        """
        return pulumi.get(self, "negative_cache_ttl")

    @negative_cache_ttl.setter
    def negative_cache_ttl(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "negative_cache_ttl", value)

    @property
    @pulumi.getter
    def ratelimit(self) -> Optional[pulumi.Input[float]]:
        """
        Ratelimit in queries per second per datacenter (applies to DNS queries sent to the upstream nameservers configured on
        the cluster)
        """
        return pulumi.get(self, "ratelimit")

    @ratelimit.setter
    def ratelimit(self, value: Optional[pulumi.Input[float]]):
...
class _DnsFirewallState:
    def __init__(__self__, *,
                 ...
                 attack_mitigation: Optional[pulumi.Input['DnsFirewallAttackMitigationArgs']] = None,
                 deprecate_any_requests: Optional[pulumi.Input[bool]] = None,
                 dns_firewall_ips: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ecs_fallback: Optional[pulumi.Input[bool]] = None,
                 maximum_cache_ttl: Optional[pulumi.Input[float]] = None,
                 minimum_cache_ttl: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[float] minimum_cache_ttl: Minimum DNS cache TTL This setting sets a lower bound on DNS TTLs for purposes of caching between DNS Firewall and the
               upstream servers. Lower TTLs will be increased to the minimum defined here for caching purposes.
        :param pulumi.Input[str] modified_on: Last modification of DNS Firewall cluster
        :param pulumi.Input[str] name: DNS Firewall cluster name
        :param pulumi.Input[float] negative_cache_ttl: Negative DNS cache TTL This setting controls how long DNS Firewall should cache negative responses (e.g., NXDOMAIN) from
               the upstream servers.
        :param pulumi.Input[float] ratelimit: Ratelimit in queries per second per datacenter (applies to DNS queries sent to the upstream nameservers configured on
    ...
    def dns_firewall_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        return pulumi.get(self, "dns_firewall_ips")

    @dns_firewall_ips.setter
    def dns_firewall_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
...
class DnsFirewall(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DnsFirewall resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            ratelimit: Optional[pulumi.Input[float]] = None,
            retries: Optional[pulumi.Input[float]] = None,
            upstream_ips: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None) -> 'DnsFirewall':
        """
    ...
    @property
    @pulumi.getter(name="deprecateAnyRequests")
    def deprecate_any_requests(self) -> pulumi.Output[Optional[bool]]:
        """
        Whether to refuse to answer queries for the ANY type
        """
        return pulumi.get(self, "deprecate_any_requests")
    ...
    @property
    @pulumi.getter(name="dnsFirewallIps")
    def dns_firewall_ips(self) -> pulumi.Output[Sequence[str]]:
        return pulumi.get(self, "dns_firewall_ips")

    @property
    @pulumi.getter(name="ecsFallback")
    def ecs_fallback(self) -> pulumi.Output[Optional[bool]]:
        """
        Whether to forward client IP (resolver) subnet if no EDNS Client Subnet is sent
        """
        return pulumi.get(self, "ecs_fallback")
    ...
    @property
    @pulumi.getter(name="maximumCacheTtl")
    def maximum_cache_ttl(self) -> pulumi.Output[float]:
        """
        Maximum DNS cache TTL This setting sets an upper bound on DNS TTLs for purposes of caching between DNS Firewall and the
        upstream servers. Higher TTLs will be decreased to the maximum defined here for caching purposes.
        """
    ...
    @property
    @pulumi.getter(name="minimumCacheTtl")
    def minimum_cache_ttl(self) -> pulumi.Output[float]:
        """
        Minimum DNS cache TTL This setting sets a lower bound on DNS TTLs for purposes of caching between DNS Firewall and the
        upstream servers. Lower TTLs will be increased to the minimum defined here for caching purposes.
        """
    ...
    @property
    @pulumi.getter(name="negativeCacheTtl")
    def negative_cache_ttl(self) -> pulumi.Output[Optional[float]]:
        """
        Negative DNS cache TTL This setting controls how long DNS Firewall should cache negative responses (e.g., NXDOMAIN) from
        the upstream servers.
        """
    ...
    @property
    @pulumi.getter
    def ratelimit(self) -> pulumi.Output[Optional[float]]:
        """
        Ratelimit in queries per second per datacenter (applies to DNS queries sent to the upstream nameservers configured on
        the cluster)
        """
