...
def get_page_shield_policies(max_items: Optional[float] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getPageShieldPolicies:getPageShieldPolicies', __args__, opts=opts, typ=GetPageShieldPoliciesResult, package_ref=_utilities.get_package()).value
...
def get_page_shield_policies_output(max_items: Optional[pulumi.Input[Optional[float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getPageShieldPolicies:getPageShieldPolicies', __args__, opts=opts, typ=GetPageShieldPoliciesResult, package_ref=_utilities.get_package())
