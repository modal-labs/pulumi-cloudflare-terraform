...
class LogpushJobArgs:
    def __init__(__self__, *,
                 ...
                 max_upload_bytes: Optional[pulumi.Input[float]] = None,
                 max_upload_interval_seconds: Optional[pulumi.Input[float]] = None,
                 max_upload_records: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[str] destination_conf: Uniquely identifies a resource (such as an s3 bucket) where data will be pushed. Additional configuration parameters
        ...
        :param pulumi.Input[str] dataset: Name of the dataset. A list of supported datasets can be found on the [Developer
        ...
        :param pulumi.Input[str] frequency: This field is deprecated. Please use `max_upload_*` parameters instead. The frequency at which Cloudflare sends batches
        ...
        :param pulumi.Input[str] kind: The kind parameter (optional) is used to differentiate between Logpush and Edge Log Delivery jobs. Currently, Edge Log
               Delivery is only supported for the `http_requests` dataset.
        :param pulumi.Input[str] logpull_options: This field is deprecated. Use `output_options` instead. Configuration string. It specifies things like requested fields
        ...
        :param pulumi.Input[float] max_upload_bytes: The maximum uncompressed file size of a batch of logs. This setting value must be between `5 MB` and `1 GB`, or `0` to
        ...
        :param pulumi.Input[float] max_upload_interval_seconds: The maximum interval in seconds for log batches. This setting must be between 30 and 300 seconds (5 minutes), or `0` to
        ...
        :param pulumi.Input[float] max_upload_records: The maximum number of log lines per batch. This setting must be between 1000 and 1,000,000 lines, or `0` to disable it.
        ...
        :param pulumi.Input[str] name: Optional human readable job name. Not unique. Cloudflare suggests that you set this to a meaningful string, like the
        ...
        :param pulumi.Input[str] ownership_challenge: Ownership challenge token to prove destination ownership.
    ...
    def max_upload_bytes(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def max_upload_bytes(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "max_upload_bytes", value)

    @property
    @pulumi.getter(name="maxUploadIntervalSeconds")
    def max_upload_interval_seconds(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def max_upload_interval_seconds(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "max_upload_interval_seconds", value)

    @property
    @pulumi.getter(name="maxUploadRecords")
    def max_upload_records(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def max_upload_records(self, value: Optional[pulumi.Input[float]]):
...
class _LogpushJobState:
    def __init__(__self__, *,
                 ...
                 frequency: Optional[pulumi.Input[str]] = None,
                 kind: Optional[pulumi.Input[str]] = None,
                 last_complete: Optional[pulumi.Input[str]] = None,
                 last_error: Optional[pulumi.Input[str]] = None,
                 logpull_options: Optional[pulumi.Input[str]] = None,
                 logpush_job_id: Optional[pulumi.Input[float]] = None,
                 max_upload_bytes: Optional[pulumi.Input[float]] = None,
                 max_upload_interval_seconds: Optional[pulumi.Input[float]] = None,
                 max_upload_records: Optional[pulumi.Input[float]] = None,
                 name: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] destination_conf: Uniquely identifies a resource (such as an s3 bucket) where data will be pushed. Additional configuration parameters
               supported by the destination may be included.
        :param pulumi.Input[bool] enabled: Flag that indicates if the job is enabled.
        :param pulumi.Input[str] error_message: If not null, the job is currently failing. Failures are usually repetitive (example: no permissions to write to
        ...
        :param pulumi.Input[str] kind: The kind parameter (optional) is used to differentiate between Logpush and Edge Log Delivery jobs. Currently, Edge Log
               Delivery is only supported for the `http_requests` dataset.
        :param pulumi.Input[str] last_complete: Records the last time for which logs have been successfully pushed. If the last successful push was for logs range
        ...
        :param pulumi.Input[str] last_error: Records the last time the job failed. If not null, the job is currently failing. If null, the job has either never
               failed or has run successfully at least once since last failure. See also the error_message field.
        :param pulumi.Input[str] logpull_options: This field is deprecated. Use `output_options` instead. Configuration string. It specifies things like requested fields
               and timestamp formats. If migrating from the logpull api, copy the url (full url or just the query string) of your call
               here, and logpush will keep on making this call for you, setting start and end times appropriately.
        :param pulumi.Input[float] logpush_job_id: Unique id of the job.
        :param pulumi.Input[float] max_upload_bytes: The maximum uncompressed file size of a batch of logs. This setting value must be between `5 MB` and `1 GB`, or `0` to
               disable it. Note that you cannot set a minimum file size; this means that log files may be much smaller than this batch
               size. This parameter is not available for jobs with `edge` as its kind.
        :param pulumi.Input[float] max_upload_interval_seconds: The maximum interval in seconds for log batches. This setting must be between 30 and 300 seconds (5 minutes), or `0` to
    ...
    def last_complete(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def last_complete(self, value: Optional[pulumi.Input[str]]):
    ...
    def logpush_job_id(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def logpush_job_id(self, value: Optional[pulumi.Input[float]]):
...
class LogpushJob(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="lastComplete")
    def last_complete(self) -> pulumi.Output[str]:
        """
        Records the last time for which logs have been successfully pushed. If the last successful push was for logs range
        2018-07-23T10:00:00Z to 2018-07-23T10:01:00Z then the value of this field will be 2018-07-23T10:01:00Z. If the job has
        never run or has just been enabled and hasn't run yet then the field will be empty.
    ...
    @property
    @pulumi.getter(name="logpushJobId")
    def logpush_job_id(self) -> pulumi.Output[float]:
        """
        Unique id of the job.
        """
        return pulumi.get(self, "logpush_job_id")
    ...
    @property
    @pulumi.getter(name="maxUploadBytes")
    def max_upload_bytes(self) -> pulumi.Output[Optional[float]]:
        """
        The maximum uncompressed file size of a batch of logs. This setting value must be between `5 MB` and `1 GB`, or `0` to
        disable it. Note that you cannot set a minimum file size; this means that log files may be much smaller than this batch
        size. This parameter is not available for jobs with `edge` as its kind.
    ...
    @property
    @pulumi.getter(name="maxUploadIntervalSeconds")
    def max_upload_interval_seconds(self) -> pulumi.Output[float]:
        """
        The maximum interval in seconds for log batches. This setting must be between 30 and 300 seconds (5 minutes), or `0` to
        disable it. Note that you cannot specify a minimum interval for log batches; this means that log files may be sent in
        shorter intervals than this. This parameter is only used for jobs with `edge` as its kind.
    ...
    @property
    @pulumi.getter(name="maxUploadRecords")
    def max_upload_records(self) -> pulumi.Output[float]:
        """
        The maximum number of log lines per batch. This setting must be between 1000 and 1,000,000 lines, or `0` to disable it.
        Note that you cannot specify a minimum number of log lines per batch; this means that log files may contain many fewer
        lines than this. This parameter is not available for jobs with `edge` as its kind.
