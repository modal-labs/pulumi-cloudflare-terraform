...
def get_leaked_credential_check(zone_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getLeakedCredentialCheck:getLeakedCredentialCheck', __args__, opts=opts, typ=GetLeakedCredentialCheckResult, package_ref=_utilities.get_package()).value
...
def get_leaked_credential_check_output(zone_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getLeakedCredentialCheck:getLeakedCredentialCheck', __args__, opts=opts, typ=GetLeakedCredentialCheckResult, package_ref=_utilities.get_package())
