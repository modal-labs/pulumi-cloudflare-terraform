...
def get_page_shield_policy(policy_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getPageShieldPolicy:getPageShieldPolicy', __args__, opts=opts, typ=GetPageShieldPolicyResult, package_ref=_utilities.get_package()).value
...
def get_page_shield_policy_output(policy_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getPageShieldPolicy:getPageShieldPolicy', __args__, opts=opts, typ=GetPageShieldPolicyResult, package_ref=_utilities.get_package())
