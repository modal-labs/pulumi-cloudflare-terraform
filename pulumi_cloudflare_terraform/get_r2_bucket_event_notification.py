...
def get_r2_bucket_event_notification(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getR2BucketEventNotification:getR2BucketEventNotification', __args__, opts=opts, typ=GetR2BucketEventNotificationResult, package_ref=_utilities.get_package()).value
...
def get_r2_bucket_event_notification_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getR2BucketEventNotification:getR2BucketEventNotification', __args__, opts=opts, typ=GetR2BucketEventNotificationResult, package_ref=_utilities.get_package())
