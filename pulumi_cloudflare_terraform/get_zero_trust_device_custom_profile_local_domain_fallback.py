...
def get_zero_trust_device_custom_profile_local_domain_fallback(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDeviceCustomProfileLocalDomainFallback:getZeroTrustDeviceCustomProfileLocalDomainFallback', __args__, opts=opts, typ=GetZeroTrustDeviceCustomProfileLocalDomainFallbackResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_device_custom_profile_local_domain_fallback_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDeviceCustomProfileLocalDomainFallback:getZeroTrustDeviceCustomProfileLocalDomainFallback', __args__, opts=opts, typ=GetZeroTrustDeviceCustomProfileLocalDomainFallbackResult, package_ref=_utilities.get_package())
