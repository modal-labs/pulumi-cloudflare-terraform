...
class GetSpectrumApplicationResult:
    ...
    def argo_smart_routing(self) -> bool:
    ...
    def origin_directs(self) -> Sequence[str]:
...
def get_spectrum_application(app_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getSpectrumApplication:getSpectrumApplication', __args__, opts=opts, typ=GetSpectrumApplicationResult, package_ref=_utilities.get_package()).value
...
def get_spectrum_application_output(app_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getSpectrumApplication:getSpectrumApplication', __args__, opts=opts, typ=GetSpectrumApplicationResult, package_ref=_utilities.get_package())
