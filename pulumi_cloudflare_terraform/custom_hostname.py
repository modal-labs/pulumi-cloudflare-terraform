...
class CustomHostnameArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] hostname: The custom hostname that will point to your hostname via CNAME.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] custom_metadata: Unique key/value metadata for this hostname. These are per-hostname (customer) settings.
        :param pulumi.Input[str] custom_origin_server: a valid hostname that’s been added to your DNS zone as an A, AAAA, or CNAME record.
        :param pulumi.Input[str] custom_origin_sni: A hostname that will be sent to your custom origin server as SNI for TLS handshake. This can be a valid subdomain of the
...
class _CustomHostnameState:
    def __init__(__self__, *,
                 ...
                 verification_errors: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 zone_id: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering CustomHostname resources.
        :param pulumi.Input[str] created_at: This is the time the hostname was created.
        :param pulumi.Input[Mapping[str, pulumi.Input[str]]] custom_metadata: Unique key/value metadata for this hostname. These are per-hostname (customer) settings.
        :param pulumi.Input[str] custom_origin_server: a valid hostname that’s been added to your DNS zone as an A, AAAA, or CNAME record.
        :param pulumi.Input[str] custom_origin_sni: A hostname that will be sent to your custom origin server as SNI for TLS handshake. This can be a valid subdomain of the
               zone or custom origin server name or the string ':request_host_header:' which will cause the host header in the request
    ...
    def verification_errors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
    ...
    def verification_errors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]):
...
class CustomHostname(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a CustomHostname resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="verificationErrors")
    def verification_errors(self) -> pulumi.Output[Sequence[str]]:
        """
        These are errors that were encountered while trying to activate a hostname.
        """
        return pulumi.get(self, "verification_errors")
