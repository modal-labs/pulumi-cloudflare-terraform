...
def get_magic_transit_site_wan(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMagicTransitSiteWan:getMagicTransitSiteWan', __args__, opts=opts, typ=GetMagicTransitSiteWanResult, package_ref=_utilities.get_package()).value
...
def get_magic_transit_site_wan_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMagicTransitSiteWan:getMagicTransitSiteWan', __args__, opts=opts, typ=GetMagicTransitSiteWanResult, package_ref=_utilities.get_package())
