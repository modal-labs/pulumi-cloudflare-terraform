...
class GetAddressMapResult:
    ...
    def address_map_id(self) -> Optional[str]:
...
def get_address_map(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getAddressMap:getAddressMap', __args__, opts=opts, typ=GetAddressMapResult, package_ref=_utilities.get_package()).value
...
def get_address_map_output(account_id: Optional[pulumi.Input[str]] = None,
                           address_map_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getAddressMap:getAddressMap', __args__, opts=opts, typ=GetAddressMapResult, package_ref=_utilities.get_package())
