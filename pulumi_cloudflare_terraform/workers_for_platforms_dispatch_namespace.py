...
class _WorkersForPlatformsDispatchNamespaceState:
    def __init__(__self__, *,
                 ...
                 script_count: Optional[pulumi.Input[float]] = None):
        """
        ...
        :param pulumi.Input[float] script_count: The current number of scripts in this Dispatch Namespace
        """
    ...
    def script_count(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    @script_count.setter
    def script_count(self, value: Optional[pulumi.Input[float]]):
...
class WorkersForPlatformsDispatchNamespace(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a WorkersForPlatformsDispatchNamespace resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            namespace_id: Optional[pulumi.Input[str]] = None,
            namespace_name: Optional[pulumi.Input[str]] = None,
            script_count: Optional[pulumi.Input[float]] = None) -> 'WorkersForPlatformsDispatchNamespace':
        """
    ...
    @property
    @pulumi.getter(name="scriptCount")
    def script_count(self) -> pulumi.Output[float]:
        """
        The current number of scripts in this Dispatch Namespace
        """
        return pulumi.get(self, "script_count")
