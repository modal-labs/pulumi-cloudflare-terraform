...
class ZeroTrustAccessPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] decision: The action Access will take if a user matches this policy. Infrastructure application policies can only use the Allow
               action.
        ...
        :param pulumi.Input[bool] isolation_required: Require this application to be served in an isolated browser for users matching this policy. 'Client Web Isolation' must
        ...
        :param pulumi.Input[str] session_duration: The amount of time that tokens issued for the application will be valid. Must be in the format `300ms` or `2h45m`. Valid
    ...
    def decision(self) -> pulumi.Input[str]:
        """
        The action Access will take if a user matches this policy. Infrastructure application policies can only use the Allow
        action.
        """
...
class _ZeroTrustAccessPolicyState:
    def __init__(__self__, *,
                 ...
                 app_count: Optional[pulumi.Input[float]] = None,
                 approval_groups: Optional[pulumi.Input[Sequence[pulumi.Input['ZeroTrustAccessPolicyApprovalGroupArgs']]]] = None,
                 approval_required: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[str] account_id: Identifier
        :param pulumi.Input[float] app_count: Number of access applications currently using this policy.
        :param pulumi.Input[Sequence[pulumi.Input['ZeroTrustAccessPolicyApprovalGroupArgs']]] approval_groups: Administrators who can approve a temporary authentication request.
        :param pulumi.Input[bool] approval_required: Requires the user to request access from an administrator at the start of each session.
        :param pulumi.Input[str] decision: The action Access will take if a user matches this policy. Infrastructure application policies can only use the Allow
               action.
    ...
    def app_count(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    @app_count.setter
    def app_count(self, value: Optional[pulumi.Input[float]]):
...
class ZeroTrustAccessPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustAccessPolicy resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="appCount")
    def app_count(self) -> pulumi.Output[float]:
        """
        Number of access applications currently using this policy.
        """
        return pulumi.get(self, "app_count")
