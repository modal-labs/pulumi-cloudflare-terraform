...
def get_resource_groups(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getResourceGroups:getResourceGroups', __args__, opts=opts, typ=GetResourceGroupsResult, package_ref=_utilities.get_package()).value
...
def get_resource_groups_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getResourceGroups:getResourceGroups', __args__, opts=opts, typ=GetResourceGroupsResult, package_ref=_utilities.get_package())
