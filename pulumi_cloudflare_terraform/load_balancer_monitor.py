...
class LoadBalancerMonitorArgs:
    def __init__(__self__, *,
                 ...
                 consecutive_down: Optional[pulumi.Input[float]] = None,
                 consecutive_up: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[bool] allow_insecure: Do not validate the certificate when monitor use HTTPS. This parameter is currently only valid for HTTP and HTTPS
               monitors.
        :param pulumi.Input[float] consecutive_down: To be marked unhealthy the monitored origin must fail this healthcheck N consecutive times.
        :param pulumi.Input[float] consecutive_up: To be marked healthy the monitored origin must pass this healthcheck N consecutive times.
        :param pulumi.Input[str] description: Object description.
        :param pulumi.Input[str] expected_body: A case-insensitive sub-string to look for in the response body. If this string is not found, the origin will be marked
               as unhealthy. This parameter is only valid for HTTP and HTTPS monitors.
        :param pulumi.Input[str] expected_codes: The expected HTTP response code or code range of the health check. This parameter is only valid for HTTP and HTTPS
               monitors.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[Sequence[pulumi.Input[str]]]]] header: The HTTP request headers to send in the health check. It is recommended you set a Host header by default. The User-Agent
               header cannot be overridden. This parameter is only valid for HTTP and HTTPS monitors.
        :param pulumi.Input[float] interval: The interval between each health check. Shorter intervals may improve failover time, but will increase load on the
               origins as we check from multiple locations.
        :param pulumi.Input[str] method: The method to use for the health check. This defaults to 'GET' for HTTP/HTTPS based checks and 'connection_established'
        ...
        :param pulumi.Input[float] port: The port number to connect to for the health check. Required for TCP, UDP, and SMTP checks. HTTP and HTTPS checks should
               only define the port when using a non-standard port (HTTP: default 80, HTTPS: default 443).
        :param pulumi.Input[str] probe_zone: Assign this monitor to emulate the specified zone while probing. This parameter is only valid for HTTP and HTTPS
               monitors.
        :param pulumi.Input[float] retries: The number of retries to attempt in case of a timeout before marking the origin as unhealthy. Retries are attempted
               immediately.
        :param pulumi.Input[float] timeout: The timeout (in seconds) before marking the health check as failed.
        :param pulumi.Input[str] type: The protocol to use for the health check. Currently supported protocols are 'HTTP','HTTPS', 'TCP', 'ICMP-PING',
               'UDP-ICMP', and 'SMTP'.
        """
    ...
    def consecutive_down(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def consecutive_down(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "consecutive_down", value)

    @property
    @pulumi.getter(name="consecutiveUp")
    def consecutive_up(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def consecutive_up(self, value: Optional[pulumi.Input[float]]):
    ...
    def expected_body(self) -> Optional[pulumi.Input[str]]:
        """
        A case-insensitive sub-string to look for in the response body. If this string is not found, the origin will be marked
        as unhealthy. This parameter is only valid for HTTP and HTTPS monitors.
        """
    ...
    def method(self) -> Optional[pulumi.Input[str]]:
        """
        The method to use for the health check. This defaults to 'GET' for HTTP/HTTPS based checks and 'connection_established'
        for TCP based health checks.
        """
    ...
    def port(self) -> Optional[pulumi.Input[float]]:
        """
        The port number to connect to for the health check. Required for TCP, UDP, and SMTP checks. HTTP and HTTPS checks should
        only define the port when using a non-standard port (HTTP: default 80, HTTPS: default 443).
        """
    ...
    def probe_zone(self) -> Optional[pulumi.Input[str]]:
        """
        Assign this monitor to emulate the specified zone while probing. This parameter is only valid for HTTP and HTTPS
        monitors.
        """
    ...
    def type(self) -> Optional[pulumi.Input[str]]:
        """
        The protocol to use for the health check. Currently supported protocols are 'HTTP','HTTPS', 'TCP', 'ICMP-PING',
        'UDP-ICMP', and 'SMTP'.
        """
...
class LoadBalancerMonitor(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LoadBalancerMonitor resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="consecutiveDown")
    def consecutive_down(self) -> pulumi.Output[float]:
        """
        To be marked unhealthy the monitored origin must fail this healthcheck N consecutive times.
        """
        return pulumi.get(self, "consecutive_down")
    ...
    @property
    @pulumi.getter(name="consecutiveUp")
    def consecutive_up(self) -> pulumi.Output[float]:
        """
        To be marked healthy the monitored origin must pass this healthcheck N consecutive times.
        """
        return pulumi.get(self, "consecutive_up")
    ...
    @property
    @pulumi.getter
    def retries(self) -> pulumi.Output[float]:
        """
        The number of retries to attempt in case of a timeout before marking the origin as unhealthy. Retries are attempted
        immediately.
        """
