...
def get_turnstile_widgets(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getTurnstileWidgets:getTurnstileWidgets', __args__, opts=opts, typ=GetTurnstileWidgetsResult, package_ref=_utilities.get_package()).value
...
def get_turnstile_widgets_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getTurnstileWidgets:getTurnstileWidgets', __args__, opts=opts, typ=GetTurnstileWidgetsResult, package_ref=_utilities.get_package())
