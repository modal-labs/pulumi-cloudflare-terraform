...
class SpectrumApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] protocol: The port configuration at Cloudflare's edge. May specify a single port, for example `"tcp/1000"`, or a range of ports,
               for example `"tcp/1000-2000"`.
        :param pulumi.Input[str] zone_id: Zone identifier.
        :param pulumi.Input[bool] argo_smart_routing: Enables Argo Smart Routing for this application. Notes: Only available for TCP applications with traffic_type set to
               "direct".
        ...
        :param pulumi.Input[bool] ip_firewall: Enables IP Access Rules for this application. Notes: Only available for TCP applications.
        ...
        :param Any origin_port: The destination port at the origin. Only specified in conjunction with origin_dns. May use an integer to specify a
               ...
               "protocol" field.
        :param pulumi.Input[str] proxy_protocol: Enables Proxy Protocol to the origin. Refer to [Enable Proxy
               protocol](https://developers.cloudflare.com/spectrum/getting-started/proxy-protocol/) for implementation details on
               PROXY Protocol V1, PROXY Protocol V2, and Simple Proxy Protocol.
        :param pulumi.Input[str] tls: The type of TLS termination associated with the application.
        :param pulumi.Input[str] traffic_type: Determines how data travels from the edge to your origin. When set to "direct", Spectrum will send traffic directly to
...
class SpectrumApplication(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a SpectrumApplication resource with the given unique name, props, and options.
