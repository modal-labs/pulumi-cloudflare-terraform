...
class CertificatePackArgs:
    def __init__(__self__, *,
                 ...
                 validity_days: pulumi.Input[float],
                 zone_id: pulumi.Input[str],
                 cloudflare_branding: Optional[pulumi.Input[bool]] = None):
        """
        The set of arguments for constructing a CertificatePack resource.
        :param pulumi.Input[str] certificate_authority: Certificate Authority selected for the order. For information on any certificate authority specific details or
               restrictions [see this page for more details.](https://developers.cloudflare.com/ssl/reference/certificate-authorities)
        :param pulumi.Input[Sequence[pulumi.Input[str]]] hosts: Comma separated list of valid host names for the certificate packs. Must contain the zone apex, may not contain more
               than 50 hosts, and may not be empty.
        ...
        :param pulumi.Input[float] validity_days: Validity Days selected for the order.
        :param pulumi.Input[str] zone_id: Identifier
        :param pulumi.Input[bool] cloudflare_branding: Whether or not to add Cloudflare Branding for the order. This will add a subdomain of sni.cloudflaressl.com as the
               Common Name if set to true.
        """
    ...
    def certificate_authority(self) -> pulumi.Input[str]:
        """
        Certificate Authority selected for the order. For information on any certificate authority specific details or
        restrictions [see this page for more details.](https://developers.cloudflare.com/ssl/reference/certificate-authorities)
        """
    ...
    def hosts(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
        Comma separated list of valid host names for the certificate packs. Must contain the zone apex, may not contain more
        than 50 hosts, and may not be empty.
        """
    ...
    def validity_days(self) -> pulumi.Input[float]:
        """
    ...
    def validity_days(self, value: pulumi.Input[float]):
    ...
    def cloudflare_branding(self) -> Optional[pulumi.Input[bool]]:
        """
        Whether or not to add Cloudflare Branding for the order. This will add a subdomain of sni.cloudflaressl.com as the
        Common Name if set to true.
        """
...
class _CertificatePackState:
    ...
    @property
    @pulumi.getter(name="validityDays")
    def validity_days(self) -> Optional[pulumi.Input[float]]:
        """
        Validity Days selected for the order.
        """
        return pulumi.get(self, "validity_days")
    ...
    @validity_days.setter
    def validity_days(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "validity_days", value)
...
class CertificatePack(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="validityDays")
    def validity_days(self) -> pulumi.Output[float]:
        """
        Validity Days selected for the order.
        """
        return pulumi.get(self, "validity_days")
