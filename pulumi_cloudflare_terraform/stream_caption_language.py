...
class StreamCaptionLanguageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] file: The WebVTT file containing the caption or subtitle content.
        """
...
class _StreamCaptionLanguageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] account_id: Identifier
        :param pulumi.Input[str] file: The WebVTT file containing the caption or subtitle content.
        :param pulumi.Input[bool] generated: Whether the caption was generated via AI.
        :param pulumi.Input[str] identifier: A Cloudflare-generated unique identifier for a media item.
...
class StreamCaptionLanguage(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a StreamCaptionLanguage resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            label: Optional[pulumi.Input[str]] = None,
            language: Optional[pulumi.Input[str]] = None,
            status: Optional[pulumi.Input[str]] = None) -> 'StreamCaptionLanguage':
        """
    ...
    @property
    @pulumi.getter
    def generated(self) -> pulumi.Output[bool]:
        """
        Whether the caption was generated via AI.
        """
        return pulumi.get(self, "generated")
