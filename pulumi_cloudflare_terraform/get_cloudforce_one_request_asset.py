...
def get_cloudforce_one_request_asset(account_identifier: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getCloudforceOneRequestAsset:getCloudforceOneRequestAsset', __args__, opts=opts, typ=GetCloudforceOneRequestAssetResult, package_ref=_utilities.get_package()).value
...
def get_cloudforce_one_request_asset_output(account_identifier: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getCloudforceOneRequestAsset:getCloudforceOneRequestAsset', __args__, opts=opts, typ=GetCloudforceOneRequestAssetResult, package_ref=_utilities.get_package())
