...
class GetZeroTrustAccessServiceTokenResult:
    ...
    def service_token_id(self) -> Optional[str]:
...
def get_zero_trust_access_service_token(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustAccessServiceToken:getZeroTrustAccessServiceToken', __args__, opts=opts, typ=GetZeroTrustAccessServiceTokenResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_access_service_token_output(account_id: Optional[pulumi.Input[Optional[str]]] = None,
                                               ...
                                               service_token_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustAccessServiceToken:getZeroTrustAccessServiceToken', __args__, opts=opts, typ=GetZeroTrustAccessServiceTokenResult, package_ref=_utilities.get_package())
