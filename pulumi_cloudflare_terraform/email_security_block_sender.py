...
class _EmailSecurityBlockSenderState:
    def __init__(__self__, *,
                 ...
                 email_security_block_sender_id: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[str] account_id: Account Identifier
        :param pulumi.Input[float] email_security_block_sender_id: The unique identifier for the allow policy.
        """
    ...
    def email_security_block_sender_id(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def email_security_block_sender_id(self, value: Optional[pulumi.Input[float]]):
...
class EmailSecurityBlockSender(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a EmailSecurityBlockSender resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            last_modified: Optional[pulumi.Input[str]] = None,
            pattern: Optional[pulumi.Input[str]] = None,
            pattern_type: Optional[pulumi.Input[str]] = None) -> 'EmailSecurityBlockSender':
        """
    ...
    @property
    @pulumi.getter(name="emailSecurityBlockSenderId")
    def email_security_block_sender_id(self) -> pulumi.Output[float]:
        """
        The unique identifier for the allow policy.
        """
        return pulumi.get(self, "email_security_block_sender_id")
    ...
    @property
    @pulumi.getter(name="isRegex")
    def is_regex(self) -> pulumi.Output[bool]:
        return pulumi.get(self, "is_regex")
