...
def get_calls_sfu_app(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getCallsSfuApp:getCallsSfuApp', __args__, opts=opts, typ=GetCallsSfuAppResult, package_ref=_utilities.get_package()).value
...
def get_calls_sfu_app_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getCallsSfuApp:getCallsSfuApp', __args__, opts=opts, typ=GetCallsSfuAppResult, package_ref=_utilities.get_package())
