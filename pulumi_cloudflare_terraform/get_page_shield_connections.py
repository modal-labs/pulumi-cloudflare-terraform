...
def get_page_shield_connections(connection_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getPageShieldConnections:getPageShieldConnections', __args__, opts=opts, typ=GetPageShieldConnectionsResult, package_ref=_utilities.get_package()).value
...
def get_page_shield_connections_output(connection_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getPageShieldConnections:getPageShieldConnections', __args__, opts=opts, typ=GetPageShieldConnectionsResult, package_ref=_utilities.get_package())
