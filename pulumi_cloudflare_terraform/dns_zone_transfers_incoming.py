...
class DnsZoneTransfersIncomingArgs:
    def __init__(__self__, *,
                 auto_refresh_seconds: pulumi.Input[float],
                 peers: pulumi.Input[Sequence[pulumi.Input[str]]],
                 zone_id: pulumi.Input[str],
                 name: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a DnsZoneTransfersIncoming resource.
        :param pulumi.Input[float] auto_refresh_seconds: How often should a secondary zone auto refresh regardless of DNS NOTIFY. Not applicable for primary zones.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] peers: A list of peer tags.
    ...
    def auto_refresh_seconds(self) -> pulumi.Input[float]:
        """
    ...
    def auto_refresh_seconds(self, value: pulumi.Input[float]):
        pulumi.set(self, "auto_refresh_seconds", value)

    @property
    @pulumi.getter
    def peers(self) -> pulumi.Input[Sequence[pulumi.Input[str]]]:
        """
        A list of peer tags.
        """
    ...
    @peers.setter
    def peers(self, value: pulumi.Input[Sequence[pulumi.Input[str]]]):
...
class _DnsZoneTransfersIncomingState:
    def __init__(__self__, *,
                 auto_refresh_seconds: Optional[pulumi.Input[float]] = None,
                 checked_time: Optional[pulumi.Input[str]] = None,
                 created_time: Optional[pulumi.Input[str]] = None,
                 modified_time: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 peers: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 soa_serial: Optional[pulumi.Input[float]] = None,
                 zone_id: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering DnsZoneTransfersIncoming resources.
        :param pulumi.Input[float] auto_refresh_seconds: How often should a secondary zone auto refresh regardless of DNS NOTIFY. Not applicable for primary zones.
        :param pulumi.Input[str] checked_time: The time for a specific event.
        :param pulumi.Input[str] created_time: The time for a specific event.
        :param pulumi.Input[str] modified_time: The time for a specific event.
        :param pulumi.Input[str] name: Zone name.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] peers: A list of peer tags.
        :param pulumi.Input[float] soa_serial: The serial number of the SOA for the given zone.
        """
    ...
    @property
    @pulumi.getter(name="autoRefreshSeconds")
    def auto_refresh_seconds(self) -> Optional[pulumi.Input[float]]:
        """
        How often should a secondary zone auto refresh regardless of DNS NOTIFY. Not applicable for primary zones.
        """
        return pulumi.get(self, "auto_refresh_seconds")
    ...
    @auto_refresh_seconds.setter
    def auto_refresh_seconds(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "auto_refresh_seconds", value)

    @property
    @pulumi.getter(name="checkedTime")
    def checked_time(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @checked_time.setter
    def checked_time(self, value: Optional[pulumi.Input[str]]):
    ...
    def soa_serial(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    @soa_serial.setter
    def soa_serial(self, value: Optional[pulumi.Input[float]]):
...
class DnsZoneTransfersIncoming(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DnsZoneTransfersIncoming resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            peers: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            soa_serial: Optional[pulumi.Input[float]] = None,
            zone_id: Optional[pulumi.Input[str]] = None) -> 'DnsZoneTransfersIncoming':
        """
    ...
    @property
    @pulumi.getter(name="autoRefreshSeconds")
    def auto_refresh_seconds(self) -> pulumi.Output[float]:
        """
        How often should a secondary zone auto refresh regardless of DNS NOTIFY. Not applicable for primary zones.
        """
        return pulumi.get(self, "auto_refresh_seconds")
    ...
    @property
    @pulumi.getter(name="checkedTime")
    def checked_time(self) -> pulumi.Output[str]:
        """
        The time for a specific event.
        """
        return pulumi.get(self, "checked_time")
    ...
    @property
    @pulumi.getter(name="soaSerial")
    def soa_serial(self) -> pulumi.Output[float]:
        """
        The serial number of the SOA for the given zone.
        """
        return pulumi.get(self, "soa_serial")
