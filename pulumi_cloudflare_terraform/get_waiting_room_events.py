...
def get_waiting_room_events(max_items: Optional[float] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWaitingRoomEvents:getWaitingRoomEvents', __args__, opts=opts, typ=GetWaitingRoomEventsResult, package_ref=_utilities.get_package()).value
...
def get_waiting_room_events_output(max_items: Optional[pulumi.Input[Optional[float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWaitingRoomEvents:getWaitingRoomEvents', __args__, opts=opts, typ=GetWaitingRoomEventsResult, package_ref=_utilities.get_package())
