...
def get_url_normalization_settings(zone_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getUrlNormalizationSettings:getUrlNormalizationSettings', __args__, opts=opts, typ=GetUrlNormalizationSettingsResult, package_ref=_utilities.get_package()).value
...
def get_url_normalization_settings_output(zone_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getUrlNormalizationSettings:getUrlNormalizationSettings', __args__, opts=opts, typ=GetUrlNormalizationSettingsResult, package_ref=_utilities.get_package())
