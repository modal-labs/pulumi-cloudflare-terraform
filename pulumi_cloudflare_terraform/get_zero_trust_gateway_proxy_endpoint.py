...
def get_zero_trust_gateway_proxy_endpoint(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustGatewayProxyEndpoint:getZeroTrustGatewayProxyEndpoint', __args__, opts=opts, typ=GetZeroTrustGatewayProxyEndpointResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_gateway_proxy_endpoint_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustGatewayProxyEndpoint:getZeroTrustGatewayProxyEndpoint', __args__, opts=opts, typ=GetZeroTrustGatewayProxyEndpointResult, package_ref=_utilities.get_package())
