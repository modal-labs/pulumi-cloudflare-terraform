...
def get_stream_download(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getStreamDownload:getStreamDownload', __args__, opts=opts, typ=GetStreamDownloadResult, package_ref=_utilities.get_package()).value
...
def get_stream_download_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getStreamDownload:getStreamDownload', __args__, opts=opts, typ=GetStreamDownloadResult, package_ref=_utilities.get_package())
