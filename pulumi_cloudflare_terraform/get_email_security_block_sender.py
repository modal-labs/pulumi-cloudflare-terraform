...
class GetEmailSecurityBlockSenderResult:
    ...
    def __init__(__self__, account_id=None, comments=None, created_at=None, filter=None, id=None, is_regex=None, last_modified=None, pattern=None, pattern_id=None, pattern_type=None):
        ...
        if pattern_id and not isinstance(pattern_id, float):
            raise TypeError("Expected argument 'pattern_id' to be a float")
    ...
    def pattern_id(self) -> Optional[float]:
...
def get_email_security_block_sender(account_id: Optional[str] = None,
                                    ...
                                    pattern_id: Optional[float] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getEmailSecurityBlockSender:getEmailSecurityBlockSender', __args__, opts=opts, typ=GetEmailSecurityBlockSenderResult, package_ref=_utilities.get_package()).value
...
def get_email_security_block_sender_output(account_id: Optional[pulumi.Input[str]] = None,
                                           ...
                                           pattern_id: Optional[pulumi.Input[Optional[float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getEmailSecurityBlockSender:getEmailSecurityBlockSender', __args__, opts=opts, typ=GetEmailSecurityBlockSenderResult, package_ref=_utilities.get_package())
