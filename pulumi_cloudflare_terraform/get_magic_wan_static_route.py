...
def get_magic_wan_static_route(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMagicWanStaticRoute:getMagicWanStaticRoute', __args__, opts=opts, typ=GetMagicWanStaticRouteResult, package_ref=_utilities.get_package()).value
...
def get_magic_wan_static_route_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMagicWanStaticRoute:getMagicWanStaticRoute', __args__, opts=opts, typ=GetMagicWanStaticRouteResult, package_ref=_utilities.get_package())
