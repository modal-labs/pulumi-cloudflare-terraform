...
class WaitingRoomSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] search_engine_crawler_bypass: Whether to allow verified search engine crawlers to bypass all waiting rooms on this zone. Verified search engine
...
class WaitingRoomSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a WaitingRoomSettings resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="searchEngineCrawlerBypass")
    def search_engine_crawler_bypass(self) -> pulumi.Output[bool]:
        """
        Whether to allow verified search engine crawlers to bypass all waiting rooms on this zone. Verified search engine
        crawlers will not be tracked or counted by the waiting room system, and will not appear in waiting room analytics.
        """
