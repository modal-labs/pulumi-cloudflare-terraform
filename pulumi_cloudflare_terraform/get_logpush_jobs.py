...
class GetLogpushJobsResult:
    ...
    @property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetLogpushJobsResultResult']:
...
class AwaitableGetLogpushJobsResult(GetLogpushJobsResult):
...
def get_logpush_jobs(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getLogpushJobs:getLogpushJobs', __args__, opts=opts, typ=GetLogpushJobsResult, package_ref=_utilities.get_package()).value
...
def get_logpush_jobs_output(account_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getLogpushJobs:getLogpushJobs', __args__, opts=opts, typ=GetLogpushJobsResult, package_ref=_utilities.get_package())
