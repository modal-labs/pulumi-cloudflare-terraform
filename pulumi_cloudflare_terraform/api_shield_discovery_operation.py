...
class ApiShieldDiscoveryOperation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ApiShieldDiscoveryOperation resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            operation_id: Optional[pulumi.Input[str]] = None,
            state: Optional[pulumi.Input[str]] = None,
            zone_id: Optional[pulumi.Input[str]] = None) -> 'ApiShieldDiscoveryOperation':
        """
