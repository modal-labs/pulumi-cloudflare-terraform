...
def get_d1_database(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getD1Database:getD1Database', __args__, opts=opts, typ=GetD1DatabaseResult, package_ref=_utilities.get_package()).value
...
def get_d1_database_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getD1Database:getD1Database', __args__, opts=opts, typ=GetD1DatabaseResult, package_ref=_utilities.get_package())
