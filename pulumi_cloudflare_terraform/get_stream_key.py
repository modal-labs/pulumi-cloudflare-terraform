...
def get_stream_key(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getStreamKey:getStreamKey', __args__, opts=opts, typ=GetStreamKeyResult, package_ref=_utilities.get_package()).value
...
def get_stream_key_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getStreamKey:getStreamKey', __args__, opts=opts, typ=GetStreamKeyResult, package_ref=_utilities.get_package())
