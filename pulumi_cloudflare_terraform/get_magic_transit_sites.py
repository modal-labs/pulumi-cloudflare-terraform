...
def get_magic_transit_sites(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMagicTransitSites:getMagicTransitSites', __args__, opts=opts, typ=GetMagicTransitSitesResult, package_ref=_utilities.get_package()).value
...
def get_magic_transit_sites_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMagicTransitSites:getMagicTransitSites', __args__, opts=opts, typ=GetMagicTransitSitesResult, package_ref=_utilities.get_package())
