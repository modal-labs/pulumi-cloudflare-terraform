...
class GetCloudforceOneRequestResult:
    ...
    def request_identifier(self) -> Optional[str]:
...
def get_cloudforce_one_request(account_identifier: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getCloudforceOneRequest:getCloudforceOneRequest', __args__, opts=opts, typ=GetCloudforceOneRequestResult, package_ref=_utilities.get_package()).value
...
def get_cloudforce_one_request_output(account_identifier: Optional[pulumi.Input[str]] = None,
                                      request_identifier: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getCloudforceOneRequest:getCloudforceOneRequest', __args__, opts=opts, typ=GetCloudforceOneRequestResult, package_ref=_utilities.get_package())
