...
def get_zero_trust_device_default_profile(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDeviceDefaultProfile:getZeroTrustDeviceDefaultProfile', __args__, opts=opts, typ=GetZeroTrustDeviceDefaultProfileResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_device_default_profile_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDeviceDefaultProfile:getZeroTrustDeviceDefaultProfile', __args__, opts=opts, typ=GetZeroTrustDeviceDefaultProfileResult, package_ref=_utilities.get_package())
