...
__all__ = [
    ...
    'AwaitableGetZeroTrustDnsLocationsResult',
    'get_zero_trust_dns_locations',
...
def get_zero_trust_dns_locations(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDnsLocations:getZeroTrustDnsLocations', __args__, opts=opts, typ=GetZeroTrustDnsLocationsResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_dns_locations_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDnsLocations:getZeroTrustDnsLocations', __args__, opts=opts, typ=GetZeroTrustDnsLocationsResult, package_ref=_utilities.get_package())
