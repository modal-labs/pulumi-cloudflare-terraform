...
def get_zero_trust_gateway_certificate(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustGatewayCertificate:getZeroTrustGatewayCertificate', __args__, opts=opts, typ=GetZeroTrustGatewayCertificateResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_gateway_certificate_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustGatewayCertificate:getZeroTrustGatewayCertificate', __args__, opts=opts, typ=GetZeroTrustGatewayCertificateResult, package_ref=_utilities.get_package())
