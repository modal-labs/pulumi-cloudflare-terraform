...
def get_workers_custom_domain(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWorkersCustomDomain:getWorkersCustomDomain', __args__, opts=opts, typ=GetWorkersCustomDomainResult, package_ref=_utilities.get_package()).value
...
def get_workers_custom_domain_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWorkersCustomDomain:getWorkersCustomDomain', __args__, opts=opts, typ=GetWorkersCustomDomainResult, package_ref=_utilities.get_package())
