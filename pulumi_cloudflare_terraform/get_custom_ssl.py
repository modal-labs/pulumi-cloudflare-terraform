...
class GetCustomSslResult:
    ...
    def custom_certificate_id(self) -> Optional[str]:
...
def get_custom_ssl(custom_certificate_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getCustomSsl:getCustomSsl', __args__, opts=opts, typ=GetCustomSslResult, package_ref=_utilities.get_package()).value
...
def get_custom_ssl_output(custom_certificate_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getCustomSsl:getCustomSsl', __args__, opts=opts, typ=GetCustomSslResult, package_ref=_utilities.get_package())
