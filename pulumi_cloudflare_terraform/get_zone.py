...
def get_zone(filter: Optional[Union['GetZoneFilterArgs', 'GetZoneFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZone:getZone', __args__, opts=opts, typ=GetZoneResult, package_ref=_utilities.get_package()).value
...
def get_zone_output(filter: Optional[pulumi.Input[Optional[Union['GetZoneFilterArgs', 'GetZoneFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZone:getZone', __args__, opts=opts, typ=GetZoneResult, package_ref=_utilities.get_package())
