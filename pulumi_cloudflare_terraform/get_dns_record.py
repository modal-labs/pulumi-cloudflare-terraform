...
class GetDnsRecordResult:
    ...
    def dns_record_id(self) -> Optional[str]:
...
def get_dns_record(dns_record_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getDnsRecord:getDnsRecord', __args__, opts=opts, typ=GetDnsRecordResult, package_ref=_utilities.get_package()).value
...
def get_dns_record_output(dns_record_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getDnsRecord:getDnsRecord', __args__, opts=opts, typ=GetDnsRecordResult, package_ref=_utilities.get_package())
