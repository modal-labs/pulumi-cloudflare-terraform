...
def get_images(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getImages:getImages', __args__, opts=opts, typ=GetImagesResult, package_ref=_utilities.get_package()).value
...
def get_images_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getImages:getImages', __args__, opts=opts, typ=GetImagesResult, package_ref=_utilities.get_package())
