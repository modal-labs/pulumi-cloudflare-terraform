...
class MagicWanIpsecTunnelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] customer_endpoint: The IP address assigned to the customer side of the IPsec tunnel. Not required, but must be set for proactive
               traceroutes to work.
        :param pulumi.Input[str] description: An optional description forthe IPsec tunnel.
        :param pulumi.Input[str] ipsec_tunnel_id: Identifier
        :param pulumi.Input[str] name: The name of the IPsec tunnel. The name cannot share a name with other tunnels.
        :param pulumi.Input[str] psk: A randomly generated or provided string for use in the IPsec tunnel.
    ...
    def customer_endpoint(self) -> Optional[pulumi.Input[str]]:
        """
        The IP address assigned to the customer side of the IPsec tunnel. Not required, but must be set for proactive
        traceroutes to work.
        """
    ...
    def ipsec_tunnel_id(self) -> Optional[pulumi.Input[str]]:
        """
        Identifier
        """
    ...
    def ipsec_tunnel_id(self, value: Optional[pulumi.Input[str]]):
...
class MagicWanIpsecTunnel(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a MagicWanIpsecTunnel resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            psk: Optional[pulumi.Input[str]] = None,
            replay_protection: Optional[pulumi.Input[bool]] = None) -> 'MagicWanIpsecTunnel':
        """
    ...
    @property
    @pulumi.getter(name="customerEndpoint")
    def customer_endpoint(self) -> pulumi.Output[Optional[str]]:
        """
        The IP address assigned to the customer side of the IPsec tunnel. Not required, but must be set for proactive
        traceroutes to work.
        """
    ...
    @property
    @pulumi.getter(name="ipsecTunnelId")
    def ipsec_tunnel_id(self) -> pulumi.Output[Optional[str]]:
        """
        Identifier
        """
        return pulumi.get(self, "ipsec_tunnel_id")
    ...
    @property
    @pulumi.getter(name="replayProtection")
    def replay_protection(self) -> pulumi.Output[bool]:
        """
        If `true`, then IPsec replay protection will be supported in the Cloudflare-to-customer direction.
        """
        return pulumi.get(self, "replay_protection")
