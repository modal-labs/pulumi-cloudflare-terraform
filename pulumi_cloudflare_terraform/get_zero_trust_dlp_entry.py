...
def get_zero_trust_dlp_entry(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDlpEntry:getZeroTrustDlpEntry', __args__, opts=opts, typ=GetZeroTrustDlpEntryResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_dlp_entry_output(account_id: Optional[pulumi.Input[str]] = None,
                                    entry_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDlpEntry:getZeroTrustDlpEntry', __args__, opts=opts, typ=GetZeroTrustDlpEntryResult, package_ref=_utilities.get_package())
