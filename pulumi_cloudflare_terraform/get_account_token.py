...
def get_account_token(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getAccountToken:getAccountToken', __args__, opts=opts, typ=GetAccountTokenResult, package_ref=_utilities.get_package()).value
...
def get_account_token_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getAccountToken:getAccountToken', __args__, opts=opts, typ=GetAccountTokenResult, package_ref=_utilities.get_package())
