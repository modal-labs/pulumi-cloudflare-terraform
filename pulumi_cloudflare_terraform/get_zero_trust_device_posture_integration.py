...
def get_zero_trust_device_posture_integration(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDevicePostureIntegration:getZeroTrustDevicePostureIntegration', __args__, opts=opts, typ=GetZeroTrustDevicePostureIntegrationResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_device_posture_integration_output(account_id: Optional[pulumi.Input[str]] = None,
                                                     integration_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDevicePostureIntegration:getZeroTrustDevicePostureIntegration', __args__, opts=opts, typ=GetZeroTrustDevicePostureIntegrationResult, package_ref=_utilities.get_package())
