...
class ZeroTrustTunnelCloudflaredArgs:
    def __init__(__self__, *,
                 ...
                 tunnel_secret: Optional[pulumi.Input[str]] = None):
        """
        ...
        :param pulumi.Input[str] config_src: Indicates if this is a locally or remotely configured tunnel. If `local`, manage the tunnel using a YAML file on the
               origin machine. If `cloudflare`, manage the tunnel on the Zero Trust dashboard.
        :param pulumi.Input[str] name: A user-friendly name for a tunnel.
        :param pulumi.Input[str] tunnel_secret: Sets the password required to run a locally-managed tunnel. Must be at least 32 bytes and encoded as a base64 string.
        """
    ...
    def tunnel_secret(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def tunnel_secret(self, value: Optional[pulumi.Input[str]]):
...
class _ZeroTrustTunnelCloudflaredState:
    def __init__(__self__, *,
                 ...
                 account_tag: Optional[pulumi.Input[str]] = None,
                 config_src: Optional[pulumi.Input[str]] = None,
                 connections: Optional[pulumi.Input[Sequence[pulumi.Input['ZeroTrustTunnelCloudflaredConnectionArgs']]]] = None,
                 conns_active_at: Optional[pulumi.Input[str]] = None,
                 conns_inactive_at: Optional[pulumi.Input[str]] = None,
                 created_at: Optional[pulumi.Input[str]] = None,
                 deleted_at: Optional[pulumi.Input[str]] = None,
                 metadata: Optional[pulumi.Input[str]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 remote_config: Optional[pulumi.Input[bool]] = None,
                 status: Optional[pulumi.Input[str]] = None,
                 tun_type: Optional[pulumi.Input[str]] = None,
                 tunnel_secret: Optional[pulumi.Input[str]] = None):
        """
        Input properties used for looking up and filtering ZeroTrustTunnelCloudflared resources.
        :param pulumi.Input[str] account_id: Cloudflare account ID
        :param pulumi.Input[str] account_tag: Cloudflare account ID
        :param pulumi.Input[str] config_src: Indicates if this is a locally or remotely configured tunnel. If `local`, manage the tunnel using a YAML file on the
               origin machine. If `cloudflare`, manage the tunnel on the Zero Trust dashboard.
        ...
        :param pulumi.Input[str] conns_active_at: Timestamp of when the tunnel established at least one connection to Cloudflare's edge. If `null`, the tunnel is
               inactive.
        :param pulumi.Input[str] conns_inactive_at: Timestamp of when the tunnel became inactive (no connections to Cloudflare's edge). If `null`, the tunnel is active.
        ...
        :param pulumi.Input[str] metadata: Metadata associated with the tunnel.
        :param pulumi.Input[str] name: A user-friendly name for a tunnel.
        :param pulumi.Input[bool] remote_config: If `true`, the tunnel can be configured remotely from the Zero Trust dashboard. If `false`, the tunnel must be
               configured locally on the origin machine.
        :param pulumi.Input[str] status: The status of the tunnel. Valid values are `inactive` (tunnel has never been run), `degraded` (tunnel is active and able
               to serve traffic but in an unhealthy state), `healthy` (tunnel is active and able to serve traffic), or `down` (tunnel
               can not serve traffic as it has no connections to the Cloudflare Edge).
        :param pulumi.Input[str] tun_type: The type of tunnel.
        :param pulumi.Input[str] tunnel_secret: Sets the password required to run a locally-managed tunnel. Must be at least 32 bytes and encoded as a base64 string.
        """
    ...
    def account_tag(self) -> Optional[pulumi.Input[str]]:
        """
        Cloudflare account ID
        """
    ...
    @account_tag.setter
    def account_tag(self, value: Optional[pulumi.Input[str]]):
    ...
    def conns_active_at(self) -> Optional[pulumi.Input[str]]:
        """
        Timestamp of when the tunnel established at least one connection to Cloudflare's edge. If `null`, the tunnel is
        inactive.
        """
        return pulumi.get(self, "conns_active_at")

    @conns_active_at.setter
    def conns_active_at(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "conns_active_at", value)

    @property
    @pulumi.getter(name="connsInactiveAt")
    def conns_inactive_at(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def conns_inactive_at(self, value: Optional[pulumi.Input[str]]):
    ...
    def remote_config(self) -> Optional[pulumi.Input[bool]]:
        """
        If `true`, the tunnel can be configured remotely from the Zero Trust dashboard. If `false`, the tunnel must be
        configured locally on the origin machine.
        """
        return pulumi.get(self, "remote_config")

    @remote_config.setter
    def remote_config(self, value: Optional[pulumi.Input[bool]]):
    ...
    def status(self) -> Optional[pulumi.Input[str]]:
        """
        The status of the tunnel. Valid values are `inactive` (tunnel has never been run), `degraded` (tunnel is active and able
        to serve traffic but in an unhealthy state), `healthy` (tunnel is active and able to serve traffic), or `down` (tunnel
        can not serve traffic as it has no connections to the Cloudflare Edge).
        """
    ...
    def tun_type(self) -> Optional[pulumi.Input[str]]:
        """
        The type of tunnel.
        """
    ...
    @tun_type.setter
    def tun_type(self, value: Optional[pulumi.Input[str]]):
...
class ZeroTrustTunnelCloudflared(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustTunnelCloudflared resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[str]] = None,
            tun_type: Optional[pulumi.Input[str]] = None,
            tunnel_secret: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustTunnelCloudflared':
        """
    ...
    @property
    @pulumi.getter(name="accountTag")
    def account_tag(self) -> pulumi.Output[str]:
        """
        Cloudflare account ID
        """
        return pulumi.get(self, "account_tag")
    ...
    @property
    @pulumi.getter(name="configSrc")
    def config_src(self) -> pulumi.Output[str]:
        """
        Indicates if this is a locally or remotely configured tunnel. If `local`, manage the tunnel using a YAML file on the
        origin machine. If `cloudflare`, manage the tunnel on the Zero Trust dashboard.
        """
    ...
    @property
    @pulumi.getter(name="connsActiveAt")
    def conns_active_at(self) -> pulumi.Output[str]:
        """
        Timestamp of when the tunnel established at least one connection to Cloudflare's edge. If `null`, the tunnel is
        inactive.
        """
    ...
    @property
    @pulumi.getter(name="connsInactiveAt")
    def conns_inactive_at(self) -> pulumi.Output[str]:
        """
        Timestamp of when the tunnel became inactive (no connections to Cloudflare's edge). If `null`, the tunnel is active.
        """
        return pulumi.get(self, "conns_inactive_at")
    ...
    @property
    @pulumi.getter(name="remoteConfig")
    def remote_config(self) -> pulumi.Output[bool]:
        """
        If `true`, the tunnel can be configured remotely from the Zero Trust dashboard. If `false`, the tunnel must be
        configured locally on the origin machine.
        """
    ...
    @property
    @pulumi.getter(name="tunType")
    def tun_type(self) -> pulumi.Output[str]:
        """
        The type of tunnel.
        """
        return pulumi.get(self, "tun_type")
    ...
    @property
    @pulumi.getter(name="tunnelSecret")
    def tunnel_secret(self) -> pulumi.Output[Optional[str]]:
        """
        Sets the password required to run a locally-managed tunnel. Must be at least 32 bytes and encoded as a base64 string.
        """
        return pulumi.get(self, "tunnel_secret")
