...
class GetZeroTrustAccessCustomPageResult:
    ...
    def __init__(__self__, account_id=None, app_count=None, created_at=None, custom_html=None, custom_page_id=None, id=None, name=None, type=None, uid=None, updated_at=None):
        ...
        if app_count and not isinstance(app_count, float):
            raise TypeError("Expected argument 'app_count' to be a float")
    ...
    def custom_page_id(self) -> Optional[str]:
...
def get_zero_trust_access_custom_page(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustAccessCustomPage:getZeroTrustAccessCustomPage', __args__, opts=opts, typ=GetZeroTrustAccessCustomPageResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_access_custom_page_output(account_id: Optional[pulumi.Input[str]] = None,
                                             custom_page_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustAccessCustomPage:getZeroTrustAccessCustomPage', __args__, opts=opts, typ=GetZeroTrustAccessCustomPageResult, package_ref=_utilities.get_package())
