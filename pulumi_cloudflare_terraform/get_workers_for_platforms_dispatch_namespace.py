...
class GetWorkersForPlatformsDispatchNamespaceResult:
    ...
    def __init__(__self__, account_id=None, created_by=None, created_on=None, dispatch_namespace=None, id=None, modified_by=None, modified_on=None, namespace_id=None, namespace_name=None, script_count=None):
        ...
        if script_count and not isinstance(script_count, float):
            raise TypeError("Expected argument 'script_count' to be a float")
    ...
    def dispatch_namespace(self) -> Optional[str]:
...
def get_workers_for_platforms_dispatch_namespace(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWorkersForPlatformsDispatchNamespace:getWorkersForPlatformsDispatchNamespace', __args__, opts=opts, typ=GetWorkersForPlatformsDispatchNamespaceResult, package_ref=_utilities.get_package()).value
...
def get_workers_for_platforms_dispatch_namespace_output(account_id: Optional[pulumi.Input[str]] = None,
                                                        dispatch_namespace: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWorkersForPlatformsDispatchNamespace:getWorkersForPlatformsDispatchNamespace', __args__, opts=opts, typ=GetWorkersForPlatformsDispatchNamespaceResult, package_ref=_utilities.get_package())
