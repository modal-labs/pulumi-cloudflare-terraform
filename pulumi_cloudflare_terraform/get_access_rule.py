...
def get_access_rule(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getAccessRule:getAccessRule', __args__, opts=opts, typ=GetAccessRuleResult, package_ref=_utilities.get_package()).value
...
def get_access_rule_output(account_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getAccessRule:getAccessRule', __args__, opts=opts, typ=GetAccessRuleResult, package_ref=_utilities.get_package())
