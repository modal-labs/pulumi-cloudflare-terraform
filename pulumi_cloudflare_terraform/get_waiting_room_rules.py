...
def get_waiting_room_rules(waiting_room_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWaitingRoomRules:getWaitingRoomRules', __args__, opts=opts, typ=GetWaitingRoomRulesResult, package_ref=_utilities.get_package()).value
...
def get_waiting_room_rules_output(waiting_room_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWaitingRoomRules:getWaitingRoomRules', __args__, opts=opts, typ=GetWaitingRoomRulesResult, package_ref=_utilities.get_package())
