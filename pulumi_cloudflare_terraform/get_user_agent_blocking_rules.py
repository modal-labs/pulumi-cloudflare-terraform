...
class GetUserAgentBlockingRulesResult:
    ...
    def ua_search(self) -> Optional[str]:
...
def get_user_agent_blocking_rules(description: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getUserAgentBlockingRules:getUserAgentBlockingRules', __args__, opts=opts, typ=GetUserAgentBlockingRulesResult, package_ref=_utilities.get_package()).value
...
def get_user_agent_blocking_rules_output(description: Optional[pulumi.Input[Optional[str]]] = None,
                                         description_search: Optional[pulumi.Input[Optional[str]]] = None,
                                         max_items: Optional[pulumi.Input[Optional[float]]] = None,
                                         ua_search: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getUserAgentBlockingRules:getUserAgentBlockingRules', __args__, opts=opts, typ=GetUserAgentBlockingRulesResult, package_ref=_utilities.get_package())
