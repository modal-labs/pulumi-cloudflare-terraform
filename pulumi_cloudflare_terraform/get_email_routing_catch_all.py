...
def get_email_routing_catch_all(zone_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getEmailRoutingCatchAll:getEmailRoutingCatchAll', __args__, opts=opts, typ=GetEmailRoutingCatchAllResult, package_ref=_utilities.get_package()).value
...
def get_email_routing_catch_all_output(zone_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getEmailRoutingCatchAll:getEmailRoutingCatchAll', __args__, opts=opts, typ=GetEmailRoutingCatchAllResult, package_ref=_utilities.get_package())
