...
class TotalTlsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enabled: If enabled, Total TLS will order a hostname specific TLS certificate for any proxied A, AAAA, or CNAME record in your
               zone.
    ...
    def enabled(self) -> pulumi.Input[bool]:
        """
        If enabled, Total TLS will order a hostname specific TLS certificate for any proxied A, AAAA, or CNAME record in your
        zone.
        """
...
class _TotalTlsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enabled: If enabled, Total TLS will order a hostname specific TLS certificate for any proxied A, AAAA, or CNAME record in your
               zone.
        :param pulumi.Input[float] validity_period: The validity period in days for the certificates ordered via Total TLS.
        :param pulumi.Input[str] zone_id: Identifier
        """
        if certificate_authority is not None:
            pulumi.set(__self__, "certificate_authority", certificate_authority)
    ...
    def validity_period(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def validity_period(self, value: Optional[pulumi.Input[float]]):
...
class TotalTls(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a TotalTls resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="validityPeriod")
    def validity_period(self) -> pulumi.Output[float]:
        """
        The validity period in days for the certificates ordered via Total TLS.
        """
        return pulumi.get(self, "validity_period")
