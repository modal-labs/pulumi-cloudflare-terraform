...
def get_zone_setting(setting_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZoneSetting:getZoneSetting', __args__, opts=opts, typ=GetZoneSettingResult, package_ref=_utilities.get_package()).value
...
def get_zone_setting_output(setting_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZoneSetting:getZoneSetting', __args__, opts=opts, typ=GetZoneSettingResult, package_ref=_utilities.get_package())
