...
class ZeroTrustDexTestArgs:
    def __init__(__self__, *,
                 ...
                 targeted: Optional[pulumi.Input[bool]] = None):
        """
        ...
        :param pulumi.Input[str] name: The name of the DEX test. Must be unique.
        :param pulumi.Input[Sequence[pulumi.Input['ZeroTrustDexTestTargetPolicyArgs']]] target_policies: Device settings profiles targeted by this test
        """
    ...
    @property
    @pulumi.getter
    def targeted(self) -> Optional[pulumi.Input[bool]]:
        return pulumi.get(self, "targeted")

    @targeted.setter
    def targeted(self, value: Optional[pulumi.Input[bool]]):
...
class _ZeroTrustDexTestState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The name of the DEX test. Must be unique.
        :param pulumi.Input[Sequence[pulumi.Input['ZeroTrustDexTestTargetPolicyArgs']]] target_policies: Device settings profiles targeted by this test
        :param pulumi.Input[str] test_id: The unique identifier for the test.
        """
...
class ZeroTrustDexTest(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustDexTest resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] interval: How often the test will run.
        :param pulumi.Input[str] name: The name of the DEX test. Must be unique.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ZeroTrustDexTestTargetPolicyArgs', 'ZeroTrustDexTestTargetPolicyArgsDict']]]] target_policies: Device settings profiles targeted by this test
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            target_policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ZeroTrustDexTestTargetPolicyArgs', 'ZeroTrustDexTestTargetPolicyArgsDict']]]]] = None,
            targeted: Optional[pulumi.Input[bool]] = None,
            test_id: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustDexTest':
        """
    ...
    @property
    @pulumi.getter(name="targetPolicies")
    def target_policies(self) -> pulumi.Output[Sequence['outputs.ZeroTrustDexTestTargetPolicy']]:
        """
        Device settings profiles targeted by this test
        """
        return pulumi.get(self, "target_policies")
    ...
    @property
    @pulumi.getter
    def targeted(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "targeted")
