...
class GetEmailSecurityImpersonationRegistryResult:
    ...
    def __init__(__self__, account_id=None, comments=None, created_at=None, directory_id=None, directory_node_id=None, display_name_id=None, email=None, external_directory_node_id=None, filter=None, id=None, is_email_regex=None, last_modified=None, name=None, provenance=None):
        ...
        if directory_id and not isinstance(directory_id, float):
            raise TypeError("Expected argument 'directory_id' to be a float")
        pulumi.set(__self__, "directory_id", directory_id)
        if directory_node_id and not isinstance(directory_node_id, float):
            raise TypeError("Expected argument 'directory_node_id' to be a float")
        pulumi.set(__self__, "directory_node_id", directory_node_id)
        if display_name_id and not isinstance(display_name_id, float):
            raise TypeError("Expected argument 'display_name_id' to be a float")
...
def get_email_security_impersonation_registry(account_id: Optional[str] = None,
                                              display_name_id: Optional[float] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getEmailSecurityImpersonationRegistry:getEmailSecurityImpersonationRegistry', __args__, opts=opts, typ=GetEmailSecurityImpersonationRegistryResult, package_ref=_utilities.get_package()).value
...
def get_email_security_impersonation_registry_output(account_id: Optional[pulumi.Input[str]] = None,
                                                     display_name_id: Optional[pulumi.Input[Optional[float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getEmailSecurityImpersonationRegistry:getEmailSecurityImpersonationRegistry', __args__, opts=opts, typ=GetEmailSecurityImpersonationRegistryResult, package_ref=_utilities.get_package())
