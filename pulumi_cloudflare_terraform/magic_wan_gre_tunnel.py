...
class MagicWanGreTunnelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] gre_tunnel_id: Identifier
        :param pulumi.Input[str] interface_address: A 31-bit prefix (/31 in CIDR notation) supporting two hosts, one for each side of the tunnel. Select the subnet from the
               following private IP space: 10.0.0.0–10.255.255.255, 172.16.0.0–172.31.255.255, 192.168.0.0–192.168.255.255.
        :param pulumi.Input[float] mtu: Maximum Transmission Unit (MTU) in bytes for the GRE tunnel. The minimum value is 576.
        :param pulumi.Input[str] name: The name of the tunnel. The name cannot contain spaces or special characters, must be 15 characters or less, and cannot
               share a name with another GRE tunnel.
        :param pulumi.Input[float] ttl: Time To Live (TTL) in number of hops of the GRE tunnel.
        """
    ...
    def gre_tunnel_id(self) -> Optional[pulumi.Input[str]]:
        """
        Identifier
        """
    ...
    def gre_tunnel_id(self, value: Optional[pulumi.Input[str]]):
    ...
    def interface_address(self) -> Optional[pulumi.Input[str]]:
        """
        A 31-bit prefix (/31 in CIDR notation) supporting two hosts, one for each side of the tunnel. Select the subnet from the
        following private IP space: 10.0.0.0–10.255.255.255, 172.16.0.0–172.31.255.255, 192.168.0.0–192.168.255.255.
        """
    ...
    def name(self) -> Optional[pulumi.Input[str]]:
        """
        The name of the tunnel. The name cannot contain spaces or special characters, must be 15 characters or less, and cannot
        share a name with another GRE tunnel.
        """
...
class _MagicWanGreTunnelState:
    def __init__(__self__, *,
                 ...
                 health_check: Optional[pulumi.Input['MagicWanGreTunnelHealthCheckArgs']] = None,
                 interface_address: Optional[pulumi.Input[str]] = None,
                 modified: Optional[pulumi.Input[bool]] = None,
    ...
    @property
    @pulumi.getter
    def modified(self) -> Optional[pulumi.Input[bool]]:
        return pulumi.get(self, "modified")

    @modified.setter
    def modified(self, value: Optional[pulumi.Input[bool]]):
...
class MagicWanGreTunnel(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a MagicWanGreTunnel resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            mtu: Optional[pulumi.Input[float]] = None,
            name: Optional[pulumi.Input[str]] = None,
            ttl: Optional[pulumi.Input[float]] = None) -> 'MagicWanGreTunnel':
        """
    ...
    @property
    @pulumi.getter(name="cloudflareGreEndpoint")
    def cloudflare_gre_endpoint(self) -> pulumi.Output[Optional[str]]:
        """
        The IP address assigned to the Cloudflare side of the GRE tunnel.
        """
        return pulumi.get(self, "cloudflare_gre_endpoint")
    ...
    @property
    @pulumi.getter(name="customerGreEndpoint")
    def customer_gre_endpoint(self) -> pulumi.Output[Optional[str]]:
        """
        The IP address assigned to the customer side of the GRE tunnel.
        """
        return pulumi.get(self, "customer_gre_endpoint")
    ...
    @property
    @pulumi.getter(name="greTunnelId")
    def gre_tunnel_id(self) -> pulumi.Output[Optional[str]]:
        """
        Identifier
        """
        return pulumi.get(self, "gre_tunnel_id")
    ...
    @property
    @pulumi.getter(name="interfaceAddress")
    def interface_address(self) -> pulumi.Output[Optional[str]]:
        """
        A 31-bit prefix (/31 in CIDR notation) supporting two hosts, one for each side of the tunnel. Select the subnet from the
        following private IP space: 10.0.0.0–10.255.255.255, 172.16.0.0–172.31.255.255, 192.168.0.0–192.168.255.255.
        """
    ...
    @property
    @pulumi.getter
    def modified(self) -> pulumi.Output[bool]:
        return pulumi.get(self, "modified")
