...
class GetMagicTransitSiteLanResult:
    ...
    def __init__(__self__, account_id=None, ha_link=None, id=None, lan_id=None, name=None, nat=None, physport=None, routed_subnets=None, site_id=None, static_addressing=None, vlan_tag=None):
        ...
        if physport and not isinstance(physport, float):
            raise TypeError("Expected argument 'physport' to be a float")
...
def get_magic_transit_site_lan(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMagicTransitSiteLan:getMagicTransitSiteLan', __args__, opts=opts, typ=GetMagicTransitSiteLanResult, package_ref=_utilities.get_package()).value
...
def get_magic_transit_site_lan_output(account_id: Optional[pulumi.Input[str]] = None,
                                      lan_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMagicTransitSiteLan:getMagicTransitSiteLan', __args__, opts=opts, typ=GetMagicTransitSiteLanResult, package_ref=_utilities.get_package())
