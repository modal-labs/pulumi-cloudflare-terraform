...
def get_zero_trust_access_mtls_certificate(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustAccessMtlsCertificate:getZeroTrustAccessMtlsCertificate', __args__, opts=opts, typ=GetZeroTrustAccessMtlsCertificateResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_access_mtls_certificate_output(account_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustAccessMtlsCertificate:getZeroTrustAccessMtlsCertificate', __args__, opts=opts, typ=GetZeroTrustAccessMtlsCertificateResult, package_ref=_utilities.get_package())
