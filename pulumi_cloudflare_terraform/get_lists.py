...
class GetListsResult:
    ...
    @property
    @pulumi.getter
    def results(self) -> Sequence['outputs.GetListsResultResult']:
...
def get_lists(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getLists:getLists', __args__, opts=opts, typ=GetListsResult, package_ref=_utilities.get_package()).value
...
def get_lists_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getLists:getLists', __args__, opts=opts, typ=GetListsResult, package_ref=_utilities.get_package())
