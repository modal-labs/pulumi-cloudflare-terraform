...
class ZeroTrustTunnelCloudflaredRouteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] network: The private IPv4 or IPv6 range connected by the route, in CIDR notation.
        :param pulumi.Input[str] tunnel_id: UUID of the tunnel.
        :param pulumi.Input[str] comment: Optional remark describing the route.
        :param pulumi.Input[str] virtual_network_id: UUID of the virtual network.
        """
...
class ZeroTrustTunnelCloudflaredRoute(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustTunnelCloudflaredRoute resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            network: Optional[pulumi.Input[str]] = None,
            tunnel_id: Optional[pulumi.Input[str]] = None,
            virtual_network_id: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustTunnelCloudflaredRoute':
        """
