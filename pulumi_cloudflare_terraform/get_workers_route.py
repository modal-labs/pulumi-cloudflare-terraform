...
def get_workers_route(route_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWorkersRoute:getWorkersRoute', __args__, opts=opts, typ=GetWorkersRouteResult, package_ref=_utilities.get_package()).value
...
def get_workers_route_output(route_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWorkersRoute:getWorkersRoute', __args__, opts=opts, typ=GetWorkersRouteResult, package_ref=_utilities.get_package())
