...
def get_page_shield_cookies_list(direction: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getPageShieldCookiesList:getPageShieldCookiesList', __args__, opts=opts, typ=GetPageShieldCookiesListResult, package_ref=_utilities.get_package()).value
...
def get_page_shield_cookies_list_output(direction: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getPageShieldCookiesList:getPageShieldCookiesList', __args__, opts=opts, typ=GetPageShieldCookiesListResult, package_ref=_utilities.get_package())
