...
class PagesProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] production_branch: Production branch of the project. Used to identify production deployments.
        """
...
class PagesProject(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PagesProject resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="productionBranch")
    def production_branch(self) -> pulumi.Output[Optional[str]]:
        """
        Production branch of the project. Used to identify production deployments.
        """
        return pulumi.get(self, "production_branch")
