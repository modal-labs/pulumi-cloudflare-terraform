...
class ZeroTrustDlpDatasetArgs:
    def __init__(__self__, *,
                 ...
                 encoding_version: Optional[pulumi.Input[float]] = None,
        ...
        :param pulumi.Input[float] encoding_version: Dataset encoding version Non-secret custom word lists with no header are always version 1. Secret EDM lists with no
               header are version 1. Multicolumn CSV with headers are version 2. Omitting this field provides the default value 0,
               which is interpreted the same as 1.
    ...
    def encoding_version(self) -> Optional[pulumi.Input[float]]:
        """
        Dataset encoding version Non-secret custom word lists with no header are always version 1. Secret EDM lists with no
        header are version 1. Multicolumn CSV with headers are version 2. Omitting this field provides the default value 0,
        which is interpreted the same as 1.
        """
    ...
    def encoding_version(self, value: Optional[pulumi.Input[float]]):
...
class _ZeroTrustDlpDatasetState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[str]] = None,
                 encoding_version: Optional[pulumi.Input[float]] = None,
                 max_cells: Optional[pulumi.Input[float]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 num_cells: Optional[pulumi.Input[float]] = None,
                 secret: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[float] version: The version to use when uploading the dataset.
        """
    ...
    def max_cells(self) -> Optional[pulumi.Input[float]]:
        return pulumi.get(self, "max_cells")

    @max_cells.setter
    def max_cells(self, value: Optional[pulumi.Input[float]]):
    ...
    def num_cells(self) -> Optional[pulumi.Input[float]]:
        return pulumi.get(self, "num_cells")

    @num_cells.setter
    def num_cells(self, value: Optional[pulumi.Input[float]]):
...
class ZeroTrustDlpDataset(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustDlpDataset resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            version: Optional[pulumi.Input[float]] = None) -> 'ZeroTrustDlpDataset':
        """
    ...
    @property
    @pulumi.getter(name="encodingVersion")
    def encoding_version(self) -> pulumi.Output[Optional[float]]:
        """
        Dataset encoding version Non-secret custom word lists with no header are always version 1. Secret EDM lists with no
        header are version 1. Multicolumn CSV with headers are version 2. Omitting this field provides the default value 0,
        which is interpreted the same as 1.
    ...
    @property
    @pulumi.getter(name="maxCells")
    def max_cells(self) -> pulumi.Output[float]:
        return pulumi.get(self, "max_cells")
    ...
    @property
    @pulumi.getter(name="numCells")
    def num_cells(self) -> pulumi.Output[float]:
        return pulumi.get(self, "num_cells")
