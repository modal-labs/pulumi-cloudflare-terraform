...
class LeakedCredentialCheckArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] enabled: Whether or not Leaked Credential Checks are enabled
        """
...
class LeakedCredentialCheck(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LeakedCredentialCheck resource with the given unique name, props, and options.
