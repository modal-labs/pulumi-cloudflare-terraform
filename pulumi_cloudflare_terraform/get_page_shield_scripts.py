...
class GetPageShieldScriptsResult:
    ...
    def __init__(__self__, added_at=None, cryptomining_score=None, dataflow_score=None, domain_reported_malicious=None, fetched_at=None, first_page_url=None, first_seen_at=None, hash=None, host=None, id=None, js_integrity_score=None, last_seen_at=None, magecart_score=None, malicious_domain_categories=None, malicious_url_categories=None, malware_score=None, obfuscation_score=None, page_urls=None, script_id=None, url=None, url_contains_cdn_cgi_path=None, url_reported_malicious=None, versions=None, zone_id=None):
        ...
        if cryptomining_score and not isinstance(cryptomining_score, float):
            raise TypeError("Expected argument 'cryptomining_score' to be a float")
        pulumi.set(__self__, "cryptomining_score", cryptomining_score)
        if dataflow_score and not isinstance(dataflow_score, float):
            raise TypeError("Expected argument 'dataflow_score' to be a float")
        ...
        if js_integrity_score and not isinstance(js_integrity_score, float):
            raise TypeError("Expected argument 'js_integrity_score' to be a float")
        ...
        if magecart_score and not isinstance(magecart_score, float):
            raise TypeError("Expected argument 'magecart_score' to be a float")
        ...
        if malware_score and not isinstance(malware_score, float):
            raise TypeError("Expected argument 'malware_score' to be a float")
        pulumi.set(__self__, "malware_score", malware_score)
        if obfuscation_score and not isinstance(obfuscation_score, float):
            raise TypeError("Expected argument 'obfuscation_score' to be a float")
    ...
    def js_integrity_score(self) -> float:
...
def get_page_shield_scripts(script_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getPageShieldScripts:getPageShieldScripts', __args__, opts=opts, typ=GetPageShieldScriptsResult, package_ref=_utilities.get_package()).value
...
def get_page_shield_scripts_output(script_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getPageShieldScripts:getPageShieldScripts', __args__, opts=opts, typ=GetPageShieldScriptsResult, package_ref=_utilities.get_package())
