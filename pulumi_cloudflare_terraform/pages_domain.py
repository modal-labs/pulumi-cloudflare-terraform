...
class PagesDomain(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a PagesDomain resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            zone_tag: Optional[pulumi.Input[str]] = None) -> 'PagesDomain':
        """
    ...
    @property
    @pulumi.getter(name="zoneTag")
    def zone_tag(self) -> pulumi.Output[str]:
        return pulumi.get(self, "zone_tag")
