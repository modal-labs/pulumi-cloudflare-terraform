...
def get_queue(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getQueue:getQueue', __args__, opts=opts, typ=GetQueueResult, package_ref=_utilities.get_package()).value
...
def get_queue_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getQueue:getQueue', __args__, opts=opts, typ=GetQueueResult, package_ref=_utilities.get_package())
