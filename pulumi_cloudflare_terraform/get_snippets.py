...
def get_snippets(zone_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getSnippets:getSnippets', __args__, opts=opts, typ=GetSnippetsResult, package_ref=_utilities.get_package()).value
...
def get_snippets_output(zone_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getSnippets:getSnippets', __args__, opts=opts, typ=GetSnippetsResult, package_ref=_utilities.get_package())
