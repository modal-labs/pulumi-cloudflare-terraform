...
def get_zero_trust_gateway_logging(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustGatewayLogging:getZeroTrustGatewayLogging', __args__, opts=opts, typ=GetZeroTrustGatewayLoggingResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_gateway_logging_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustGatewayLogging:getZeroTrustGatewayLogging', __args__, opts=opts, typ=GetZeroTrustGatewayLoggingResult, package_ref=_utilities.get_package())
