...
def get_email_routing_rules(enabled: Optional[bool] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getEmailRoutingRules:getEmailRoutingRules', __args__, opts=opts, typ=GetEmailRoutingRulesResult, package_ref=_utilities.get_package()).value
...
def get_email_routing_rules_output(enabled: Optional[pulumi.Input[Optional[bool]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getEmailRoutingRules:getEmailRoutingRules', __args__, opts=opts, typ=GetEmailRoutingRulesResult, package_ref=_utilities.get_package())
