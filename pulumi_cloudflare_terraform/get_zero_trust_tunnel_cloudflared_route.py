...
def get_zero_trust_tunnel_cloudflared_route(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustTunnelCloudflaredRoute:getZeroTrustTunnelCloudflaredRoute', __args__, opts=opts, typ=GetZeroTrustTunnelCloudflaredRouteResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_tunnel_cloudflared_route_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustTunnelCloudflaredRoute:getZeroTrustTunnelCloudflaredRoute', __args__, opts=opts, typ=GetZeroTrustTunnelCloudflaredRouteResult, package_ref=_utilities.get_package())
