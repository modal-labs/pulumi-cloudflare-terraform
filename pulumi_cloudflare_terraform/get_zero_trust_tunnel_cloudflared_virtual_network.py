...
def get_zero_trust_tunnel_cloudflared_virtual_network(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustTunnelCloudflaredVirtualNetwork:getZeroTrustTunnelCloudflaredVirtualNetwork', __args__, opts=opts, typ=GetZeroTrustTunnelCloudflaredVirtualNetworkResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_tunnel_cloudflared_virtual_network_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustTunnelCloudflaredVirtualNetwork:getZeroTrustTunnelCloudflaredVirtualNetwork', __args__, opts=opts, typ=GetZeroTrustTunnelCloudflaredVirtualNetworkResult, package_ref=_utilities.get_package())
