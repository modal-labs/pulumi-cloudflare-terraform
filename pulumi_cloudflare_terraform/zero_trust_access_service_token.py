...
class ZeroTrustAccessServiceTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] duration: The duration for how long the service token will be valid. Must be in the format `300ms` or `2h45m`. Valid time units
...
class _ZeroTrustAccessServiceTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] client_secret: The Client Secret for the service token. Access will check for this value in the `CF-Access-Client-Secret` request
               header.
        :param pulumi.Input[str] duration: The duration for how long the service token will be valid. Must be in the format `300ms` or `2h45m`. Valid time units
               are: ns, us (or µs), ms, s, m, h. The default is 1 year in hours (8760h).
        :param pulumi.Input[str] name: The name of the service token.
...
class ZeroTrustAccessServiceToken(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustAccessServiceToken resource with the given unique name, props, and options.
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: Optional[ZeroTrustAccessServiceTokenArgs] = None,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a ZeroTrustAccessServiceToken resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
