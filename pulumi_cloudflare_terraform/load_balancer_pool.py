...
class LoadBalancerPoolArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerPoolOriginArgs']]] origins: The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins,
        ...
        :param pulumi.Input[bool] enabled: Whether to enable (the default) or disable this pool. Disabled pools will not receive traffic and are excluded from
               health checks. Disabling a pool will cause any load balancers using it to failover to the next pool (if any).
        :param pulumi.Input[float] latitude: The latitude of the data center containing the origins used in this pool in decimal degrees. If this is set, longitude
               must also be set.
        ...
        :param pulumi.Input[float] longitude: The longitude of the data center containing the origins used in this pool in decimal degrees. If this is set, latitude
               must also be set.
        :param pulumi.Input[float] minimum_origins: The minimum number of origins that must be healthy for this pool to serve traffic. If the number of healthy origins
               falls below this number, the pool will be marked unhealthy and will failover to the next available pool.
        ...
        :param pulumi.Input[str] notification_email: This field is now deprecated. It has been moved to Cloudflare's Centralized Notification service
               https://developers.cloudflare.com/fundamentals/notifications/. The email address to send health status notifications to.
        ...
        :param pulumi.Input['LoadBalancerPoolOriginSteeringArgs'] origin_steering: Configures origin steering for the pool. Controls how origins are selected for new sessions and traffic without session
               affinity.
        """
    ...
    def origins(self) -> pulumi.Input[Sequence[pulumi.Input['LoadBalancerPoolOriginArgs']]]:
        """
        The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins,
        provided the pool itself is healthy.
        """
    ...
    def latitude(self) -> Optional[pulumi.Input[float]]:
        """
        The latitude of the data center containing the origins used in this pool in decimal degrees. If this is set, longitude
        must also be set.
        """
    ...
    def longitude(self) -> Optional[pulumi.Input[float]]:
        """
        The longitude of the data center containing the origins used in this pool in decimal degrees. If this is set, latitude
        must also be set.
        """
    ...
    def minimum_origins(self) -> Optional[pulumi.Input[float]]:
        """
    ...
    def minimum_origins(self, value: Optional[pulumi.Input[float]]):
    ...
    def notification_email(self) -> Optional[pulumi.Input[str]]:
        """
        This field is now deprecated. It has been moved to Cloudflare's Centralized Notification service
        https://developers.cloudflare.com/fundamentals/notifications/. The email address to send health status notifications to.
        This can be an individual mailbox or a mailing list. Multiple emails can be supplied as a comma delimited list.
        """
    ...
    def origin_steering(self) -> Optional[pulumi.Input['LoadBalancerPoolOriginSteeringArgs']]:
        """
        Configures origin steering for the pool. Controls how origins are selected for new sessions and traffic without session
        affinity.
        """
...
class LoadBalancerPool(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a LoadBalancerPool resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[Union['LoadBalancerPoolOriginSteeringArgs', 'LoadBalancerPoolOriginSteeringArgsDict']] origin_steering: Configures origin steering for the pool. Controls how origins are selected for new sessions and traffic without session
               affinity.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LoadBalancerPoolOriginArgs', 'LoadBalancerPoolOriginArgsDict']]]] origins: The list of origins within this pool. Traffic directed at this pool is balanced across all currently healthy origins,
               provided the pool itself is healthy.
        """
        ...
    @overload
    ...
    @property
    @pulumi.getter(name="minimumOrigins")
    def minimum_origins(self) -> pulumi.Output[float]:
        """
        The minimum number of origins that must be healthy for this pool to serve traffic. If the number of healthy origins
        falls below this number, the pool will be marked unhealthy and will failover to the next available pool.
        """
