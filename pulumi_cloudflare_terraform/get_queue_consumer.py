...
def get_queue_consumer(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getQueueConsumer:getQueueConsumer', __args__, opts=opts, typ=GetQueueConsumerResult, package_ref=_utilities.get_package()).value
...
def get_queue_consumer_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getQueueConsumer:getQueueConsumer', __args__, opts=opts, typ=GetQueueConsumerResult, package_ref=_utilities.get_package())
