...
class ApiShieldOperationSchemaValidationSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] mitigation_action: When set, this applies a mitigation action to this operation - `log` log request when request does not conform to schema
...
class ApiShieldOperationSchemaValidationSettings(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ApiShieldOperationSchemaValidationSettings resource with the given unique name, props, and options.
