...
class ZeroTrustDnsLocationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] dns_destination_ips_id: The identifier of the pair of IPv4 addresses assigned to this location. When creating a location, if this field is
               absent or set with null, the pair of shared IPv4 addresses (0e4a32c6-6fb8-4858-9296-98f51631e8e6) is auto-assigned. When
               updating a location, if the field is absent or set with null, the pre-assigned pair remains unchanged.
        :param pulumi.Input[bool] ecs_support: True if the location needs to resolve EDNS queries.
        :param pulumi.Input['ZeroTrustDnsLocationEndpointsArgs'] endpoints: The destination endpoints configured for this location. When updating a location, if this field is absent or set with
               null, the endpoints configuration remains unchanged.
        :param pulumi.Input[str] name: The name of the location.
        :param pulumi.Input[Sequence[pulumi.Input['ZeroTrustDnsLocationNetworkArgs']]] networks: A list of network ranges that requests from this location would originate from. A non-empty list is only effective if
    ...
    def dns_destination_ips_id(self) -> Optional[pulumi.Input[str]]:
        """
        The identifier of the pair of IPv4 addresses assigned to this location. When creating a location, if this field is
        absent or set with null, the pair of shared IPv4 addresses (0e4a32c6-6fb8-4858-9296-98f51631e8e6) is auto-assigned. When
        updating a location, if the field is absent or set with null, the pre-assigned pair remains unchanged.
        """
    ...
    def endpoints(self) -> Optional[pulumi.Input['ZeroTrustDnsLocationEndpointsArgs']]:
        """
        The destination endpoints configured for this location. When updating a location, if this field is absent or set with
        null, the endpoints configuration remains unchanged.
        """
    ...
    def networks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['ZeroTrustDnsLocationNetworkArgs']]]]:
        """
        A list of network ranges that requests from this location would originate from. A non-empty list is only effective if
        the ipv4 endpoint is enabled for this location.
        """
...
class _ZeroTrustDnsLocationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] dns_destination_ips_id: The identifier of the pair of IPv4 addresses assigned to this location. When creating a location, if this field is
               absent or set with null, the pair of shared IPv4 addresses (0e4a32c6-6fb8-4858-9296-98f51631e8e6) is auto-assigned. When
               updating a location, if the field is absent or set with null, the pre-assigned pair remains unchanged.
        :param pulumi.Input[str] dns_destination_ipv6_block_id: The uuid identifier of the IPv6 block brought to the gateway, so that this location's IPv6 address is allocated from the
               Bring Your Own Ipv6(BYOIPv6) block and not from the standard CloudFlare IPv6 block.
        ...
        :param pulumi.Input['ZeroTrustDnsLocationEndpointsArgs'] endpoints: The destination endpoints configured for this location. When updating a location, if this field is absent or set with
               null, the endpoints configuration remains unchanged.
        :param pulumi.Input[str] ip: IPV6 destination ip assigned to this location. DNS requests sent to this IP will counted as the request under this
               location. This field is auto-generated by Gateway.
        :param pulumi.Input[str] ipv4_destination: The primary destination IPv4 address from the pair identified by the dns_destination_ips_id. This field is read-only.
        :param pulumi.Input[str] ipv4_destination_backup: The backup destination IPv4 address from the pair identified by the dns_destination_ips_id. This field is read-only.
        :param pulumi.Input[str] name: The name of the location.
        :param pulumi.Input[Sequence[pulumi.Input['ZeroTrustDnsLocationNetworkArgs']]] networks: A list of network ranges that requests from this location would originate from. A non-empty list is only effective if
               the ipv4 endpoint is enabled for this location.
        """
    ...
    def dns_destination_ipv6_block_id(self) -> Optional[pulumi.Input[str]]:
        """
        The uuid identifier of the IPv6 block brought to the gateway, so that this location's IPv6 address is allocated from the
        Bring Your Own Ipv6(BYOIPv6) block and not from the standard CloudFlare IPv6 block.
        """
    ...
    def ip(self) -> Optional[pulumi.Input[str]]:
        """
        IPV6 destination ip assigned to this location. DNS requests sent to this IP will counted as the request under this
        location. This field is auto-generated by Gateway.
        """
...
class ZeroTrustDnsLocation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustDnsLocation resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] dns_destination_ips_id: The identifier of the pair of IPv4 addresses assigned to this location. When creating a location, if this field is
               ...
               updating a location, if the field is absent or set with null, the pre-assigned pair remains unchanged.
        :param pulumi.Input[bool] ecs_support: True if the location needs to resolve EDNS queries.
        :param pulumi.Input[Union['ZeroTrustDnsLocationEndpointsArgs', 'ZeroTrustDnsLocationEndpointsArgsDict']] endpoints: The destination endpoints configured for this location. When updating a location, if this field is absent or set with
               null, the endpoints configuration remains unchanged.
        :param pulumi.Input[str] name: The name of the location.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ZeroTrustDnsLocationNetworkArgs', 'ZeroTrustDnsLocationNetworkArgsDict']]]] networks: A list of network ranges that requests from this location would originate from. A non-empty list is only effective if
               the ipv4 endpoint is enabled for this location.
        """
        ...
    @overload
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[str]] = None,
            networks: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ZeroTrustDnsLocationNetworkArgs', 'ZeroTrustDnsLocationNetworkArgsDict']]]]] = None,
            updated_at: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustDnsLocation':
        """
