...
class GetKeylessCertificateResult:
    ...
    def keyless_certificate_id(self) -> Optional[str]:
...
def get_keyless_certificate(keyless_certificate_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getKeylessCertificate:getKeylessCertificate', __args__, opts=opts, typ=GetKeylessCertificateResult, package_ref=_utilities.get_package()).value
...
def get_keyless_certificate_output(keyless_certificate_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getKeylessCertificate:getKeylessCertificate', __args__, opts=opts, typ=GetKeylessCertificateResult, package_ref=_utilities.get_package())
