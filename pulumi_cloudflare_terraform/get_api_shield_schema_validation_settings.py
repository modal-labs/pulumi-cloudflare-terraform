...
__all__ = [
    ...
    'AwaitableGetApiShieldSchemaValidationSettingsResult',
    'get_api_shield_schema_validation_settings',
    'get_api_shield_schema_validation_settings_output',
]
...
class GetApiShieldSchemaValidationSettingsResult:
    ...
    def __init__(__self__, id=None, validation_default_mitigation_action=None, validation_override_mitigation_action=None, zone_id=None):
        ...
        if validation_override_mitigation_action and not isinstance(validation_override_mitigation_action, str):
            raise TypeError("Expected argument 'validation_override_mitigation_action' to be a str")
...
class AwaitableGetApiShieldSchemaValidationSettingsResult(GetApiShieldSchemaValidationSettingsResult):
...
def get_api_shield_schema_validation_settings(zone_id: Optional[str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApiShieldSchemaValidationSettingsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getApiShieldSchemaValidationSettings:getApiShieldSchemaValidationSettings', __args__, opts=opts, typ=GetApiShieldSchemaValidationSettingsResult, package_ref=_utilities.get_package()).value

    return AwaitableGetApiShieldSchemaValidationSettingsResult(
...
def get_api_shield_schema_validation_settings_output(zone_id: Optional[pulumi.Input[str]] = None,
                                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApiShieldSchemaValidationSettingsResult]:
    """
    Use this data source to access information about an existing resource.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getApiShieldSchemaValidationSettings:getApiShieldSchemaValidationSettings', __args__, opts=opts, typ=GetApiShieldSchemaValidationSettingsResult, package_ref=_utilities.get_package())
    return __ret__.apply(lambda __response__: GetApiShieldSchemaValidationSettingsResult(
