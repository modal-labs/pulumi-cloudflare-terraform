...
class ApiShieldSchemaArgs:
    def __init__(__self__, *,
                 ...
                 validation_enabled: Optional[pulumi.Input[str]] = None):
        """
    ...
    def validation_enabled(self, value: Optional[pulumi.Input[str]]):
...
class ApiShieldSchema(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ApiShieldSchema resource with the given unique name, props, and options.
