...
def get_zero_trust_access_infrastructure_targets(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustAccessInfrastructureTargets:getZeroTrustAccessInfrastructureTargets', __args__, opts=opts, typ=GetZeroTrustAccessInfrastructureTargetsResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_access_infrastructure_targets_output(account_id: Optional[pulumi.Input[str]] = None,
                                                        ...
                                                        ipv4_end: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustAccessInfrastructureTargets:getZeroTrustAccessInfrastructureTargets', __args__, opts=opts, typ=GetZeroTrustAccessInfrastructureTargetsResult, package_ref=_utilities.get_package())
