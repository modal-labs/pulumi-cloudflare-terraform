...
def get_workers_kv_namespaces(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWorkersKvNamespaces:getWorkersKvNamespaces', __args__, opts=opts, typ=GetWorkersKvNamespacesResult, package_ref=_utilities.get_package()).value
...
def get_workers_kv_namespaces_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWorkersKvNamespaces:getWorkersKvNamespaces', __args__, opts=opts, typ=GetWorkersKvNamespacesResult, package_ref=_utilities.get_package())
