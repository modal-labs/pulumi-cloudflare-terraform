...
class _ZeroTrustDlpEntryState:
    ...
    def word_list(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "word_list")

    @word_list.setter
    def word_list(self, value: Optional[pulumi.Input[str]]):
...
class ZeroTrustDlpEntry(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustDlpEntry resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[str]] = None,
            updated_at: Optional[pulumi.Input[str]] = None,
            word_list: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustDlpEntry':
        """
    ...
    @property
    @pulumi.getter
    def secret(self) -> pulumi.Output[bool]:
        return pulumi.get(self, "secret")
    ...
    @property
    @pulumi.getter(name="wordList")
    def word_list(self) -> pulumi.Output[str]:
        return pulumi.get(self, "word_list")
