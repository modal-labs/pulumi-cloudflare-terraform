...
def get_zero_trust_access_application(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustAccessApplication:getZeroTrustAccessApplication', __args__, opts=opts, typ=GetZeroTrustAccessApplicationResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_access_application_output(account_id: Optional[pulumi.Input[Optional[str]]] = None,
                                             app_id: Optional[pulumi.Input[Optional[str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustAccessApplication:getZeroTrustAccessApplication', __args__, opts=opts, typ=GetZeroTrustAccessApplicationResult, package_ref=_utilities.get_package())
