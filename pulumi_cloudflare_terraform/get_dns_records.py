...
def get_dns_records(comment: Optional[Union['GetDnsRecordsCommentArgs', 'GetDnsRecordsCommentArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getDnsRecords:getDnsRecords', __args__, opts=opts, typ=GetDnsRecordsResult, package_ref=_utilities.get_package()).value
...
def get_dns_records_output(comment: Optional[pulumi.Input[Optional[Union['GetDnsRecordsCommentArgs', 'GetDnsRecordsCommentArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getDnsRecords:getDnsRecords', __args__, opts=opts, typ=GetDnsRecordsResult, package_ref=_utilities.get_package())
