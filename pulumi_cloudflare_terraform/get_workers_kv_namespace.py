...
def get_workers_kv_namespace(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWorkersKvNamespace:getWorkersKvNamespace', __args__, opts=opts, typ=GetWorkersKvNamespaceResult, package_ref=_utilities.get_package()).value
...
def get_workers_kv_namespace_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWorkersKvNamespace:getWorkersKvNamespace', __args__, opts=opts, typ=GetWorkersKvNamespaceResult, package_ref=_utilities.get_package())
