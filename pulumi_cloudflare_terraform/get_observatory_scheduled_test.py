...
def get_observatory_scheduled_test(zone_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getObservatoryScheduledTest:getObservatoryScheduledTest', __args__, opts=opts, typ=GetObservatoryScheduledTestResult, package_ref=_utilities.get_package()).value
...
def get_observatory_scheduled_test_output(zone_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getObservatoryScheduledTest:getObservatoryScheduledTest', __args__, opts=opts, typ=GetObservatoryScheduledTestResult, package_ref=_utilities.get_package())
