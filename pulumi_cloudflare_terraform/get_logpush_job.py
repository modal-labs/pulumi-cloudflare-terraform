...
class GetLogpushJobResult:
    ...
    def job_id(self) -> Optional[float]:
...
def get_logpush_job(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getLogpushJob:getLogpushJob', __args__, opts=opts, typ=GetLogpushJobResult, package_ref=_utilities.get_package()).value
...
def get_logpush_job_output(account_id: Optional[pulumi.Input[Optional[str]]] = None,
                           job_id: Optional[pulumi.Input[Optional[float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getLogpushJob:getLogpushJob', __args__, opts=opts, typ=GetLogpushJobResult, package_ref=_utilities.get_package())
