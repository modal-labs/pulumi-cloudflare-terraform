...
def get_workers_scripts(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getWorkersScripts:getWorkersScripts', __args__, opts=opts, typ=GetWorkersScriptsResult, package_ref=_utilities.get_package()).value
...
def get_workers_scripts_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getWorkersScripts:getWorkersScripts', __args__, opts=opts, typ=GetWorkersScriptsResult, package_ref=_utilities.get_package())
