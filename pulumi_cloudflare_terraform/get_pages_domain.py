...
def get_pages_domain(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getPagesDomain:getPagesDomain', __args__, opts=opts, typ=GetPagesDomainResult, package_ref=_utilities.get_package()).value
...
def get_pages_domain_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getPagesDomain:getPagesDomain', __args__, opts=opts, typ=GetPagesDomainResult, package_ref=_utilities.get_package())
