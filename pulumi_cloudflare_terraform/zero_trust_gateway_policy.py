...
class ZeroTrustGatewayPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] action: The action to preform when the associated traffic, identity, and device posture expressions are either absent or
               evaluate to `true`.
        ...
        :param pulumi.Input['ZeroTrustGatewayPolicyExpirationArgs'] expiration: The expiration time stamp and default duration of a DNS policy. Takes precedence over the policy's `schedule`
        ...
        :param pulumi.Input[float] precedence: Precedence sets the order of your rules. Lower values indicate higher precedence. At each processing phase, applicable
...
class _ZeroTrustGatewayPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['ZeroTrustGatewayPolicyScheduleArgs'] schedule: The schedule for activating DNS policies. This does not apply to HTTP or network policies.
        :param pulumi.Input[str] traffic: The wirefilter expression used for traffic matching.
        :param pulumi.Input[float] version: version number of the rule
        """
...
class ZeroTrustGatewayPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustGatewayPolicy resource with the given unique name, props, and options.
        ...
        :param pulumi.Input[str] device_posture: The wirefilter expression used for device posture check matching.
        :param pulumi.Input[bool] enabled: True if the rule is enabled.
        :param pulumi.Input[Union['ZeroTrustGatewayPolicyExpirationArgs', 'ZeroTrustGatewayPolicyExpirationArgsDict']] expiration: The expiration time stamp and default duration of a DNS policy. Takes precedence over the policy's `schedule`
               configuration, if any. This does not apply to HTTP or network policies.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] filters: The protocol or layer to evaluate the traffic, identity, and device posture expressions.
        :param pulumi.Input[str] identity: The wirefilter expression used for identity matching.
        :param pulumi.Input[str] name: The name of the rule.
    ...
    def get(resource_name: str,
            ...
            traffic: Optional[pulumi.Input[str]] = None,
            updated_at: Optional[pulumi.Input[str]] = None,
            version: Optional[pulumi.Input[float]] = None) -> 'ZeroTrustGatewayPolicy':
        """
