...
def get_api_token(filter: Optional[Union['GetApiTokenFilterArgs', 'GetApiTokenFilterArgsDict']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getApiToken:getApiToken', __args__, opts=opts, typ=GetApiTokenResult, package_ref=_utilities.get_package()).value
...
def get_api_token_output(filter: Optional[pulumi.Input[Optional[Union['GetApiTokenFilterArgs', 'GetApiTokenFilterArgsDict']]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getApiToken:getApiToken', __args__, opts=opts, typ=GetApiTokenResult, package_ref=_utilities.get_package())
