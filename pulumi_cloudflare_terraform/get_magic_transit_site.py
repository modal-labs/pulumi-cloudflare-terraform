...
def get_magic_transit_site(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getMagicTransitSite:getMagicTransitSite', __args__, opts=opts, typ=GetMagicTransitSiteResult, package_ref=_utilities.get_package()).value
...
def get_magic_transit_site_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getMagicTransitSite:getMagicTransitSite', __args__, opts=opts, typ=GetMagicTransitSiteResult, package_ref=_utilities.get_package())
