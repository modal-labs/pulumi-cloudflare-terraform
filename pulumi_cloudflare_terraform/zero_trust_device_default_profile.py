...
class _ZeroTrustDeviceDefaultProfileState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[float] auto_connect: The amount of time in seconds to reconnect after having been disabled.
        :param pulumi.Input[float] captive_portal: Turn on the captive portal after the specified amount of time.
        :param pulumi.Input[bool] default: Whether the policy will be applied to matching devices.
        :param pulumi.Input[bool] disable_auto_fallback: If the `dns_server` field of a fallback domain is not present, the client will fall back to a best guess of the
               default/system DNS resolvers unless this policy option is set to `true`.
...
class ZeroTrustDeviceDefaultProfile(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ZeroTrustDeviceDefaultProfile resource with the given unique name, props, and options.
    ...
    def get(resource_name: str,
            ...
            support_url: Optional[pulumi.Input[str]] = None,
            switch_locked: Optional[pulumi.Input[bool]] = None,
            tunnel_protocol: Optional[pulumi.Input[str]] = None) -> 'ZeroTrustDeviceDefaultProfile':
        """
