...
class StreamArgs:
    def __init__(__self__, *,
                 ...
                 max_duration_seconds: Optional[pulumi.Input[float]] = None,
                 meta: Optional[pulumi.Input[str]] = None,
                 require_signed_urls: Optional[pulumi.Input[bool]] = None,
                 scheduled_deletion: Optional[pulumi.Input[str]] = None,
                 thumbnail_timestamp_pct: Optional[pulumi.Input[float]] = None,
                 upload_expiry: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a Stream resource.
        :param pulumi.Input[str] account_id: The account identifier tag.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] allowed_origins: Lists the origins allowed to display the video. Enter allowed origin domains in an array and use `*` for wildcard
               subdomains. Empty arrays allow the video to be viewed on any origin.
        :param pulumi.Input[str] creator: A user-defined identifier for the media creator.
        :param pulumi.Input[str] identifier: A Cloudflare-generated unique identifier for a media item.
        :param pulumi.Input[float] max_duration_seconds: The maximum duration in seconds for a video upload. Can be set for a video that is not yet uploaded to limit its
               duration. Uploads that exceed the specified duration will fail during processing. A value of `-1` means the value is
               unknown.
        :param pulumi.Input[str] meta: A user modifiable key-value store used to reference other systems of record for managing videos.
        :param pulumi.Input[bool] require_signed_urls: Indicates whether the video can be a accessed using the UID. When set to `true`, a signed token must be generated with a
               signing key to view the video.
        :param pulumi.Input[str] scheduled_deletion: Indicates the date and time at which the video will be deleted. Omit the field to indicate no change, or include with a
               `null` value to remove an existing scheduled deletion. If specified, must be at least 30 days from upload time.
        :param pulumi.Input[float] thumbnail_timestamp_pct: The timestamp for a thumbnail image calculated as a percentage value of the video's duration. To convert from a
               second-wise timestamp to a percentage, divide the desired timestamp by the total duration of the video. If this value is
               not set, the default thumbnail image is taken from 0s of the video.
        :param pulumi.Input[str] upload_expiry: The date and time when the video upload URL is no longer valid for direct user uploads.
        """
    ...
    def allowed_origins(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[str]]]]:
        """
        Lists the origins allowed to display the video. Enter allowed origin domains in an array and use `*` for wildcard
        subdomains. Empty arrays allow the video to be viewed on any origin.
        """
    ...
    def max_duration_seconds(self) -> Optional[pulumi.Input[float]]:
        """
        The maximum duration in seconds for a video upload. Can be set for a video that is not yet uploaded to limit its
        duration. Uploads that exceed the specified duration will fail during processing. A value of `-1` means the value is
        unknown.
        """
    ...
    def max_duration_seconds(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "max_duration_seconds", value)

    @property
    @pulumi.getter
    def meta(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @meta.setter
    def meta(self, value: Optional[pulumi.Input[str]]):
    ...
    def require_signed_urls(self) -> Optional[pulumi.Input[bool]]:
        """
        Indicates whether the video can be a accessed using the UID. When set to `true`, a signed token must be generated with a
        signing key to view the video.
        """
    ...
    def scheduled_deletion(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def scheduled_deletion(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "scheduled_deletion", value)

    @property
    @pulumi.getter(name="thumbnailTimestampPct")
    def thumbnail_timestamp_pct(self) -> Optional[pulumi.Input[float]]:
        """
        The timestamp for a thumbnail image calculated as a percentage value of the video's duration. To convert from a
        second-wise timestamp to a percentage, divide the desired timestamp by the total duration of the video. If this value is
        not set, the default thumbnail image is taken from 0s of the video.
        """
    ...
    def thumbnail_timestamp_pct(self, value: Optional[pulumi.Input[float]]):
        pulumi.set(self, "thumbnail_timestamp_pct", value)

    @property
    @pulumi.getter(name="uploadExpiry")
    def upload_expiry(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def upload_expiry(self, value: Optional[pulumi.Input[str]]):
...
class _StreamState:
    def __init__(__self__, *,
                 ...
                 live_input: Optional[pulumi.Input[str]] = None,
                 max_duration_seconds: Optional[pulumi.Input[float]] = None,
                 meta: Optional[pulumi.Input[str]] = None,
                 ...
                 ready_to_stream: Optional[pulumi.Input[bool]] = None,
                 ready_to_stream_at: Optional[pulumi.Input[str]] = None,
                 require_signed_urls: Optional[pulumi.Input[bool]] = None,
                 scheduled_deletion: Optional[pulumi.Input[str]] = None,
                 ...
                 upload_expiry: Optional[pulumi.Input[str]] = None,
                 uploaded: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] allowed_origins: Lists the origins allowed to display the video. Enter allowed origin domains in an array and use `*` for wildcard
               subdomains. Empty arrays allow the video to be viewed on any origin.
        :param pulumi.Input[str] created: The date and time the media item was created.
        :param pulumi.Input[str] creator: A user-defined identifier for the media creator.
        :param pulumi.Input[float] duration: The duration of the video in seconds. A value of `-1` means the duration is unknown. The duration becomes available
               after the upload and before the video is ready.
        :param pulumi.Input[str] identifier: A Cloudflare-generated unique identifier for a media item.
        :param pulumi.Input[str] live_input: The live input ID used to upload a video with Stream Live.
        :param pulumi.Input[float] max_duration_seconds: The maximum duration in seconds for a video upload. Can be set for a video that is not yet uploaded to limit its
               duration. Uploads that exceed the specified duration will fail during processing. A value of `-1` means the value is
               unknown.
        :param pulumi.Input[str] meta: A user modifiable key-value store used to reference other systems of record for managing videos.
        :param pulumi.Input[str] modified: The date and time the media item was last modified.
        :param pulumi.Input[str] preview: The video's preview page URI. This field is omitted until encoding is complete.
        :param pulumi.Input[bool] ready_to_stream: Indicates whether the video is playable. The field is empty if the video is not ready for viewing or the live stream is
               still in progress.
        :param pulumi.Input[str] ready_to_stream_at: Indicates the time at which the video became playable. The field is empty if the video is not ready for viewing or the
               live stream is still in progress.
        :param pulumi.Input[bool] require_signed_urls: Indicates whether the video can be a accessed using the UID. When set to `true`, a signed token must be generated with a
               signing key to view the video.
        :param pulumi.Input[str] scheduled_deletion: Indicates the date and time at which the video will be deleted. Omit the field to indicate no change, or include with a
               `null` value to remove an existing scheduled deletion. If specified, must be at least 30 days from upload time.
        :param pulumi.Input[float] size: The size of the media item in bytes.
        :param pulumi.Input['StreamStatusArgs'] status: Specifies a detailed status for a video. If the `state` is `inprogress` or `error`, the `step` field returns `encoding`
               or `manifest`. If the `state` is `inprogress`, `pctComplete` returns a number between 0 and 100 to indicate the
               approximate percent of completion. If the `state` is `error`, `errorReasonCode` and `errorReasonText` provide additional
               details.
        :param pulumi.Input[str] thumbnail: The media item's thumbnail URI. This field is omitted until encoding is complete.
        :param pulumi.Input[float] thumbnail_timestamp_pct: The timestamp for a thumbnail image calculated as a percentage value of the video's duration. To convert from a
               second-wise timestamp to a percentage, divide the desired timestamp by the total duration of the video. If this value is
               not set, the default thumbnail image is taken from 0s of the video.
        :param pulumi.Input[str] uid: A Cloudflare-generated unique identifier for a media item.
        :param pulumi.Input[str] upload_expiry: The date and time when the video upload URL is no longer valid for direct user uploads.
        :param pulumi.Input[str] uploaded: The date and time the media item was uploaded.
        """
    ...
    def duration(self) -> Optional[pulumi.Input[float]]:
        """
        The duration of the video in seconds. A value of `-1` means the duration is unknown. The duration becomes available
        after the upload and before the video is ready.
        """
    ...
    def live_input(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @live_input.setter
    def live_input(self, value: Optional[pulumi.Input[str]]):
    ...
    def ready_to_stream(self) -> Optional[pulumi.Input[bool]]:
        """
        Indicates whether the video is playable. The field is empty if the video is not ready for viewing or the live stream is
        still in progress.
        """
        return pulumi.get(self, "ready_to_stream")

    @ready_to_stream.setter
    def ready_to_stream(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "ready_to_stream", value)

    @property
    @pulumi.getter(name="readyToStreamAt")
    def ready_to_stream_at(self) -> Optional[pulumi.Input[str]]:
        """
        Indicates the time at which the video became playable. The field is empty if the video is not ready for viewing or the
        live stream is still in progress.
        """
        return pulumi.get(self, "ready_to_stream_at")

    @ready_to_stream_at.setter
    def ready_to_stream_at(self, value: Optional[pulumi.Input[str]]):
    ...
    def status(self) -> Optional[pulumi.Input['StreamStatusArgs']]:
        """
        Specifies a detailed status for a video. If the `state` is `inprogress` or `error`, the `step` field returns `encoding`
        or `manifest`. If the `state` is `inprogress`, `pctComplete` returns a number between 0 and 100 to indicate the
        approximate percent of completion. If the `state` is `error`, `errorReasonCode` and `errorReasonText` provide additional
        details.
        """
    ...
    @property
    @pulumi.getter
    def uploaded(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @uploaded.setter
    def uploaded(self, value: Optional[pulumi.Input[str]]):
...
class Stream(pulumi.CustomResource):
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[str] scheduled_deletion: Indicates the date and time at which the video will be deleted. Omit the field to indicate no change, or include with a
               `null` value to remove an existing scheduled deletion. If specified, must be at least 30 days from upload time.
        :param pulumi.Input[float] size: The size of the media item in bytes.
        :param pulumi.Input[Union['StreamStatusArgs', 'StreamStatusArgsDict']] status: Specifies a detailed status for a video. If the `state` is `inprogress` or `error`, the `step` field returns `encoding`
               or `manifest`. If the `state` is `inprogress`, `pctComplete` returns a number between 0 and 100 to indicate the
               approximate percent of completion. If the `state` is `error`, `errorReasonCode` and `errorReasonText` provide additional
               details.
        :param pulumi.Input[str] thumbnail: The media item's thumbnail URI. This field is omitted until encoding is complete.
    ...
    @property
    @pulumi.getter
    def creator(self) -> pulumi.Output[Optional[str]]:
        """
        A user-defined identifier for the media creator.
        """
        return pulumi.get(self, "creator")
    ...
    @property
    @pulumi.getter(name="liveInput")
    def live_input(self) -> pulumi.Output[str]:
        """
        The live input ID used to upload a video with Stream Live.
        """
        return pulumi.get(self, "live_input")
    ...
    @property
    @pulumi.getter(name="maxDurationSeconds")
    def max_duration_seconds(self) -> pulumi.Output[Optional[float]]:
        """
        The maximum duration in seconds for a video upload. Can be set for a video that is not yet uploaded to limit its
        duration. Uploads that exceed the specified duration will fail during processing. A value of `-1` means the value is
        unknown.
    ...
    @property
    @pulumi.getter
    def meta(self) -> pulumi.Output[Optional[str]]:
        """
        A user modifiable key-value store used to reference other systems of record for managing videos.
        """
        return pulumi.get(self, "meta")
    ...
    @property
    @pulumi.getter(name="readyToStream")
    def ready_to_stream(self) -> pulumi.Output[bool]:
        """
        Indicates whether the video is playable. The field is empty if the video is not ready for viewing or the live stream is
        still in progress.
        """
    ...
    @property
    @pulumi.getter(name="readyToStreamAt")
    def ready_to_stream_at(self) -> pulumi.Output[str]:
        """
        Indicates the time at which the video became playable. The field is empty if the video is not ready for viewing or the
        live stream is still in progress.
        """
    ...
    @property
    @pulumi.getter(name="requireSignedUrls")
    def require_signed_urls(self) -> pulumi.Output[bool]:
        """
        Indicates whether the video can be a accessed using the UID. When set to `true`, a signed token must be generated with a
        signing key to view the video.
        """
    ...
    @property
    @pulumi.getter(name="scheduledDeletion")
    def scheduled_deletion(self) -> pulumi.Output[Optional[str]]:
        """
        Indicates the date and time at which the video will be deleted. Omit the field to indicate no change, or include with a
        `null` value to remove an existing scheduled deletion. If specified, must be at least 30 days from upload time.
        """
    ...
    @property
    @pulumi.getter(name="thumbnailTimestampPct")
    def thumbnail_timestamp_pct(self) -> pulumi.Output[float]:
        """
        The timestamp for a thumbnail image calculated as a percentage value of the video's duration. To convert from a
        second-wise timestamp to a percentage, divide the desired timestamp by the total duration of the video. If this value is
        not set, the default thumbnail image is taken from 0s of the video.
    ...
    @property
    @pulumi.getter(name="uploadExpiry")
    def upload_expiry(self) -> pulumi.Output[Optional[str]]:
        """
        The date and time when the video upload URL is no longer valid for direct user uploads.
        """
        return pulumi.get(self, "upload_expiry")
    ...
    @property
    @pulumi.getter
    def uploaded(self) -> pulumi.Output[str]:
        """
        The date and time the media item was uploaded.
        """
        return pulumi.get(self, "uploaded")
