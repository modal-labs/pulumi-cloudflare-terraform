...
class ZoneDnssecArgs:
    def __init__(__self__, *,
                 ...
                 dnssec_multi_signer: Optional[pulumi.Input[bool]] = None,
                 dnssec_presigned: Optional[pulumi.Input[bool]] = None,
                 status: Optional[pulumi.Input[str]] = None):
        """
        The set of arguments for constructing a ZoneDnssec resource.
        :param pulumi.Input[str] zone_id: Identifier
        :param pulumi.Input[bool] dnssec_multi_signer: If true, multi-signer DNSSEC is enabled on the zone, allowing multiple providers to serve a DNSSEC-signed zone at the
               same time. This is required for DNSKEY records (except those automatically generated by Cloudflare) to be added to the
               zone. See [Multi-signer DNSSEC](https://developers.cloudflare.com/dns/dnssec/multi-signer-dnssec/) for details.
        :param pulumi.Input[bool] dnssec_presigned: If true, allows Cloudflare to transfer in a DNSSEC-signed zone including signatures from an external provider, without
    ...
    def dnssec_multi_signer(self) -> Optional[pulumi.Input[bool]]:
        """
        If true, multi-signer DNSSEC is enabled on the zone, allowing multiple providers to serve a DNSSEC-signed zone at the
        same time. This is required for DNSKEY records (except those automatically generated by Cloudflare) to be added to the
        zone. See [Multi-signer DNSSEC](https://developers.cloudflare.com/dns/dnssec/multi-signer-dnssec/) for details.
        """
    ...
    def dnssec_multi_signer(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "dnssec_multi_signer", value)

    @property
    @pulumi.getter(name="dnssecPresigned")
    def dnssec_presigned(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def dnssec_presigned(self, value: Optional[pulumi.Input[bool]]):
...
class _ZoneDnssecState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] algorithm: Algorithm key code.
        :param pulumi.Input[str] digest: Digest hash.
        :param pulumi.Input[str] digest_algorithm: Type of digest algorithm.
        :param pulumi.Input[str] digest_type: Coded type for digest algorithm.
        :param pulumi.Input[bool] dnssec_multi_signer: If true, multi-signer DNSSEC is enabled on the zone, allowing multiple providers to serve a DNSSEC-signed zone at the
               same time. This is required for DNSKEY records (except those automatically generated by Cloudflare) to be added to the
               zone. See [Multi-signer DNSSEC](https://developers.cloudflare.com/dns/dnssec/multi-signer-dnssec/) for details.
        :param pulumi.Input[bool] dnssec_presigned: If true, allows Cloudflare to transfer in a DNSSEC-signed zone including signatures from an external provider, without
               ...
               Secondary](https://developers.cloudflare.com/dns/zone-setups/zone-transfers/cloudflare-as-secondary/setup/#dnssec) for
               details.
        :param pulumi.Input[str] ds: Full DS record.
        :param pulumi.Input[float] flags: Flag for DNSSEC record.
        :param pulumi.Input[float] key_tag: Code for key tag.
...
class ZoneDnssec(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dnssecMultiSigner")
    def dnssec_multi_signer(self) -> pulumi.Output[Optional[bool]]:
        """
        If true, multi-signer DNSSEC is enabled on the zone, allowing multiple providers to serve a DNSSEC-signed zone at the
        same time. This is required for DNSKEY records (except those automatically generated by Cloudflare) to be added to the
        zone. See [Multi-signer DNSSEC](https://developers.cloudflare.com/dns/dnssec/multi-signer-dnssec/) for details.
    ...
    @property
    @pulumi.getter(name="dnssecPresigned")
    def dnssec_presigned(self) -> pulumi.Output[Optional[bool]]:
        """
        If true, allows Cloudflare to transfer in a DNSSEC-signed zone including signatures from an external provider, without
        requiring Cloudflare to sign any records on the fly. Note that this feature has some limitations. See [Cloudflare as
        Secondary](https://developers.cloudflare.com/dns/zone-setups/zone-transfers/cloudflare-as-secondary/setup/#dnssec) for
    ...
    @property
    @pulumi.getter
    def flags(self) -> pulumi.Output[float]:
        """
        Flag for DNSSEC record.
        """
        return pulumi.get(self, "flags")
    ...
    @property
    @pulumi.getter(name="keyTag")
    def key_tag(self) -> pulumi.Output[float]:
        """
        Code for key tag.
        """
        return pulumi.get(self, "key_tag")
