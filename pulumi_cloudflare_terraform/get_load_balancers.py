...
def get_load_balancers(max_items: Optional[float] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getLoadBalancers:getLoadBalancers', __args__, opts=opts, typ=GetLoadBalancersResult, package_ref=_utilities.get_package()).value
...
def get_load_balancers_output(max_items: Optional[pulumi.Input[Optional[float]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getLoadBalancers:getLoadBalancers', __args__, opts=opts, typ=GetLoadBalancersResult, package_ref=_utilities.get_package())
