...
def get_zero_trust_dlp_custom_profile(account_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('cloudflare:index/getZeroTrustDlpCustomProfile:getZeroTrustDlpCustomProfile', __args__, opts=opts, typ=GetZeroTrustDlpCustomProfileResult, package_ref=_utilities.get_package()).value
...
def get_zero_trust_dlp_custom_profile_output(account_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('cloudflare:index/getZeroTrustDlpCustomProfile:getZeroTrustDlpCustomProfile', __args__, opts=opts, typ=GetZeroTrustDlpCustomProfileResult, package_ref=_utilities.get_package())
